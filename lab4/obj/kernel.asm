...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	631040ef          	jal	ra,ffffffffc0204e7a <memset>
...
ffffffffc0200056:	e7658593          	addi	a1,a1,-394 # ffffffffc0204ec8 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e8e50513          	addi	a0,a0,-370 # ffffffffc0204ee8 <etext+0x20>
...
ffffffffc0200076:	19f030ef          	jal	ra,ffffffffc0203a14 <vmm_init>
    proc_init();                // init process table
ffffffffc020007a:	5e6040ef          	jal	ra,ffffffffc0204660 <proc_init>
...
ffffffffc020008e:	021040ef          	jal	ra,ffffffffc02048ae <cpu_idle>
...
ffffffffc02000ac:	e4850513          	addi	a0,a0,-440 # ffffffffc0204ef0 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	109040ef          	jal	ra,ffffffffc0204a7c <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0d3040ef          	jal	ra,ffffffffc0204a7c <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d2e50513          	addi	a0,a0,-722 # ffffffffc0204ef8 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d3850513          	addi	a0,a0,-712 # ffffffffc0204f18 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cdc58593          	addi	a1,a1,-804 # ffffffffc0204ec8 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d4450513          	addi	a0,a0,-700 # ffffffffc0204f38 <etext+0x70>
...
ffffffffc020020c:	d5050513          	addi	a0,a0,-688 # ffffffffc0204f58 <etext+0x90>
...
ffffffffc0200220:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204f78 <etext+0xb0>
...
ffffffffc020024e:	d4e50513          	addi	a0,a0,-690 # ffffffffc0204f98 <etext+0xd0>
}
...
ffffffffc020025c:	d7060613          	addi	a2,a2,-656 # ffffffffc0204fc8 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d7c50513          	addi	a0,a0,-644 # ffffffffc0204fe0 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	d8460613          	addi	a2,a2,-636 # ffffffffc0204ff8 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d9c58593          	addi	a1,a1,-612 # ffffffffc0205018 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d9c50513          	addi	a0,a0,-612 # ffffffffc0205020 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d9e60613          	addi	a2,a2,-610 # ffffffffc0205030 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dbe58593          	addi	a1,a1,-578 # ffffffffc0205058 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d7e50513          	addi	a0,a0,-642 # ffffffffc0205020 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dba60613          	addi	a2,a2,-582 # ffffffffc0205068 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dd258593          	addi	a1,a1,-558 # ffffffffc0205088 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d6250513          	addi	a0,a0,-670 # ffffffffc0205020 <etext+0x158>
...
ffffffffc02002fc:	da050513          	addi	a0,a0,-608 # ffffffffc0205098 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	da650513          	addi	a0,a0,-602 # ffffffffc02050c0 <etext+0x1f8>
...
ffffffffc0200348:	da490913          	addi	s2,s2,-604 # ffffffffc02050e8 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	da448493          	addi	s1,s1,-604 # ffffffffc02050f0 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	da2b0b13          	addi	s6,s6,-606 # ffffffffc02050f8 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cbaa0a13          	addi	s4,s4,-838 # ffffffffc0205018 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2b9040ef          	jal	ra,ffffffffc0204e46 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2a5040ef          	jal	ra,ffffffffc0204e46 <strcmp>
...
ffffffffc02003e0:	285040ef          	jal	ra,ffffffffc0204e64 <strchr>
...
ffffffffc020041e:	247040ef          	jal	ra,ffffffffc0204e64 <strchr>
...
ffffffffc020043c:	ce050513          	addi	a0,a0,-800 # ffffffffc0205118 <etext+0x250>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	101040ef          	jal	ra,ffffffffc0204e8c <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0dd040ef          	jal	ra,ffffffffc0204e8c <memcpy>
    return 0;
}
...
ffffffffc020061c:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc020061e:	1cb0306f          	j	ffffffffc0203fe8 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0201bbe:	2bc030ef          	jal	ra,ffffffffc0204e7a <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	22a030ef          	jal	ra,ffffffffc0204e7a <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	2e3020ef          	jal	ra,ffffffffc0204e34 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2e9020ef          	jal	ra,ffffffffc0204e46 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	26b020ef          	jal	ra,ffffffffc0204dfe <strlen>
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	548010ef          	jal	ra,ffffffffc02040c8 <swapfs_init>
...
ffffffffc0202c38:	429000ef          	jal	ra,ffffffffc0203860 <mm_create>
...
ffffffffc0202c70:	439000ef          	jal	ra,ffffffffc02038a8 <vma_create>
...
ffffffffc0202c7c:	49b000ef          	jal	ra,ffffffffc0203916 <insert_vma_struct>
...
ffffffffc0202e88:	35f000ef          	jal	ra,ffffffffc02039e6 <mm_destroy>
...
ffffffffc020335a:	635000ef          	jal	ra,ffffffffc020418e <swapfs_write>
...
ffffffffc02033f8:	509000ef          	jal	ra,ffffffffc0204100 <swapfs_read>
...
ffffffffc0203606:	05700593          	li	a1,87
...
ffffffffc0203626:	07900593          	li	a1,121
...
ffffffffc0203666:	07500593          	li	a1,117
...
ffffffffc0203686:	07200593          	li	a1,114
...
ffffffffc02036a6:	06f00593          	li	a1,111
...
ffffffffc02036c6:	06c00593          	li	a1,108
...
ffffffffc02036e6:	06900593          	li	a1,105
...
ffffffffc0203706:	06600593          	li	a1,102
...
ffffffffc0203726:	06300593          	li	a1,99
...
ffffffffc0203746:	06000593          	li	a1,96
...
ffffffffc0203766:	05d00593          	li	a1,93
...
ffffffffc0203786:	05a00593          	li	a1,90
...
ffffffffc0203796:	7508                	ld	a0,40(a0)
{
ffffffffc0203798:	1141                	addi	sp,sp,-16
ffffffffc020379a:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc020379c:	c11d                	beqz	a0,ffffffffc02037c2 <_fifo_swap_out_victim+0x2c>
     assert(in_tick==0);
ffffffffc020379e:	e231                	bnez	a2,ffffffffc02037e2 <_fifo_swap_out_victim+0x4c>
    return listelm->next;
ffffffffc02037a0:	651c                	ld	a5,8(a0)
    __list_del(listelm->prev, listelm->next);
ffffffffc02037a2:	6398                	ld	a4,0(a5)
ffffffffc02037a4:	6794                	ld	a3,8(a5)
    if (entry != head) {
ffffffffc02037a6:	00f50563          	beq	a0,a5,ffffffffc02037b0 <_fifo_swap_out_victim+0x1a>
    prev->next = next;
ffffffffc02037aa:	e714                	sd	a3,8(a4)
    next->prev = prev;
ffffffffc02037ac:	e298                	sd	a4,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc02037ae:	6398                	ld	a4,0(a5)
    prev->next = next;
ffffffffc02037b0:	e714                	sd	a3,8(a4)
}
ffffffffc02037b2:	60a2                	ld	ra,8(sp)
    next->prev = prev;
ffffffffc02037b4:	e298                	sd	a4,0(a3)
    *ptr_page = le2page(entry, pra_page_link);
ffffffffc02037b6:	fd878793          	addi	a5,a5,-40
ffffffffc02037ba:	e19c                	sd	a5,0(a1)
}
...
ffffffffc02037c6:	00668693          	addi	a3,a3,6 # ffffffffc02067c8 <default_pmm_manager+0xbb0>
ffffffffc02037ca:	00002617          	auipc	a2,0x2
ffffffffc02037ce:	09e60613          	addi	a2,a2,158 # ffffffffc0205868 <commands+0x738>
ffffffffc02037d2:	04100593          	li	a1,65
ffffffffc02037d6:	00003517          	auipc	a0,0x3
ffffffffc02037da:	ea250513          	addi	a0,a0,-350 # ffffffffc0206678 <default_pmm_manager+0xa60>
ffffffffc02037de:	c69fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037e2:	00003697          	auipc	a3,0x3
ffffffffc02037e6:	ff668693          	addi	a3,a3,-10 # ffffffffc02067d8 <default_pmm_manager+0xbc0>
ffffffffc02037ea:	00002617          	auipc	a2,0x2
ffffffffc02037ee:	07e60613          	addi	a2,a2,126 # ffffffffc0205868 <commands+0x738>
ffffffffc02037f2:	04200593          	li	a1,66
ffffffffc02037f6:	00003517          	auipc	a0,0x3
ffffffffc02037fa:	e8250513          	addi	a0,a0,-382 # ffffffffc0206678 <default_pmm_manager+0xa60>
ffffffffc02037fe:	c49fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203802 <_fifo_map_swappable>:
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203802:	751c                	ld	a5,40(a0)
    assert(entry != NULL && head != NULL);
ffffffffc0203804:	cb91                	beqz	a5,ffffffffc0203818 <_fifo_map_swappable+0x16>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0203806:	6394                	ld	a3,0(a5)
ffffffffc0203808:	02860713          	addi	a4,a2,40
    prev->next = next->prev = elm;
ffffffffc020380c:	e398                	sd	a4,0(a5)
ffffffffc020380e:	e698                	sd	a4,8(a3)
}
ffffffffc0203810:	4501                	li	a0,0
    elm->next = next;
ffffffffc0203812:	fa1c                	sd	a5,48(a2)
    elm->prev = prev;
ffffffffc0203814:	f614                	sd	a3,40(a2)
ffffffffc0203816:	8082                	ret
{
ffffffffc0203818:	1141                	addi	sp,sp,-16
    assert(entry != NULL && head != NULL);
ffffffffc020381a:	00003697          	auipc	a3,0x3
ffffffffc020381e:	fce68693          	addi	a3,a3,-50 # ffffffffc02067e8 <default_pmm_manager+0xbd0>
ffffffffc0203822:	00002617          	auipc	a2,0x2
ffffffffc0203826:	04660613          	addi	a2,a2,70 # ffffffffc0205868 <commands+0x738>
ffffffffc020382a:	03200593          	li	a1,50
ffffffffc020382e:	00003517          	auipc	a0,0x3
ffffffffc0203832:	e4a50513          	addi	a0,a0,-438 # ffffffffc0206678 <default_pmm_manager+0xa60>
{
ffffffffc0203836:	e406                	sd	ra,8(sp)
    assert(entry != NULL && head != NULL);
ffffffffc0203838:	c0ffc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020383c <check_vma_overlap.part.0>:
}
...
ffffffffc0203842:	fe268693          	addi	a3,a3,-30 # ffffffffc0206820 <default_pmm_manager+0xc08>
ffffffffc0203846:	00002617          	auipc	a2,0x2
ffffffffc020384a:	02260613          	addi	a2,a2,34 # ffffffffc0205868 <commands+0x738>
ffffffffc020384e:	07e00593          	li	a1,126
ffffffffc0203852:	00003517          	auipc	a0,0x3
ffffffffc0203856:	fee50513          	addi	a0,a0,-18 # ffffffffc0206840 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020385a:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020385c:	bebfc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203860 <mm_create>:
mm_create(void) {
ffffffffc0203860:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203862:	03000513          	li	a0,48
mm_create(void) {
ffffffffc0203866:	e022                	sd	s0,0(sp)
ffffffffc0203868:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020386a:	fe5fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020386e:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203870:	c105                	beqz	a0,ffffffffc0203890 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203872:	e408                	sd	a0,8(s0)
ffffffffc0203874:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc0203876:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020387a:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020387e:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203882:	00012797          	auipc	a5,0x12
ffffffffc0203886:	d167a783          	lw	a5,-746(a5) # ffffffffc0215598 <swap_init_ok>
ffffffffc020388a:	eb81                	bnez	a5,ffffffffc020389a <mm_create+0x3a>
...
ffffffffc0203898:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020389a:	a05ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
}
...
ffffffffc02038a8 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint32_t vm_flags) {
ffffffffc02038a8:	1101                	addi	sp,sp,-32
ffffffffc02038aa:	e04a                	sd	s2,0(sp)
ffffffffc02038ac:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038ae:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint32_t vm_flags) {
ffffffffc02038b2:	e822                	sd	s0,16(sp)
ffffffffc02038b4:	e426                	sd	s1,8(sp)
ffffffffc02038b6:	ec06                	sd	ra,24(sp)
ffffffffc02038b8:	84ae                	mv	s1,a1
ffffffffc02038ba:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038bc:	f93fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    if (vma != NULL) {
ffffffffc02038c0:	c509                	beqz	a0,ffffffffc02038ca <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc02038c2:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc02038c6:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02038c8:	cd00                	sw	s0,24(a0)
}
...
ffffffffc02038d6 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc02038d6:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc02038d8:	c505                	beqz	a0,ffffffffc0203900 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc02038da:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02038dc:	c501                	beqz	a0,ffffffffc02038e4 <find_vma+0xe>
ffffffffc02038de:	651c                	ld	a5,8(a0)
ffffffffc02038e0:	02f5f263          	bgeu	a1,a5,ffffffffc0203904 <find_vma+0x2e>
    return listelm->next;
ffffffffc02038e4:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc02038e6:	00f68d63          	beq	a3,a5,ffffffffc0203900 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc02038ea:	fe87b703          	ld	a4,-24(a5)
ffffffffc02038ee:	00e5e663          	bltu	a1,a4,ffffffffc02038fa <find_vma+0x24>
ffffffffc02038f2:	ff07b703          	ld	a4,-16(a5)
ffffffffc02038f6:	00e5ec63          	bltu	a1,a4,ffffffffc020390e <find_vma+0x38>
ffffffffc02038fa:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02038fc:	fef697e3          	bne	a3,a5,ffffffffc02038ea <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203900:	4501                	li	a0,0
}
ffffffffc0203902:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203904:	691c                	ld	a5,16(a0)
ffffffffc0203906:	fcf5ffe3          	bgeu	a1,a5,ffffffffc02038e4 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020390a:	ea88                	sd	a0,16(a3)
ffffffffc020390c:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc020390e:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203912:	ea88                	sd	a0,16(a3)
ffffffffc0203914:	8082                	ret

ffffffffc0203916 <insert_vma_struct>:
...
ffffffffc0203916:	6590                	ld	a2,8(a1)
ffffffffc0203918:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc020391c:	1141                	addi	sp,sp,-16
ffffffffc020391e:	e406                	sd	ra,8(sp)
ffffffffc0203920:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203922:	01066763          	bltu	a2,a6,ffffffffc0203930 <insert_vma_struct+0x1a>
ffffffffc0203926:	a085                	j	ffffffffc0203986 <insert_vma_struct+0x70>
...
ffffffffc0203928:	fe87b703          	ld	a4,-24(a5)
ffffffffc020392c:	04e66863          	bltu	a2,a4,ffffffffc020397c <insert_vma_struct+0x66>
ffffffffc0203930:	86be                	mv	a3,a5
ffffffffc0203932:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0203934:	fef51ae3          	bne	a0,a5,ffffffffc0203928 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc0203938:	02a68463          	beq	a3,a0,ffffffffc0203960 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc020393c:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203940:	fe86b883          	ld	a7,-24(a3)
ffffffffc0203944:	08e8f163          	bgeu	a7,a4,ffffffffc02039c6 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203948:	04e66f63          	bltu	a2,a4,ffffffffc02039a6 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc020394c:	00f50a63          	beq	a0,a5,ffffffffc0203960 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203950:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203954:	05076963          	bltu	a4,a6,ffffffffc02039a6 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc0203958:	ff07b603          	ld	a2,-16(a5)
ffffffffc020395c:	02c77363          	bgeu	a4,a2,ffffffffc0203982 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203960:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203962:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203964:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc0203968:	e390                	sd	a2,0(a5)
ffffffffc020396a:	e690                	sd	a2,8(a3)
}
ffffffffc020396c:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc020396e:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203970:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc0203972:	0017079b          	addiw	a5,a4,1
ffffffffc0203976:	d11c                	sw	a5,32(a0)
}
ffffffffc0203978:	0141                	addi	sp,sp,16
ffffffffc020397a:	8082                	ret
    if (le_prev != list) {
ffffffffc020397c:	fca690e3          	bne	a3,a0,ffffffffc020393c <insert_vma_struct+0x26>
ffffffffc0203980:	bfd1                	j	ffffffffc0203954 <insert_vma_struct+0x3e>
ffffffffc0203982:	ebbff0ef          	jal	ra,ffffffffc020383c <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203986:	00003697          	auipc	a3,0x3
ffffffffc020398a:	eca68693          	addi	a3,a3,-310 # ffffffffc0206850 <default_pmm_manager+0xc38>
ffffffffc020398e:	00002617          	auipc	a2,0x2
ffffffffc0203992:	eda60613          	addi	a2,a2,-294 # ffffffffc0205868 <commands+0x738>
ffffffffc0203996:	08500593          	li	a1,133
ffffffffc020399a:	00003517          	auipc	a0,0x3
ffffffffc020399e:	ea650513          	addi	a0,a0,-346 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc02039a2:	aa5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02039a6:	00003697          	auipc	a3,0x3
ffffffffc02039aa:	eea68693          	addi	a3,a3,-278 # ffffffffc0206890 <default_pmm_manager+0xc78>
ffffffffc02039ae:	00002617          	auipc	a2,0x2
ffffffffc02039b2:	eba60613          	addi	a2,a2,-326 # ffffffffc0205868 <commands+0x738>
ffffffffc02039b6:	07d00593          	li	a1,125
ffffffffc02039ba:	00003517          	auipc	a0,0x3
ffffffffc02039be:	e8650513          	addi	a0,a0,-378 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc02039c2:	a85fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039c6:	00003697          	auipc	a3,0x3
ffffffffc02039ca:	eaa68693          	addi	a3,a3,-342 # ffffffffc0206870 <default_pmm_manager+0xc58>
ffffffffc02039ce:	00002617          	auipc	a2,0x2
ffffffffc02039d2:	e9a60613          	addi	a2,a2,-358 # ffffffffc0205868 <commands+0x738>
ffffffffc02039d6:	07c00593          	li	a1,124
ffffffffc02039da:	00003517          	auipc	a0,0x3
ffffffffc02039de:	e6650513          	addi	a0,a0,-410 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc02039e2:	a65fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02039e6 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc02039e6:	1141                	addi	sp,sp,-16
ffffffffc02039e8:	e022                	sd	s0,0(sp)
ffffffffc02039ea:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02039ec:	6508                	ld	a0,8(a0)
ffffffffc02039ee:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02039f0:	00a40c63          	beq	s0,a0,ffffffffc0203a08 <mm_destroy+0x22>
    __list_del(listelm->prev, listelm->next);
ffffffffc02039f4:	6118                	ld	a4,0(a0)
...
ffffffffc02039fe:	f01fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203a02:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203a04:	fea418e3          	bne	s0,a0,ffffffffc02039f4 <mm_destroy+0xe>
    }
    kfree(mm); //kfree mm
...
ffffffffc0203a0e:	0141                	addi	sp,sp,16
    kfree(mm); //kfree mm
ffffffffc0203a10:	eeffd06f          	j	ffffffffc02018fe <kfree>
...
ffffffffc0203a26:	e456                	sd	s5,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203a28:	e27fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    if (mm != NULL) {
ffffffffc0203a2c:	58050e63          	beqz	a0,ffffffffc0203fc8 <vmm_init+0x5b4>
    elm->prev = elm->next = elm;
...
ffffffffc0203a3c:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a40:	00012797          	auipc	a5,0x12
ffffffffc0203a44:	b587a783          	lw	a5,-1192(a5) # ffffffffc0215598 <swap_init_ok>
ffffffffc0203a48:	84aa                	mv	s1,a0
ffffffffc0203a4a:	e7b9                	bnez	a5,ffffffffc0203a98 <vmm_init+0x84>
        else mm->sm_priv = NULL;
ffffffffc0203a4c:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc0203a50:	03200413          	li	s0,50
ffffffffc0203a54:	a811                	j	ffffffffc0203a68 <vmm_init+0x54>
        vma->vm_start = vm_start;
...
ffffffffc0203a5a:	00052c23          	sw	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203a5e:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203a60:	8526                	mv	a0,s1
ffffffffc0203a62:	eb5ff0ef          	jal	ra,ffffffffc0203916 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203a66:	cc05                	beqz	s0,ffffffffc0203a9e <vmm_init+0x8a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203a68:	03000513          	li	a0,48
ffffffffc0203a6c:	de3fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203a70:	85aa                	mv	a1,a0
ffffffffc0203a72:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203a76:	f165                	bnez	a0,ffffffffc0203a56 <vmm_init+0x42>
        assert(vma != NULL);
ffffffffc0203a78:	00003697          	auipc	a3,0x3
ffffffffc0203a7c:	8e868693          	addi	a3,a3,-1816 # ffffffffc0206360 <default_pmm_manager+0x748>
ffffffffc0203a80:	00002617          	auipc	a2,0x2
ffffffffc0203a84:	de860613          	addi	a2,a2,-536 # ffffffffc0205868 <commands+0x738>
ffffffffc0203a88:	0c900593          	li	a1,201
ffffffffc0203a8c:	00003517          	auipc	a0,0x3
ffffffffc0203a90:	db450513          	addi	a0,a0,-588 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203a94:	9b3fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a98:	807ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
ffffffffc0203a9c:	bf55                	j	ffffffffc0203a50 <vmm_init+0x3c>
ffffffffc0203a9e:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203aa2:	1f900913          	li	s2,505
ffffffffc0203aa6:	a819                	j	ffffffffc0203abc <vmm_init+0xa8>
        vma->vm_start = vm_start;
ffffffffc0203aa8:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203aaa:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203aac:	00052c23          	sw	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203ab0:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203ab2:	8526                	mv	a0,s1
ffffffffc0203ab4:	e63ff0ef          	jal	ra,ffffffffc0203916 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203ab8:	03240a63          	beq	s0,s2,ffffffffc0203aec <vmm_init+0xd8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203abc:	03000513          	li	a0,48
ffffffffc0203ac0:	d8ffd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203ac4:	85aa                	mv	a1,a0
ffffffffc0203ac6:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203aca:	fd79                	bnez	a0,ffffffffc0203aa8 <vmm_init+0x94>
        assert(vma != NULL);
ffffffffc0203acc:	00003697          	auipc	a3,0x3
ffffffffc0203ad0:	89468693          	addi	a3,a3,-1900 # ffffffffc0206360 <default_pmm_manager+0x748>
ffffffffc0203ad4:	00002617          	auipc	a2,0x2
ffffffffc0203ad8:	d9460613          	addi	a2,a2,-620 # ffffffffc0205868 <commands+0x738>
ffffffffc0203adc:	0cf00593          	li	a1,207
ffffffffc0203ae0:	00003517          	auipc	a0,0x3
ffffffffc0203ae4:	d6050513          	addi	a0,a0,-672 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203ae8:	95ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return listelm->next;
ffffffffc0203aec:	649c                	ld	a5,8(s1)
...
ffffffffc0203af4:	30f48e63          	beq	s1,a5,ffffffffc0203e10 <vmm_init+0x3fc>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203af8:	fe87b683          	ld	a3,-24(a5)
ffffffffc0203afc:	ffe70613          	addi	a2,a4,-2
ffffffffc0203b00:	2ad61863          	bne	a2,a3,ffffffffc0203db0 <vmm_init+0x39c>
ffffffffc0203b04:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203b08:	2ae69463          	bne	a3,a4,ffffffffc0203db0 <vmm_init+0x39c>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203b0c:	0715                	addi	a4,a4,5
ffffffffc0203b0e:	679c                	ld	a5,8(a5)
ffffffffc0203b10:	feb712e3          	bne	a4,a1,ffffffffc0203af4 <vmm_init+0xe0>
ffffffffc0203b14:	4a1d                	li	s4,7
ffffffffc0203b16:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203b18:	1f900a93          	li	s5,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203b1c:	85a2                	mv	a1,s0
ffffffffc0203b1e:	8526                	mv	a0,s1
ffffffffc0203b20:	db7ff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
ffffffffc0203b24:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203b26:	34050563          	beqz	a0,ffffffffc0203e70 <vmm_init+0x45c>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203b2a:	00140593          	addi	a1,s0,1
ffffffffc0203b2e:	8526                	mv	a0,s1
ffffffffc0203b30:	da7ff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
ffffffffc0203b34:	89aa                	mv	s3,a0
        assert(vma2 != NULL);
ffffffffc0203b36:	34050d63          	beqz	a0,ffffffffc0203e90 <vmm_init+0x47c>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203b3a:	85d2                	mv	a1,s4
ffffffffc0203b3c:	8526                	mv	a0,s1
ffffffffc0203b3e:	d99ff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
        assert(vma3 == NULL);
ffffffffc0203b42:	36051763          	bnez	a0,ffffffffc0203eb0 <vmm_init+0x49c>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203b46:	00340593          	addi	a1,s0,3
ffffffffc0203b4a:	8526                	mv	a0,s1
ffffffffc0203b4c:	d8bff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
        assert(vma4 == NULL);
ffffffffc0203b50:	2e051063          	bnez	a0,ffffffffc0203e30 <vmm_init+0x41c>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203b54:	00440593          	addi	a1,s0,4
ffffffffc0203b58:	8526                	mv	a0,s1
ffffffffc0203b5a:	d7dff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203b5e:	2e051963          	bnez	a0,ffffffffc0203e50 <vmm_init+0x43c>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203b62:	00893783          	ld	a5,8(s2)
ffffffffc0203b66:	26879563          	bne	a5,s0,ffffffffc0203dd0 <vmm_init+0x3bc>
ffffffffc0203b6a:	01093783          	ld	a5,16(s2)
ffffffffc0203b6e:	27479163          	bne	a5,s4,ffffffffc0203dd0 <vmm_init+0x3bc>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203b72:	0089b783          	ld	a5,8(s3)
ffffffffc0203b76:	26879d63          	bne	a5,s0,ffffffffc0203df0 <vmm_init+0x3dc>
ffffffffc0203b7a:	0109b783          	ld	a5,16(s3)
ffffffffc0203b7e:	27479963          	bne	a5,s4,ffffffffc0203df0 <vmm_init+0x3dc>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203b82:	0415                	addi	s0,s0,5
ffffffffc0203b84:	0a15                	addi	s4,s4,5
ffffffffc0203b86:	f9541be3          	bne	s0,s5,ffffffffc0203b1c <vmm_init+0x108>
ffffffffc0203b8a:	4411                	li	s0,4
    }
...
ffffffffc0203b90:	8526                	mv	a0,s1
ffffffffc0203b92:	d45ff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
ffffffffc0203b96:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203b9a:	c90d                	beqz	a0,ffffffffc0203bcc <vmm_init+0x1b8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203b9c:	6914                	ld	a3,16(a0)
ffffffffc0203b9e:	6510                	ld	a2,8(a0)
ffffffffc0203ba0:	00003517          	auipc	a0,0x3
ffffffffc0203ba4:	e1050513          	addi	a0,a0,-496 # ffffffffc02069b0 <default_pmm_manager+0xd98>
ffffffffc0203ba8:	dd8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203bac:	00003697          	auipc	a3,0x3
ffffffffc0203bb0:	e2c68693          	addi	a3,a3,-468 # ffffffffc02069d8 <default_pmm_manager+0xdc0>
ffffffffc0203bb4:	00002617          	auipc	a2,0x2
ffffffffc0203bb8:	cb460613          	addi	a2,a2,-844 # ffffffffc0205868 <commands+0x738>
ffffffffc0203bbc:	0f100593          	li	a1,241
ffffffffc0203bc0:	00003517          	auipc	a0,0x3
ffffffffc0203bc4:	c8050513          	addi	a0,a0,-896 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203bc8:	87ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203bcc:	147d                	addi	s0,s0,-1
ffffffffc0203bce:	fd2410e3          	bne	s0,s2,ffffffffc0203b8e <vmm_init+0x17a>
ffffffffc0203bd2:	a801                	j	ffffffffc0203be2 <vmm_init+0x1ce>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc0203bde:	d21fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203be2:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203be4:	fea498e3          	bne	s1,a0,ffffffffc0203bd4 <vmm_init+0x1c0>
    kfree(mm); //kfree mm
ffffffffc0203be8:	8526                	mv	a0,s1
ffffffffc0203bea:	d15fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    }
...
ffffffffc0203bf2:	e0250513          	addi	a0,a0,-510 # ffffffffc02069f0 <default_pmm_manager+0xdd8>
ffffffffc0203bf6:	d8afc0ef          	jal	ra,ffffffffc0200180 <cprintf>
...
ffffffffc0203bfa:	f05fd0ef          	jal	ra,ffffffffc0201afe <nr_free_pages>
ffffffffc0203bfe:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203c00:	03000513          	li	a0,48
ffffffffc0203c04:	c4bfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203c08:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203c0a:	2c050363          	beqz	a0,ffffffffc0203ed0 <vmm_init+0x4bc>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203c0e:	00012797          	auipc	a5,0x12
ffffffffc0203c12:	98a7a783          	lw	a5,-1654(a5) # ffffffffc0215598 <swap_init_ok>
    elm->prev = elm->next = elm;
...
ffffffffc0203c22:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203c26:	18079263          	bnez	a5,ffffffffc0203daa <vmm_init+0x396>
        else mm->sm_priv = NULL;
ffffffffc0203c2a:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203c2e:	00012917          	auipc	s2,0x12
ffffffffc0203c32:	93293903          	ld	s2,-1742(s2) # ffffffffc0215560 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203c36:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203c3a:	00012717          	auipc	a4,0x12
ffffffffc0203c3e:	96873323          	sd	s0,-1690(a4) # ffffffffc02155a0 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203c42:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203c46:	36079163          	bnez	a5,ffffffffc0203fa8 <vmm_init+0x594>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203c4a:	03000513          	li	a0,48
ffffffffc0203c4e:	c01fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0203c52:	89aa                	mv	s3,a0
    if (vma != NULL) {
ffffffffc0203c54:	2a050263          	beqz	a0,ffffffffc0203ef8 <vmm_init+0x4e4>
        vma->vm_end = vm_end;
ffffffffc0203c58:	002007b7          	lui	a5,0x200
ffffffffc0203c5c:	00f9b823          	sd	a5,16(s3)
        vma->vm_flags = vm_flags;
...
ffffffffc0203c62:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203c64:	00f9ac23          	sw	a5,24(s3)
    insert_vma_struct(mm, vma);
ffffffffc0203c68:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203c6a:	0009b423          	sd	zero,8(s3)
    insert_vma_struct(mm, vma);
ffffffffc0203c6e:	ca9ff0ef          	jal	ra,ffffffffc0203916 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c72:	10000593          	li	a1,256
ffffffffc0203c76:	8522                	mv	a0,s0
ffffffffc0203c78:	c5fff0ef          	jal	ra,ffffffffc02038d6 <find_vma>
ffffffffc0203c7c:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc0203c80:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203c84:	28a99a63          	bne	s3,a0,ffffffffc0203f18 <vmm_init+0x504>
        *(char *)(addr + i) = i;
ffffffffc0203c88:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203c8c:	0785                	addi	a5,a5,1
ffffffffc0203c8e:	fee79de3          	bne	a5,a4,ffffffffc0203c88 <vmm_init+0x274>
        sum += i;
ffffffffc0203c92:	6705                	lui	a4,0x1
ffffffffc0203c94:	10000793          	li	a5,256
ffffffffc0203c98:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203c9c:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc0203ca0:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203ca4:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203ca6:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203ca8:	fec79ce3          	bne	a5,a2,ffffffffc0203ca0 <vmm_init+0x28c>
    }
    assert(sum == 0);
ffffffffc0203cac:	28071663          	bnez	a4,ffffffffc0203f38 <vmm_init+0x524>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cb0:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203cb4:	00012a97          	auipc	s5,0x12
ffffffffc0203cb8:	8b4a8a93          	addi	s5,s5,-1868 # ffffffffc0215568 <npage>
ffffffffc0203cbc:	000ab603          	ld	a2,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cc0:	078a                	slli	a5,a5,0x2
ffffffffc0203cc2:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203cc4:	28c7fa63          	bgeu	a5,a2,ffffffffc0203f58 <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203cc8:	00003a17          	auipc	s4,0x3
ffffffffc0203ccc:	2e0a3a03          	ld	s4,736(s4) # ffffffffc0206fa8 <nbase>
ffffffffc0203cd0:	414787b3          	sub	a5,a5,s4
ffffffffc0203cd4:	079a                	slli	a5,a5,0x6
    return page - pages + nbase;
ffffffffc0203cd6:	8799                	srai	a5,a5,0x6
ffffffffc0203cd8:	97d2                	add	a5,a5,s4
    return KADDR(page2pa(page));
ffffffffc0203cda:	00c79713          	slli	a4,a5,0xc
ffffffffc0203cde:	8331                	srli	a4,a4,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203ce0:	00c79693          	slli	a3,a5,0xc
    return KADDR(page2pa(page));
ffffffffc0203ce4:	28c77663          	bgeu	a4,a2,ffffffffc0203f70 <vmm_init+0x55c>
ffffffffc0203ce8:	00012997          	auipc	s3,0x12
ffffffffc0203cec:	8989b983          	ld	s3,-1896(s3) # ffffffffc0215580 <va_pa_offset>

    pde_t *pd1=pgdir,*pd0=page2kva(pde2page(pgdir[0]));
    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc0203cf0:	4581                	li	a1,0
ffffffffc0203cf2:	854a                	mv	a0,s2
ffffffffc0203cf4:	99b6                	add	s3,s3,a3
ffffffffc0203cf6:	868fe0ef          	jal	ra,ffffffffc0201d5e <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203cfa:	0009b783          	ld	a5,0(s3)
    if (PPN(pa) >= npage) {
ffffffffc0203cfe:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d02:	078a                	slli	a5,a5,0x2
ffffffffc0203d04:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203d06:	24e7f963          	bgeu	a5,a4,ffffffffc0203f58 <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203d0a:	00012997          	auipc	s3,0x12
ffffffffc0203d0e:	86698993          	addi	s3,s3,-1946 # ffffffffc0215570 <pages>
ffffffffc0203d12:	0009b503          	ld	a0,0(s3)
ffffffffc0203d16:	414787b3          	sub	a5,a5,s4
ffffffffc0203d1a:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd0[0]));
ffffffffc0203d1c:	953e                	add	a0,a0,a5
ffffffffc0203d1e:	4585                	li	a1,1
ffffffffc0203d20:	d9ffd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d24:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203d28:	000ab703          	ld	a4,0(s5)
    return pa2page(PDE_ADDR(pde));
ffffffffc0203d2c:	078a                	slli	a5,a5,0x2
ffffffffc0203d2e:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203d30:	22e7f463          	bgeu	a5,a4,ffffffffc0203f58 <vmm_init+0x544>
    return &pages[PPN(pa) - nbase];
ffffffffc0203d34:	0009b503          	ld	a0,0(s3)
ffffffffc0203d38:	414787b3          	sub	a5,a5,s4
ffffffffc0203d3c:	079a                	slli	a5,a5,0x6
    free_page(pde2page(pd1[0]));
ffffffffc0203d3e:	4585                	li	a1,1
ffffffffc0203d40:	953e                	add	a0,a0,a5
ffffffffc0203d42:	d7dfd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    pgdir[0] = 0;
ffffffffc0203d46:	00093023          	sd	zero,0(s2)
  asm volatile("sfence.vma");
ffffffffc0203d4a:	12000073          	sfence.vma
    return listelm->next;
ffffffffc0203d4e:	6408                	ld	a0,8(s0)
    flush_tlb();

    mm->pgdir = NULL;
ffffffffc0203d50:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203d54:	00a40c63          	beq	s0,a0,ffffffffc0203d6c <vmm_init+0x358>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203d58:	6118                	ld	a4,0(a0)
ffffffffc0203d5a:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link));  //kfree vma        
ffffffffc0203d5c:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203d5e:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203d60:	e398                	sd	a4,0(a5)
ffffffffc0203d62:	b9dfd0ef          	jal	ra,ffffffffc02018fe <kfree>
    return listelm->next;
ffffffffc0203d66:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203d68:	fea418e3          	bne	s0,a0,ffffffffc0203d58 <vmm_init+0x344>
    kfree(mm); //kfree mm
ffffffffc0203d6c:	8522                	mv	a0,s0
ffffffffc0203d6e:	b91fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    mm_destroy(mm);
    check_mm_struct = NULL;
ffffffffc0203d72:	00012797          	auipc	a5,0x12
ffffffffc0203d76:	8207b723          	sd	zero,-2002(a5) # ffffffffc02155a0 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203d7a:	d85fd0ef          	jal	ra,ffffffffc0201afe <nr_free_pages>
ffffffffc0203d7e:	20a49563          	bne	s1,a0,ffffffffc0203f88 <vmm_init+0x574>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203d82:	00003517          	auipc	a0,0x3
ffffffffc0203d86:	ce650513          	addi	a0,a0,-794 # ffffffffc0206a68 <default_pmm_manager+0xe50>
ffffffffc0203d8a:	bf6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0203d8e:	7442                	ld	s0,48(sp)
ffffffffc0203d90:	70e2                	ld	ra,56(sp)
ffffffffc0203d92:	74a2                	ld	s1,40(sp)
ffffffffc0203d94:	7902                	ld	s2,32(sp)
ffffffffc0203d96:	69e2                	ld	s3,24(sp)
ffffffffc0203d98:	6a42                	ld	s4,16(sp)
ffffffffc0203d9a:	6aa2                	ld	s5,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203d9c:	00003517          	auipc	a0,0x3
ffffffffc0203da0:	cec50513          	addi	a0,a0,-788 # ffffffffc0206a88 <default_pmm_manager+0xe70>
}
ffffffffc0203da4:	6121                	addi	sp,sp,64
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203da6:	bdafc06f          	j	ffffffffc0200180 <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203daa:	cf4ff0ef          	jal	ra,ffffffffc020329e <swap_init_mm>
ffffffffc0203dae:	b541                	j	ffffffffc0203c2e <vmm_init+0x21a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203db0:	00003697          	auipc	a3,0x3
ffffffffc0203db4:	b1868693          	addi	a3,a3,-1256 # ffffffffc02068c8 <default_pmm_manager+0xcb0>
ffffffffc0203db8:	00002617          	auipc	a2,0x2
ffffffffc0203dbc:	ab060613          	addi	a2,a2,-1360 # ffffffffc0205868 <commands+0x738>
ffffffffc0203dc0:	0d800593          	li	a1,216
ffffffffc0203dc4:	00003517          	auipc	a0,0x3
ffffffffc0203dc8:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203dcc:	e7afc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dd0:	00003697          	auipc	a3,0x3
ffffffffc0203dd4:	b8068693          	addi	a3,a3,-1152 # ffffffffc0206950 <default_pmm_manager+0xd38>
ffffffffc0203dd8:	00002617          	auipc	a2,0x2
ffffffffc0203ddc:	a9060613          	addi	a2,a2,-1392 # ffffffffc0205868 <commands+0x738>
ffffffffc0203de0:	0e800593          	li	a1,232
ffffffffc0203de4:	00003517          	auipc	a0,0x3
ffffffffc0203de8:	a5c50513          	addi	a0,a0,-1444 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203dec:	e5afc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203df0:	00003697          	auipc	a3,0x3
ffffffffc0203df4:	b9068693          	addi	a3,a3,-1136 # ffffffffc0206980 <default_pmm_manager+0xd68>
ffffffffc0203df8:	00002617          	auipc	a2,0x2
ffffffffc0203dfc:	a7060613          	addi	a2,a2,-1424 # ffffffffc0205868 <commands+0x738>
ffffffffc0203e00:	0e900593          	li	a1,233
ffffffffc0203e04:	00003517          	auipc	a0,0x3
ffffffffc0203e08:	a3c50513          	addi	a0,a0,-1476 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203e0c:	e3afc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e10:	00003697          	auipc	a3,0x3
ffffffffc0203e14:	aa068693          	addi	a3,a3,-1376 # ffffffffc02068b0 <default_pmm_manager+0xc98>
ffffffffc0203e18:	00002617          	auipc	a2,0x2
ffffffffc0203e1c:	a5060613          	addi	a2,a2,-1456 # ffffffffc0205868 <commands+0x738>
ffffffffc0203e20:	0d600593          	li	a1,214
ffffffffc0203e24:	00003517          	auipc	a0,0x3
ffffffffc0203e28:	a1c50513          	addi	a0,a0,-1508 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203e2c:	e1afc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e30:	00003697          	auipc	a3,0x3
ffffffffc0203e34:	b0068693          	addi	a3,a3,-1280 # ffffffffc0206930 <default_pmm_manager+0xd18>
ffffffffc0203e38:	00002617          	auipc	a2,0x2
ffffffffc0203e3c:	a3060613          	addi	a2,a2,-1488 # ffffffffc0205868 <commands+0x738>
ffffffffc0203e40:	0e400593          	li	a1,228
ffffffffc0203e44:	00003517          	auipc	a0,0x3
ffffffffc0203e48:	9fc50513          	addi	a0,a0,-1540 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203e4c:	dfafc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e50:	00003697          	auipc	a3,0x3
ffffffffc0203e54:	af068693          	addi	a3,a3,-1296 # ffffffffc0206940 <default_pmm_manager+0xd28>
ffffffffc0203e58:	00002617          	auipc	a2,0x2
ffffffffc0203e5c:	a1060613          	addi	a2,a2,-1520 # ffffffffc0205868 <commands+0x738>
ffffffffc0203e60:	0e600593          	li	a1,230
ffffffffc0203e64:	00003517          	auipc	a0,0x3
ffffffffc0203e68:	9dc50513          	addi	a0,a0,-1572 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203e6c:	ddafc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e70:	00003697          	auipc	a3,0x3
ffffffffc0203e74:	a9068693          	addi	a3,a3,-1392 # ffffffffc0206900 <default_pmm_manager+0xce8>
ffffffffc0203e78:	00002617          	auipc	a2,0x2
ffffffffc0203e7c:	9f060613          	addi	a2,a2,-1552 # ffffffffc0205868 <commands+0x738>
ffffffffc0203e80:	0de00593          	li	a1,222
ffffffffc0203e84:	00003517          	auipc	a0,0x3
ffffffffc0203e88:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203e8c:	dbafc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e90:	00003697          	auipc	a3,0x3
ffffffffc0203e94:	a8068693          	addi	a3,a3,-1408 # ffffffffc0206910 <default_pmm_manager+0xcf8>
ffffffffc0203e98:	00002617          	auipc	a2,0x2
ffffffffc0203e9c:	9d060613          	addi	a2,a2,-1584 # ffffffffc0205868 <commands+0x738>
ffffffffc0203ea0:	0e000593          	li	a1,224
ffffffffc0203ea4:	00003517          	auipc	a0,0x3
ffffffffc0203ea8:	99c50513          	addi	a0,a0,-1636 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203eac:	d9afc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203eb0:	00003697          	auipc	a3,0x3
ffffffffc0203eb4:	a7068693          	addi	a3,a3,-1424 # ffffffffc0206920 <default_pmm_manager+0xd08>
ffffffffc0203eb8:	00002617          	auipc	a2,0x2
ffffffffc0203ebc:	9b060613          	addi	a2,a2,-1616 # ffffffffc0205868 <commands+0x738>
ffffffffc0203ec0:	0e200593          	li	a1,226
ffffffffc0203ec4:	00003517          	auipc	a0,0x3
ffffffffc0203ec8:	97c50513          	addi	a0,a0,-1668 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203ecc:	d7afc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ed0:	00003697          	auipc	a3,0x3
ffffffffc0203ed4:	bd068693          	addi	a3,a3,-1072 # ffffffffc0206aa0 <default_pmm_manager+0xe88>
ffffffffc0203ed8:	00002617          	auipc	a2,0x2
ffffffffc0203edc:	99060613          	addi	a2,a2,-1648 # ffffffffc0205868 <commands+0x738>
ffffffffc0203ee0:	10100593          	li	a1,257
ffffffffc0203ee4:	00003517          	auipc	a0,0x3
ffffffffc0203ee8:	95c50513          	addi	a0,a0,-1700 # ffffffffc0206840 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
ffffffffc0203eec:	00011797          	auipc	a5,0x11
ffffffffc0203ef0:	6a07ba23          	sd	zero,1716(a5) # ffffffffc02155a0 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203ef4:	d52fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(vma != NULL);
ffffffffc0203ef8:	00002697          	auipc	a3,0x2
ffffffffc0203efc:	46868693          	addi	a3,a3,1128 # ffffffffc0206360 <default_pmm_manager+0x748>
ffffffffc0203f00:	00002617          	auipc	a2,0x2
ffffffffc0203f04:	96860613          	addi	a2,a2,-1688 # ffffffffc0205868 <commands+0x738>
ffffffffc0203f08:	10800593          	li	a1,264
ffffffffc0203f0c:	00003517          	auipc	a0,0x3
ffffffffc0203f10:	93450513          	addi	a0,a0,-1740 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203f14:	d32fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f18:	00003697          	auipc	a3,0x3
ffffffffc0203f1c:	af868693          	addi	a3,a3,-1288 # ffffffffc0206a10 <default_pmm_manager+0xdf8>
ffffffffc0203f20:	00002617          	auipc	a2,0x2
ffffffffc0203f24:	94860613          	addi	a2,a2,-1720 # ffffffffc0205868 <commands+0x738>
ffffffffc0203f28:	10d00593          	li	a1,269
ffffffffc0203f2c:	00003517          	auipc	a0,0x3
ffffffffc0203f30:	91450513          	addi	a0,a0,-1772 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203f34:	d12fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f38:	00003697          	auipc	a3,0x3
ffffffffc0203f3c:	af868693          	addi	a3,a3,-1288 # ffffffffc0206a30 <default_pmm_manager+0xe18>
ffffffffc0203f40:	00002617          	auipc	a2,0x2
ffffffffc0203f44:	92860613          	addi	a2,a2,-1752 # ffffffffc0205868 <commands+0x738>
ffffffffc0203f48:	11700593          	li	a1,279
ffffffffc0203f4c:	00003517          	auipc	a0,0x3
ffffffffc0203f50:	8f450513          	addi	a0,a0,-1804 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203f54:	cf2fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f58:	00002617          	auipc	a2,0x2
ffffffffc0203f5c:	dc860613          	addi	a2,a2,-568 # ffffffffc0205d20 <default_pmm_manager+0x108>
ffffffffc0203f60:	06200593          	li	a1,98
ffffffffc0203f64:	00002517          	auipc	a0,0x2
ffffffffc0203f68:	d1450513          	addi	a0,a0,-748 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc0203f6c:	cdafc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f70:	00002617          	auipc	a2,0x2
ffffffffc0203f74:	ce060613          	addi	a2,a2,-800 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc0203f78:	06900593          	li	a1,105
ffffffffc0203f7c:	00002517          	auipc	a0,0x2
ffffffffc0203f80:	cfc50513          	addi	a0,a0,-772 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc0203f84:	cc2fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f88:	00003697          	auipc	a3,0x3
ffffffffc0203f8c:	ab868693          	addi	a3,a3,-1352 # ffffffffc0206a40 <default_pmm_manager+0xe28>
ffffffffc0203f90:	00002617          	auipc	a2,0x2
ffffffffc0203f94:	8d860613          	addi	a2,a2,-1832 # ffffffffc0205868 <commands+0x738>
ffffffffc0203f98:	12400593          	li	a1,292
ffffffffc0203f9c:	00003517          	auipc	a0,0x3
ffffffffc0203fa0:	8a450513          	addi	a0,a0,-1884 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203fa4:	ca2fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203fa8:	00002697          	auipc	a3,0x2
ffffffffc0203fac:	3a868693          	addi	a3,a3,936 # ffffffffc0206350 <default_pmm_manager+0x738>
ffffffffc0203fb0:	00002617          	auipc	a2,0x2
ffffffffc0203fb4:	8b860613          	addi	a2,a2,-1864 # ffffffffc0205868 <commands+0x738>
ffffffffc0203fb8:	10500593          	li	a1,261
ffffffffc0203fbc:	00003517          	auipc	a0,0x3
ffffffffc0203fc0:	88450513          	addi	a0,a0,-1916 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203fc4:	c82fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fc8:	00002697          	auipc	a3,0x2
ffffffffc0203fcc:	36068693          	addi	a3,a3,864 # ffffffffc0206328 <default_pmm_manager+0x710>
ffffffffc0203fd0:	00002617          	auipc	a2,0x2
ffffffffc0203fd4:	89860613          	addi	a2,a2,-1896 # ffffffffc0205868 <commands+0x738>
ffffffffc0203fd8:	0c200593          	li	a1,194
ffffffffc0203fdc:	00003517          	auipc	a0,0x3
ffffffffc0203fe0:	86450513          	addi	a0,a0,-1948 # ffffffffc0206840 <default_pmm_manager+0xc28>
ffffffffc0203fe4:	c62fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0203fe8 <do_pgfault>:
...
ffffffffc0203ff2:	e84a                	sd	s2,16(sp)
ffffffffc0203ff4:	8432                	mv	s0,a2
ffffffffc0203ff6:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203ff8:	8dfff0ef          	jal	ra,ffffffffc02038d6 <find_vma>

    pgfault_num++;
ffffffffc0203ffc:	00011797          	auipc	a5,0x11
ffffffffc0204000:	5ac7a783          	lw	a5,1452(a5) # ffffffffc02155a8 <pgfault_num>
ffffffffc0204004:	2785                	addiw	a5,a5,1
ffffffffc0204006:	00011717          	auipc	a4,0x11
ffffffffc020400a:	5af72123          	sw	a5,1442(a4) # ffffffffc02155a8 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc020400e:	c541                	beqz	a0,ffffffffc0204096 <do_pgfault+0xae>
ffffffffc0204010:	651c                	ld	a5,8(a0)
ffffffffc0204012:	08f46263          	bltu	s0,a5,ffffffffc0204096 <do_pgfault+0xae>
...
ffffffffc0204016:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0204018:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc020401a:	8b89                	andi	a5,a5,2
ffffffffc020401c:	ebb9                	bnez	a5,ffffffffc0204072 <do_pgfault+0x8a>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc020401e:	75fd                	lui	a1,0xfffff
...
ffffffffc0204020:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204022:	8c6d                	and	s0,s0,a1
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc0204024:	4605                	li	a2,1
ffffffffc0204026:	85a2                	mv	a1,s0
ffffffffc0204028:	b11fd0ef          	jal	ra,ffffffffc0201b38 <get_pte>
ffffffffc020402c:	c551                	beqz	a0,ffffffffc02040b8 <do_pgfault+0xd0>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc020402e:	610c                	ld	a1,0(a0)
ffffffffc0204030:	c1b9                	beqz	a1,ffffffffc0204076 <do_pgfault+0x8e>
        ...
        */
        if (swap_init_ok) {
ffffffffc0204032:	00011797          	auipc	a5,0x11
ffffffffc0204036:	5667a783          	lw	a5,1382(a5) # ffffffffc0215598 <swap_init_ok>
ffffffffc020403a:	c7bd                	beqz	a5,ffffffffc02040a8 <do_pgfault+0xc0>
...
ffffffffc020403c:	85a2                	mv	a1,s0
ffffffffc020403e:	0030                	addi	a2,sp,8
ffffffffc0204040:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0204042:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page); 
ffffffffc0204044:	b86ff0ef          	jal	ra,ffffffffc02033ca <swap_in>
            page_insert(mm->pgdir, page, addr, perm); 
ffffffffc0204048:	65a2                	ld	a1,8(sp)
ffffffffc020404a:	6c88                	ld	a0,24(s1)
ffffffffc020404c:	86ca                	mv	a3,s2
ffffffffc020404e:	8622                	mv	a2,s0
ffffffffc0204050:	dabfd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0204054:	6622                	ld	a2,8(sp)
ffffffffc0204056:	4685                	li	a3,1
ffffffffc0204058:	85a2                	mv	a1,s0
ffffffffc020405a:	8526                	mv	a0,s1
ffffffffc020405c:	a4eff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0204060:	67a2                	ld	a5,8(sp)
...
ffffffffc020406a:	64e2                	ld	s1,24(sp)
ffffffffc020406c:	6942                	ld	s2,16(sp)
ffffffffc020406e:	6145                	addi	sp,sp,48
ffffffffc0204070:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204072:	495d                	li	s2,23
ffffffffc0204074:	b76d                	j	ffffffffc020401e <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204076:	6c88                	ld	a0,24(s1)
ffffffffc0204078:	864a                	mv	a2,s2
ffffffffc020407a:	85a2                	mv	a1,s0
ffffffffc020407c:	a15fe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
ffffffffc0204080:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0204082:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204084:	f3ed                	bnez	a5,ffffffffc0204066 <do_pgfault+0x7e>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0204086:	00003517          	auipc	a0,0x3
ffffffffc020408a:	a8250513          	addi	a0,a0,-1406 # ffffffffc0206b08 <default_pmm_manager+0xef0>
ffffffffc020408e:	8f2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204092:	5571                	li	a0,-4
            goto failed;
ffffffffc0204094:	bfc9                	j	ffffffffc0204066 <do_pgfault+0x7e>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0204096:	85a2                	mv	a1,s0
ffffffffc0204098:	00003517          	auipc	a0,0x3
ffffffffc020409c:	a2050513          	addi	a0,a0,-1504 # ffffffffc0206ab8 <default_pmm_manager+0xea0>
ffffffffc02040a0:	8e0fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc02040a4:	5575                	li	a0,-3
        goto failed;
ffffffffc02040a6:	b7c1                	j	ffffffffc0204066 <do_pgfault+0x7e>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040a8:	00003517          	auipc	a0,0x3
ffffffffc02040ac:	a8850513          	addi	a0,a0,-1400 # ffffffffc0206b30 <default_pmm_manager+0xf18>
ffffffffc02040b0:	8d0fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040b4:	5571                	li	a0,-4
            goto failed;
ffffffffc02040b6:	bf45                	j	ffffffffc0204066 <do_pgfault+0x7e>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040b8:	00003517          	auipc	a0,0x3
ffffffffc02040bc:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206ae8 <default_pmm_manager+0xed0>
ffffffffc02040c0:	8c0fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040c4:	5571                	li	a0,-4
        goto failed;
ffffffffc02040c6:	b745                	j	ffffffffc0204066 <do_pgfault+0x7e>

ffffffffc02040c8 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc02040cc:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040ce:	c9afc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040d2:	cd01                	beqz	a0,ffffffffc02040ea <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040d4:	4505                	li	a0,1
ffffffffc02040d6:	c98fc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040da:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040dc:	810d                	srli	a0,a0,0x3
ffffffffc02040de:	00011797          	auipc	a5,0x11
ffffffffc02040e2:	4aa7b523          	sd	a0,1194(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc02040e6:	0141                	addi	sp,sp,16
ffffffffc02040e8:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040ea:	00003617          	auipc	a2,0x3
ffffffffc02040ee:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0206b58 <default_pmm_manager+0xf40>
ffffffffc02040f2:	45b5                	li	a1,13
ffffffffc02040f4:	00003517          	auipc	a0,0x3
ffffffffc02040f8:	a8450513          	addi	a0,a0,-1404 # ffffffffc0206b78 <default_pmm_manager+0xf60>
ffffffffc02040fc:	b4afc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204100 <swapfs_read>:
...
ffffffffc0204108:	cbb1                	beqz	a5,ffffffffc020415c <swapfs_read+0x5c>
ffffffffc020410a:	00011717          	auipc	a4,0x11
ffffffffc020410e:	47e73703          	ld	a4,1150(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc0204112:	04e7f563          	bgeu	a5,a4,ffffffffc020415c <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204116:	00011617          	auipc	a2,0x11
ffffffffc020411a:	45a63603          	ld	a2,1114(a2) # ffffffffc0215570 <pages>
ffffffffc020411e:	8d91                	sub	a1,a1,a2
ffffffffc0204120:	4065d613          	srai	a2,a1,0x6
ffffffffc0204124:	00003717          	auipc	a4,0x3
ffffffffc0204128:	e8473703          	ld	a4,-380(a4) # ffffffffc0206fa8 <nbase>
ffffffffc020412c:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc020412e:	00c61713          	slli	a4,a2,0xc
ffffffffc0204132:	8331                	srli	a4,a4,0xc
ffffffffc0204134:	00011697          	auipc	a3,0x11
ffffffffc0204138:	4346b683          	ld	a3,1076(a3) # ffffffffc0215568 <npage>
ffffffffc020413c:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204140:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204142:	02d77963          	bgeu	a4,a3,ffffffffc0204174 <swapfs_read+0x74>
}
ffffffffc0204146:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204148:	00011797          	auipc	a5,0x11
ffffffffc020414c:	4387b783          	ld	a5,1080(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc0204150:	46a1                	li	a3,8
ffffffffc0204152:	963e                	add	a2,a2,a5
ffffffffc0204154:	4505                	li	a0,1
}
ffffffffc0204156:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204158:	c1cfc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc020415c:	86aa                	mv	a3,a0
ffffffffc020415e:	00003617          	auipc	a2,0x3
ffffffffc0204162:	a3260613          	addi	a2,a2,-1486 # ffffffffc0206b90 <default_pmm_manager+0xf78>
ffffffffc0204166:	45d1                	li	a1,20
ffffffffc0204168:	00003517          	auipc	a0,0x3
ffffffffc020416c:	a1050513          	addi	a0,a0,-1520 # ffffffffc0206b78 <default_pmm_manager+0xf60>
ffffffffc0204170:	ad6fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204174:	86b2                	mv	a3,a2
ffffffffc0204176:	06900593          	li	a1,105
ffffffffc020417a:	00002617          	auipc	a2,0x2
ffffffffc020417e:	ad660613          	addi	a2,a2,-1322 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc0204182:	00002517          	auipc	a0,0x2
ffffffffc0204186:	af650513          	addi	a0,a0,-1290 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc020418a:	abcfc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020418e <swapfs_write>:
...
ffffffffc0204192:	00855793          	srli	a5,a0,0x8
ffffffffc0204196:	cbb1                	beqz	a5,ffffffffc02041ea <swapfs_write+0x5c>
ffffffffc0204198:	00011717          	auipc	a4,0x11
ffffffffc020419c:	3f073703          	ld	a4,1008(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc02041a0:	04e7f563          	bgeu	a5,a4,ffffffffc02041ea <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041a4:	00011617          	auipc	a2,0x11
ffffffffc02041a8:	3cc63603          	ld	a2,972(a2) # ffffffffc0215570 <pages>
ffffffffc02041ac:	8d91                	sub	a1,a1,a2
ffffffffc02041ae:	4065d613          	srai	a2,a1,0x6
ffffffffc02041b2:	00003717          	auipc	a4,0x3
ffffffffc02041b6:	df673703          	ld	a4,-522(a4) # ffffffffc0206fa8 <nbase>
ffffffffc02041ba:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041bc:	00c61713          	slli	a4,a2,0xc
ffffffffc02041c0:	8331                	srli	a4,a4,0xc
ffffffffc02041c2:	00011697          	auipc	a3,0x11
ffffffffc02041c6:	3a66b683          	ld	a3,934(a3) # ffffffffc0215568 <npage>
ffffffffc02041ca:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041ce:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041d0:	02d77963          	bgeu	a4,a3,ffffffffc0204202 <swapfs_write+0x74>
}
ffffffffc02041d4:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041d6:	00011797          	auipc	a5,0x11
ffffffffc02041da:	3aa7b783          	ld	a5,938(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc02041de:	46a1                	li	a3,8
ffffffffc02041e0:	963e                	add	a2,a2,a5
ffffffffc02041e2:	4505                	li	a0,1
}
ffffffffc02041e4:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041e6:	bb2fc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc02041ea:	86aa                	mv	a3,a0
ffffffffc02041ec:	00003617          	auipc	a2,0x3
ffffffffc02041f0:	9a460613          	addi	a2,a2,-1628 # ffffffffc0206b90 <default_pmm_manager+0xf78>
ffffffffc02041f4:	45e5                	li	a1,25
ffffffffc02041f6:	00003517          	auipc	a0,0x3
ffffffffc02041fa:	98250513          	addi	a0,a0,-1662 # ffffffffc0206b78 <default_pmm_manager+0xf60>
ffffffffc02041fe:	a48fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204202:	86b2                	mv	a3,a2
ffffffffc0204204:	06900593          	li	a1,105
ffffffffc0204208:	00002617          	auipc	a2,0x2
ffffffffc020420c:	a4860613          	addi	a2,a2,-1464 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc0204210:	00002517          	auipc	a0,0x2
ffffffffc0204214:	a6850513          	addi	a0,a0,-1432 # ffffffffc0205c78 <default_pmm_manager+0x60>
...
ffffffffc020421e:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204220:	424000ef          	jal	ra,ffffffffc0204644 <do_exit>
...
ffffffffc020422c:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc020422e:	e20fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0204232:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204234:	c521                	beqz	a0,ffffffffc020427c <alloc_proc+0x58>
     ...
     */
        ...
        proc->pid = -1;
        proc->cr3 = boot_cr3;
ffffffffc0204236:	00011797          	auipc	a5,0x11
ffffffffc020423a:	3227b783          	ld	a5,802(a5) # ffffffffc0215558 <boot_cr3>
ffffffffc020423e:	f55c                	sd	a5,168(a0)
        proc->state = PROC_UNINIT;
ffffffffc0204240:	57fd                	li	a5,-1
ffffffffc0204242:	1782                	slli	a5,a5,0x20
        proc->runs = 0;
        proc->kstack = 0;
        proc->need_resched = 0;
        proc->parent = NULL;
...
ffffffffc020424a:	e11c                	sd	a5,0(a0)
        proc->runs = 0;
ffffffffc020424c:	00052423          	sw	zero,8(a0)
        proc->kstack = 0;
ffffffffc0204250:	00053823          	sd	zero,16(a0)
        proc->need_resched = 0;
ffffffffc0204254:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;
ffffffffc0204258:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;
ffffffffc020425c:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204260:	03050513          	addi	a0,a0,48
ffffffffc0204264:	417000ef          	jal	ra,ffffffffc0204e7a <memset>
        proc->tf = NULL;
        proc->flags = 0;
...
ffffffffc0204274:	0b440513          	addi	a0,s0,180
ffffffffc0204278:	403000ef          	jal	ra,ffffffffc0204e7a <memset>

    }
    return proc;
}
ffffffffc020427c:	60a2                	ld	ra,8(sp)
ffffffffc020427e:	8522                	mv	a0,s0
ffffffffc0204280:	6402                	ld	s0,0(sp)
ffffffffc0204282:	0141                	addi	sp,sp,16
ffffffffc0204284:	8082                	ret

ffffffffc0204286 <forkret>:
...
forkret(void) {
    forkrets(current->tf);
ffffffffc0204286:	00011797          	auipc	a5,0x11
ffffffffc020428a:	32a7b783          	ld	a5,810(a5) # ffffffffc02155b0 <current>
ffffffffc020428e:	73c8                	ld	a0,160(a5)
ffffffffc0204290:	8ddfc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc0204294 <init_main>:
    panic("process exit!!.\n");
}
...
static int
init_main(void *arg) {
ffffffffc0204294:	7179                	addi	sp,sp,-48
ffffffffc0204296:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc0204298:	00011497          	auipc	s1,0x11
ffffffffc020429c:	28048493          	addi	s1,s1,640 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc02042a0:	f022                	sd	s0,32(sp)
ffffffffc02042a2:	e84a                	sd	s2,16(sp)
ffffffffc02042a4:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042a6:	00011917          	auipc	s2,0x11
ffffffffc02042aa:	30a93903          	ld	s2,778(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
ffffffffc02042ae:	4641                	li	a2,16
ffffffffc02042b0:	4581                	li	a1,0
ffffffffc02042b2:	8526                	mv	a0,s1
init_main(void *arg) {
ffffffffc02042b4:	f406                	sd	ra,40(sp)
ffffffffc02042b6:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042b8:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042bc:	3bf000ef          	jal	ra,ffffffffc0204e7a <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042c0:	0b490593          	addi	a1,s2,180
ffffffffc02042c4:	463d                	li	a2,15
ffffffffc02042c6:	8526                	mv	a0,s1
ffffffffc02042c8:	3c5000ef          	jal	ra,ffffffffc0204e8c <memcpy>
ffffffffc02042cc:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042ce:	85ce                	mv	a1,s3
ffffffffc02042d0:	00003517          	auipc	a0,0x3
ffffffffc02042d4:	8e050513          	addi	a0,a0,-1824 # ffffffffc0206bb0 <default_pmm_manager+0xf98>
ffffffffc02042d8:	ea9fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042dc:	85a2                	mv	a1,s0
ffffffffc02042de:	00003517          	auipc	a0,0x3
ffffffffc02042e2:	8fa50513          	addi	a0,a0,-1798 # ffffffffc0206bd8 <default_pmm_manager+0xfc0>
ffffffffc02042e6:	e9bfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042ea:	00003517          	auipc	a0,0x3
ffffffffc02042ee:	8fe50513          	addi	a0,a0,-1794 # ffffffffc0206be8 <default_pmm_manager+0xfd0>
...
ffffffffc0204306 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204306:	7179                	addi	sp,sp,-48
ffffffffc0204308:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc020430a:	00011917          	auipc	s2,0x11
ffffffffc020430e:	2a690913          	addi	s2,s2,678 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204312:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204314:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204318:	f406                	sd	ra,40(sp)
ffffffffc020431a:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc020431c:	02a48963          	beq	s1,a0,ffffffffc020434e <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204320:	100027f3          	csrr	a5,sstatus
ffffffffc0204324:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204326:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204328:	e3a1                	bnez	a5,ffffffffc0204368 <proc_run+0x62>
            lcr3(next->cr3);
ffffffffc020432a:	755c                	ld	a5,168(a0)
...
ffffffffc020432c:	80000737          	lui	a4,0x80000
            current = proc;
ffffffffc0204330:	00a93023          	sd	a0,0(s2)
ffffffffc0204334:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204338:	8fd9                	or	a5,a5,a4
ffffffffc020433a:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));
ffffffffc020433e:	03050593          	addi	a1,a0,48
ffffffffc0204342:	03048513          	addi	a0,s1,48
ffffffffc0204346:	584000ef          	jal	ra,ffffffffc02048ca <switch_to>
    if (flag) {
ffffffffc020434a:	00099863          	bnez	s3,ffffffffc020435a <proc_run+0x54>
}
ffffffffc020434e:	70a2                	ld	ra,40(sp)
ffffffffc0204350:	7482                	ld	s1,32(sp)
ffffffffc0204352:	6962                	ld	s2,24(sp)
ffffffffc0204354:	69c2                	ld	s3,16(sp)
ffffffffc0204356:	6145                	addi	sp,sp,48
ffffffffc0204358:	8082                	ret
ffffffffc020435a:	70a2                	ld	ra,40(sp)
ffffffffc020435c:	7482                	ld	s1,32(sp)
ffffffffc020435e:	6962                	ld	s2,24(sp)
ffffffffc0204360:	69c2                	ld	s3,16(sp)
ffffffffc0204362:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204364:	a58fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204368:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020436a:	a58fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020436e:	6522                	ld	a0,8(sp)
ffffffffc0204370:	4985                	li	s3,1
ffffffffc0204372:	bf65                	j	ffffffffc020432a <proc_run+0x24>

ffffffffc0204374 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204374:	7179                	addi	sp,sp,-48
ffffffffc0204376:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204378:	00011497          	auipc	s1,0x11
ffffffffc020437c:	25048493          	addi	s1,s1,592 # ffffffffc02155c8 <nr_process>
ffffffffc0204380:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204382:	f406                	sd	ra,40(sp)
ffffffffc0204384:	f022                	sd	s0,32(sp)
ffffffffc0204386:	e84a                	sd	s2,16(sp)
ffffffffc0204388:	e44e                	sd	s3,8(sp)
ffffffffc020438a:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020438c:	6785                	lui	a5,0x1
ffffffffc020438e:	22f75063          	bge	a4,a5,ffffffffc02045ae <do_fork+0x23a>
ffffffffc0204392:	892e                	mv	s2,a1
ffffffffc0204394:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0204396:	e8fff0ef          	jal	ra,ffffffffc0204224 <alloc_proc>
ffffffffc020439a:	89aa                	mv	s3,a0
ffffffffc020439c:	20050e63          	beqz	a0,ffffffffc02045b8 <do_fork+0x244>
    proc->parent = current;  // 子进程的父进程是当前进程
ffffffffc02043a0:	00011a17          	auipc	s4,0x11
ffffffffc02043a4:	210a0a13          	addi	s4,s4,528 # ffffffffc02155b0 <current>
ffffffffc02043a8:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043ac:	4509                	li	a0,2
    proc->parent = current;  // 子进程的父进程是当前进程
ffffffffc02043ae:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043b2:	e7afd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043b6:	1e050763          	beqz	a0,ffffffffc02045a4 <do_fork+0x230>
    return page - pages + nbase;
...
ffffffffc02043cc:	be053503          	ld	a0,-1056(a0) # ffffffffc0206fa8 <nbase>
...
ffffffffc02043e0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043e2:	1ee7fd63          	bgeu	a5,a4,ffffffffc02045dc <do_fork+0x268>
    assert(current->mm == NULL);
ffffffffc02043e6:	000a3783          	ld	a5,0(s4)
ffffffffc02043ea:	00011717          	auipc	a4,0x11
ffffffffc02043ee:	19673703          	ld	a4,406(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043f2:	96ba                	add	a3,a3,a4
ffffffffc02043f4:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043f6:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043fa:	1c079163          	bnez	a5,ffffffffc02045bc <do_fork+0x248>
...
ffffffffc0204404:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204406:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204408:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc020440c:	87b6                	mv	a5,a3
ffffffffc020440e:	12040893          	addi	a7,s0,288
ffffffffc0204412:	00063803          	ld	a6,0(a2)
ffffffffc0204416:	6608                	ld	a0,8(a2)
ffffffffc0204418:	6a0c                	ld	a1,16(a2)
ffffffffc020441a:	6e18                	ld	a4,24(a2)
ffffffffc020441c:	0107b023          	sd	a6,0(a5)
ffffffffc0204420:	e788                	sd	a0,8(a5)
ffffffffc0204422:	eb8c                	sd	a1,16(a5)
ffffffffc0204424:	ef98                	sd	a4,24(a5)
ffffffffc0204426:	02060613          	addi	a2,a2,32
ffffffffc020442a:	02078793          	addi	a5,a5,32
ffffffffc020442e:	ff1612e3          	bne	a2,a7,ffffffffc0204412 <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc0204432:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204436:	12090563          	beqz	s2,ffffffffc0204560 <do_fork+0x1ec>
ffffffffc020443a:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020443e:	00000797          	auipc	a5,0x0
ffffffffc0204442:	e4878793          	addi	a5,a5,-440 # ffffffffc0204286 <forkret>
ffffffffc0204446:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020444a:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204454:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204456:	12079663          	bnez	a5,ffffffffc0204582 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc020445a:	00006817          	auipc	a6,0x6
ffffffffc020445e:	bfe80813          	addi	a6,a6,-1026 # ffffffffc020a058 <last_pid.1>
ffffffffc0204462:	00082783          	lw	a5,0(a6)
ffffffffc0204466:	6709                	lui	a4,0x2
ffffffffc0204468:	0017851b          	addiw	a0,a5,1
ffffffffc020446c:	00a82023          	sw	a0,0(a6)
ffffffffc0204470:	08e55163          	bge	a0,a4,ffffffffc02044f2 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204474:	00006317          	auipc	t1,0x6
ffffffffc0204478:	be830313          	addi	t1,t1,-1048 # ffffffffc020a05c <next_safe.0>
ffffffffc020447c:	00032783          	lw	a5,0(t1)
ffffffffc0204480:	00011417          	auipc	s0,0x11
ffffffffc0204484:	0a840413          	addi	s0,s0,168 # ffffffffc0215528 <proc_list>
ffffffffc0204488:	06f55d63          	bge	a0,a5,ffffffffc0204502 <do_fork+0x18e>
        proc->pid = get_pid();  // 获取当前pid
ffffffffc020448c:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204490:	45a9                	li	a1,10
ffffffffc0204492:	2501                	sext.w	a0,a0
ffffffffc0204494:	566000ef          	jal	ra,ffffffffc02049fa <hash32>
ffffffffc0204498:	02051793          	slli	a5,a0,0x20
ffffffffc020449c:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044a0:	0000d797          	auipc	a5,0xd
ffffffffc02044a4:	07878793          	addi	a5,a5,120 # ffffffffc0211518 <hash_list>
ffffffffc02044a8:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044aa:	6510                	ld	a2,8(a0)
ffffffffc02044ac:	0d898793          	addi	a5,s3,216
ffffffffc02044b0:	6414                	ld	a3,8(s0)
        nr_process++;  // 更新进程数
ffffffffc02044b2:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044b4:	e21c                	sd	a5,0(a2)
ffffffffc02044b6:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044b8:	0ec9b023          	sd	a2,224(s3)
        list_add(&proc_list, &proc->list_link); 
ffffffffc02044bc:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044c0:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044c4:	e29c                	sd	a5,0(a3)
        nr_process++;  // 更新进程数
ffffffffc02044c6:	2705                	addiw	a4,a4,1
ffffffffc02044c8:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044ca:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044ce:	0c89b423          	sd	s0,200(s3)
ffffffffc02044d2:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044d4:	0a091b63          	bnez	s2,ffffffffc020458a <do_fork+0x216>
    wakeup_proc(proc);
ffffffffc02044d8:	854e                	mv	a0,s3
ffffffffc02044da:	45a000ef          	jal	ra,ffffffffc0204934 <wakeup_proc>
    ret = proc->pid;
ffffffffc02044de:	0049a503          	lw	a0,4(s3)
}
...
ffffffffc02044ec:	6a02                	ld	s4,0(sp)
...
ffffffffc02044fe:	b6230313          	addi	t1,t1,-1182 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc0204502:	00011417          	auipc	s0,0x11
ffffffffc0204506:	02640413          	addi	s0,s0,38 # ffffffffc0215528 <proc_list>
ffffffffc020450a:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
...
ffffffffc0204516:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204518:	6e89                	lui	t4,0x2
ffffffffc020451a:	088e0063          	beq	t3,s0,ffffffffc020459a <do_fork+0x226>
ffffffffc020451e:	88ae                	mv	a7,a1
ffffffffc0204520:	87f2                	mv	a5,t3
ffffffffc0204522:	6609                	lui	a2,0x2
ffffffffc0204524:	a811                	j	ffffffffc0204538 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204526:	00e6d663          	bge	a3,a4,ffffffffc0204532 <do_fork+0x1be>
ffffffffc020452a:	00c75463          	bge	a4,a2,ffffffffc0204532 <do_fork+0x1be>
ffffffffc020452e:	863a                	mv	a2,a4
ffffffffc0204530:	4885                	li	a7,1
ffffffffc0204532:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204534:	00878d63          	beq	a5,s0,ffffffffc020454e <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc0204538:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020453c:	fed715e3          	bne	a4,a3,ffffffffc0204526 <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204540:	2685                	addiw	a3,a3,1
ffffffffc0204542:	04c6d763          	bge	a3,a2,ffffffffc0204590 <do_fork+0x21c>
ffffffffc0204546:	679c                	ld	a5,8(a5)
ffffffffc0204548:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020454a:	fe8797e3          	bne	a5,s0,ffffffffc0204538 <do_fork+0x1c4>
ffffffffc020454e:	c581                	beqz	a1,ffffffffc0204556 <do_fork+0x1e2>
ffffffffc0204550:	00d82023          	sw	a3,0(a6)
ffffffffc0204554:	8536                	mv	a0,a3
ffffffffc0204556:	f2088be3          	beqz	a7,ffffffffc020448c <do_fork+0x118>
ffffffffc020455a:	00c32023          	sw	a2,0(t1)
ffffffffc020455e:	b73d                	j	ffffffffc020448c <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204560:	8936                	mv	s2,a3
ffffffffc0204562:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204566:	00000797          	auipc	a5,0x0
ffffffffc020456a:	d2078793          	addi	a5,a5,-736 # ffffffffc0204286 <forkret>
ffffffffc020456e:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204572:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204576:	100027f3          	csrr	a5,sstatus
ffffffffc020457a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020457c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020457e:	ec078ee3          	beqz	a5,ffffffffc020445a <do_fork+0xe6>
        intr_disable();
ffffffffc0204582:	840fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204586:	4905                	li	s2,1
ffffffffc0204588:	bdc9                	j	ffffffffc020445a <do_fork+0xe6>
        intr_enable();
ffffffffc020458a:	832fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020458e:	b7a9                	j	ffffffffc02044d8 <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc0204590:	01d6c363          	blt	a3,t4,ffffffffc0204596 <do_fork+0x222>
                        last_pid = 1;
ffffffffc0204594:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204596:	4585                	li	a1,1
ffffffffc0204598:	b749                	j	ffffffffc020451a <do_fork+0x1a6>
ffffffffc020459a:	cd81                	beqz	a1,ffffffffc02045b2 <do_fork+0x23e>
ffffffffc020459c:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045a0:	8536                	mv	a0,a3
ffffffffc02045a2:	b5ed                	j	ffffffffc020448c <do_fork+0x118>
    kfree(proc);
ffffffffc02045a4:	854e                	mv	a0,s3
ffffffffc02045a6:	b58fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045aa:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045ac:	bf1d                	j	ffffffffc02044e2 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045ae:	556d                	li	a0,-5
ffffffffc02045b0:	bf0d                	j	ffffffffc02044e2 <do_fork+0x16e>
    return last_pid;
ffffffffc02045b2:	00082503          	lw	a0,0(a6)
ffffffffc02045b6:	bdd9                	j	ffffffffc020448c <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc02045b8:	5571                	li	a0,-4
    return ret;
ffffffffc02045ba:	b725                	j	ffffffffc02044e2 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc02045bc:	00002697          	auipc	a3,0x2
ffffffffc02045c0:	64c68693          	addi	a3,a3,1612 # ffffffffc0206c08 <default_pmm_manager+0xff0>
ffffffffc02045c4:	00001617          	auipc	a2,0x1
ffffffffc02045c8:	2a460613          	addi	a2,a2,676 # ffffffffc0205868 <commands+0x738>
ffffffffc02045cc:	10500593          	li	a1,261
ffffffffc02045d0:	00002517          	auipc	a0,0x2
ffffffffc02045d4:	65050513          	addi	a0,a0,1616 # ffffffffc0206c20 <default_pmm_manager+0x1008>
ffffffffc02045d8:	e6ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02045dc:	00001617          	auipc	a2,0x1
ffffffffc02045e0:	67460613          	addi	a2,a2,1652 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc02045e4:	06900593          	li	a1,105
ffffffffc02045e8:	00001517          	auipc	a0,0x1
ffffffffc02045ec:	69050513          	addi	a0,a0,1680 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc02045f0:	e57fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02045f4 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045f4:	7129                	addi	sp,sp,-320
ffffffffc02045f6:	fa22                	sd	s0,304(sp)
ffffffffc02045f8:	f626                	sd	s1,296(sp)
ffffffffc02045fa:	f24a                	sd	s2,288(sp)
ffffffffc02045fc:	84ae                	mv	s1,a1
ffffffffc02045fe:	892a                	mv	s2,a0
ffffffffc0204600:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204602:	4581                	li	a1,0
ffffffffc0204604:	12000613          	li	a2,288
ffffffffc0204608:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020460a:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020460c:	06f000ef          	jal	ra,ffffffffc0204e7a <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0204610:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0204612:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0204614:	100027f3          	csrr	a5,sstatus
ffffffffc0204618:	edd7f793          	andi	a5,a5,-291
ffffffffc020461c:	1207e793          	ori	a5,a5,288
ffffffffc0204620:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204622:	860a                	mv	a2,sp
ffffffffc0204624:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204628:	00000797          	auipc	a5,0x0
ffffffffc020462c:	bf478793          	addi	a5,a5,-1036 # ffffffffc020421c <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204630:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204632:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204634:	d41ff0ef          	jal	ra,ffffffffc0204374 <do_fork>
}
ffffffffc0204638:	70f2                	ld	ra,312(sp)
ffffffffc020463a:	7452                	ld	s0,304(sp)
ffffffffc020463c:	74b2                	ld	s1,296(sp)
ffffffffc020463e:	7912                	ld	s2,288(sp)
ffffffffc0204640:	6131                	addi	sp,sp,320
ffffffffc0204642:	8082                	ret

ffffffffc0204644 <do_exit>:
do_exit(int error_code) {
ffffffffc0204644:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0204646:	00002617          	auipc	a2,0x2
ffffffffc020464a:	5f260613          	addi	a2,a2,1522 # ffffffffc0206c38 <default_pmm_manager+0x1020>
ffffffffc020464e:	16700593          	li	a1,359
ffffffffc0204652:	00002517          	auipc	a0,0x2
ffffffffc0204656:	5ce50513          	addi	a0,a0,1486 # ffffffffc0206c20 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc020465a:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020465c:	debfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204660 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204660:	7179                	addi	sp,sp,-48
ffffffffc0204662:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0204664:	00011797          	auipc	a5,0x11
ffffffffc0204668:	ec478793          	addi	a5,a5,-316 # ffffffffc0215528 <proc_list>
ffffffffc020466c:	f406                	sd	ra,40(sp)
ffffffffc020466e:	f022                	sd	s0,32(sp)
ffffffffc0204670:	e84a                	sd	s2,16(sp)
ffffffffc0204672:	e44e                	sd	s3,8(sp)
ffffffffc0204674:	0000d497          	auipc	s1,0xd
ffffffffc0204678:	ea448493          	addi	s1,s1,-348 # ffffffffc0211518 <hash_list>
...
ffffffffc0204684:	e9870713          	addi	a4,a4,-360 # ffffffffc0215518 <name.2>
ffffffffc0204688:	87a6                	mv	a5,s1
ffffffffc020468a:	e79c                	sd	a5,8(a5)
ffffffffc020468c:	e39c                	sd	a5,0(a5)
ffffffffc020468e:	07c1                	addi	a5,a5,16
ffffffffc0204690:	fef71de3          	bne	a4,a5,ffffffffc020468a <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204694:	b91ff0ef          	jal	ra,ffffffffc0204224 <alloc_proc>
ffffffffc0204698:	00011917          	auipc	s2,0x11
ffffffffc020469c:	f2090913          	addi	s2,s2,-224 # ffffffffc02155b8 <idleproc>
ffffffffc02046a0:	00a93023          	sd	a0,0(s2)
ffffffffc02046a4:	18050d63          	beqz	a0,ffffffffc020483e <proc_init+0x1de>
...
ffffffffc02046ac:	9a2fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046b0:	07000613          	li	a2,112
ffffffffc02046b4:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046b6:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046b8:	7c2000ef          	jal	ra,ffffffffc0204e7a <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02046bc:	00093503          	ld	a0,0(s2)
ffffffffc02046c0:	85a2                	mv	a1,s0
ffffffffc02046c2:	07000613          	li	a2,112
ffffffffc02046c6:	03050513          	addi	a0,a0,48
ffffffffc02046ca:	7da000ef          	jal	ra,ffffffffc0204ea4 <memcmp>
ffffffffc02046ce:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046d0:	453d                	li	a0,15
...
ffffffffc02046d8:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc02046da:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046dc:	79e000ef          	jal	ra,ffffffffc0204e7a <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc02046e0:	00093503          	ld	a0,0(s2)
ffffffffc02046e4:	463d                	li	a2,15
ffffffffc02046e6:	85a2                	mv	a1,s0
ffffffffc02046e8:	0b450513          	addi	a0,a0,180
ffffffffc02046ec:	7b8000ef          	jal	ra,ffffffffc0204ea4 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc02046f0:	00093783          	ld	a5,0(s2)
ffffffffc02046f4:	00011717          	auipc	a4,0x11
ffffffffc02046f8:	e6473703          	ld	a4,-412(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc02046fc:	77d4                	ld	a3,168(a5)
ffffffffc02046fe:	0ee68463          	beq	a3,a4,ffffffffc02047e6 <proc_init+0x186>
...
ffffffffc0204706:	00003717          	auipc	a4,0x3
ffffffffc020470a:	8fa70713          	addi	a4,a4,-1798 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020470e:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204712:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0204714:	4705                	li	a4,1
ffffffffc0204716:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204718:	4641                	li	a2,16
ffffffffc020471a:	4581                	li	a1,0
ffffffffc020471c:	8522                	mv	a0,s0
ffffffffc020471e:	75c000ef          	jal	ra,ffffffffc0204e7a <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204722:	463d                	li	a2,15
ffffffffc0204724:	00002597          	auipc	a1,0x2
ffffffffc0204728:	55c58593          	addi	a1,a1,1372 # ffffffffc0206c80 <default_pmm_manager+0x1068>
ffffffffc020472c:	8522                	mv	a0,s0
ffffffffc020472e:	75e000ef          	jal	ra,ffffffffc0204e8c <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204732:	00011717          	auipc	a4,0x11
ffffffffc0204736:	e9670713          	addi	a4,a4,-362 # ffffffffc02155c8 <nr_process>
ffffffffc020473a:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc020473c:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204740:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204742:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204744:	00002597          	auipc	a1,0x2
ffffffffc0204748:	54458593          	addi	a1,a1,1348 # ffffffffc0206c88 <default_pmm_manager+0x1070>
ffffffffc020474c:	00000517          	auipc	a0,0x0
ffffffffc0204750:	b4850513          	addi	a0,a0,-1208 # ffffffffc0204294 <init_main>
    nr_process ++;
ffffffffc0204754:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204756:	00011797          	auipc	a5,0x11
ffffffffc020475a:	e4d7bd23          	sd	a3,-422(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020475e:	e97ff0ef          	jal	ra,ffffffffc02045f4 <kernel_thread>
ffffffffc0204762:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0204764:	0ea05963          	blez	a0,ffffffffc0204856 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc0204768:	6789                	lui	a5,0x2
ffffffffc020476a:	fff5071b          	addiw	a4,a0,-1
ffffffffc020476e:	17f9                	addi	a5,a5,-2
ffffffffc0204770:	2501                	sext.w	a0,a0
ffffffffc0204772:	02e7e363          	bltu	a5,a4,ffffffffc0204798 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204776:	45a9                	li	a1,10
ffffffffc0204778:	282000ef          	jal	ra,ffffffffc02049fa <hash32>
ffffffffc020477c:	02051793          	slli	a5,a0,0x20
ffffffffc0204780:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204784:	96a6                	add	a3,a3,s1
ffffffffc0204786:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0204788:	a029                	j	ffffffffc0204792 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc020478a:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020478e:	0a870563          	beq	a4,s0,ffffffffc0204838 <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204792:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204794:	fef69be3          	bne	a3,a5,ffffffffc020478a <proc_init+0x12a>
    return NULL;
...
ffffffffc02047a2:	00011417          	auipc	s0,0x11
ffffffffc02047a6:	e1e40413          	addi	s0,s0,-482 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047aa:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047ac:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047ae:	6cc000ef          	jal	ra,ffffffffc0204e7a <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047b2:	463d                	li	a2,15
ffffffffc02047b4:	00002597          	auipc	a1,0x2
ffffffffc02047b8:	50458593          	addi	a1,a1,1284 # ffffffffc0206cb8 <default_pmm_manager+0x10a0>
ffffffffc02047bc:	8526                	mv	a0,s1
ffffffffc02047be:	6ce000ef          	jal	ra,ffffffffc0204e8c <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02047c2:	00093783          	ld	a5,0(s2)
ffffffffc02047c6:	c7e1                	beqz	a5,ffffffffc020488e <proc_init+0x22e>
ffffffffc02047c8:	43dc                	lw	a5,4(a5)
ffffffffc02047ca:	e3f1                	bnez	a5,ffffffffc020488e <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047cc:	601c                	ld	a5,0(s0)
ffffffffc02047ce:	c3c5                	beqz	a5,ffffffffc020486e <proc_init+0x20e>
ffffffffc02047d0:	43d8                	lw	a4,4(a5)
ffffffffc02047d2:	4785                	li	a5,1
ffffffffc02047d4:	08f71d63          	bne	a4,a5,ffffffffc020486e <proc_init+0x20e>
}
...
ffffffffc02047e8:	ff09                	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
ffffffffc02047ea:	f0099ce3          	bnez	s3,ffffffffc0204702 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc02047ee:	6394                	ld	a3,0(a5)
ffffffffc02047f0:	577d                	li	a4,-1
ffffffffc02047f2:	1702                	slli	a4,a4,0x20
ffffffffc02047f4:	f0e697e3          	bne	a3,a4,ffffffffc0204702 <proc_init+0xa2>
ffffffffc02047f8:	4798                	lw	a4,8(a5)
ffffffffc02047fa:	f00714e3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047fe:	6b98                	ld	a4,16(a5)
ffffffffc0204800:	f00711e3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
ffffffffc0204804:	4f98                	lw	a4,24(a5)
ffffffffc0204806:	2701                	sext.w	a4,a4
ffffffffc0204808:	ee071de3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
ffffffffc020480c:	7398                	ld	a4,32(a5)
ffffffffc020480e:	ee071ae3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204812:	7798                	ld	a4,40(a5)
ffffffffc0204814:	ee0717e3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
ffffffffc0204818:	0b07a703          	lw	a4,176(a5)
ffffffffc020481c:	8d59                	or	a0,a0,a4
ffffffffc020481e:	0005071b          	sext.w	a4,a0
ffffffffc0204822:	ee0710e3          	bnez	a4,ffffffffc0204702 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0204826:	00002517          	auipc	a0,0x2
ffffffffc020482a:	44250513          	addi	a0,a0,1090 # ffffffffc0206c68 <default_pmm_manager+0x1050>
ffffffffc020482e:	953fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc0204832:	00093783          	ld	a5,0(s2)
ffffffffc0204836:	b5f1                	j	ffffffffc0204702 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204838:	f2878793          	addi	a5,a5,-216
ffffffffc020483c:	bfb9                	j	ffffffffc020479a <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc020483e:	00002617          	auipc	a2,0x2
ffffffffc0204842:	41260613          	addi	a2,a2,1042 # ffffffffc0206c50 <default_pmm_manager+0x1038>
ffffffffc0204846:	17f00593          	li	a1,383
ffffffffc020484a:	00002517          	auipc	a0,0x2
ffffffffc020484e:	3d650513          	addi	a0,a0,982 # ffffffffc0206c20 <default_pmm_manager+0x1008>
ffffffffc0204852:	bf5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204856:	00002617          	auipc	a2,0x2
ffffffffc020485a:	44260613          	addi	a2,a2,1090 # ffffffffc0206c98 <default_pmm_manager+0x1080>
ffffffffc020485e:	19f00593          	li	a1,415
ffffffffc0204862:	00002517          	auipc	a0,0x2
ffffffffc0204866:	3be50513          	addi	a0,a0,958 # ffffffffc0206c20 <default_pmm_manager+0x1008>
ffffffffc020486a:	bddfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020486e:	00002697          	auipc	a3,0x2
ffffffffc0204872:	47a68693          	addi	a3,a3,1146 # ffffffffc0206ce8 <default_pmm_manager+0x10d0>
ffffffffc0204876:	00001617          	auipc	a2,0x1
ffffffffc020487a:	ff260613          	addi	a2,a2,-14 # ffffffffc0205868 <commands+0x738>
ffffffffc020487e:	1a600593          	li	a1,422
ffffffffc0204882:	00002517          	auipc	a0,0x2
ffffffffc0204886:	39e50513          	addi	a0,a0,926 # ffffffffc0206c20 <default_pmm_manager+0x1008>
ffffffffc020488a:	bbdfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020488e:	00002697          	auipc	a3,0x2
ffffffffc0204892:	43268693          	addi	a3,a3,1074 # ffffffffc0206cc0 <default_pmm_manager+0x10a8>
ffffffffc0204896:	00001617          	auipc	a2,0x1
ffffffffc020489a:	fd260613          	addi	a2,a2,-46 # ffffffffc0205868 <commands+0x738>
ffffffffc020489e:	1a500593          	li	a1,421
ffffffffc02048a2:	00002517          	auipc	a0,0x2
ffffffffc02048a6:	37e50513          	addi	a0,a0,894 # ffffffffc0206c20 <default_pmm_manager+0x1008>
ffffffffc02048aa:	b9dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048ae <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc02048ae:	1141                	addi	sp,sp,-16
ffffffffc02048b0:	e022                	sd	s0,0(sp)
ffffffffc02048b2:	e406                	sd	ra,8(sp)
ffffffffc02048b4:	00011417          	auipc	s0,0x11
ffffffffc02048b8:	cfc40413          	addi	s0,s0,-772 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc02048bc:	6018                	ld	a4,0(s0)
ffffffffc02048be:	4f1c                	lw	a5,24(a4)
ffffffffc02048c0:	2781                	sext.w	a5,a5
ffffffffc02048c2:	dff5                	beqz	a5,ffffffffc02048be <cpu_idle+0x10>
            schedule();
ffffffffc02048c4:	0a2000ef          	jal	ra,ffffffffc0204966 <schedule>
ffffffffc02048c8:	bfd5                	j	ffffffffc02048bc <cpu_idle+0xe>

ffffffffc02048ca <switch_to>:
.text
...
ffffffffc02048ca:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048ce:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048d2:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048d4:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048d6:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048da:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048de:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048e2:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048e6:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc02048ea:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc02048ee:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc02048f2:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc02048f6:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02048fa:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02048fe:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204902:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204906:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204908:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020490a:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020490e:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204912:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204916:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020491a:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020491e:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204922:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204926:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020492a:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020492e:	0685bd83          	ld	s11,104(a1)
...
ffffffffc020493a:	00f77563          	bgeu	a4,a5,ffffffffc0204944 <wakeup_proc+0x10>
...
ffffffffc020494a:	3ca68693          	addi	a3,a3,970 # ffffffffc0206d10 <default_pmm_manager+0x10f8>
ffffffffc020494e:	00001617          	auipc	a2,0x1
ffffffffc0204952:	f1a60613          	addi	a2,a2,-230 # ffffffffc0205868 <commands+0x738>
ffffffffc0204956:	45a5                	li	a1,9
ffffffffc0204958:	00002517          	auipc	a0,0x2
ffffffffc020495c:	3f850513          	addi	a0,a0,1016 # ffffffffc0206d50 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204960:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204962:	ae5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
void
schedule(void) {
ffffffffc0204966:	1141                	addi	sp,sp,-16
ffffffffc0204968:	e406                	sd	ra,8(sp)
ffffffffc020496a:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020496c:	100027f3          	csrr	a5,sstatus
ffffffffc0204970:	8b89                	andi	a5,a5,2
ffffffffc0204972:	4401                	li	s0,0
ffffffffc0204974:	efbd                	bnez	a5,ffffffffc02049f2 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204976:	00011897          	auipc	a7,0x11
ffffffffc020497a:	c3a8b883          	ld	a7,-966(a7) # ffffffffc02155b0 <current>
ffffffffc020497e:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204982:	00011517          	auipc	a0,0x11
ffffffffc0204986:	c3653503          	ld	a0,-970(a0) # ffffffffc02155b8 <idleproc>
ffffffffc020498a:	04a88e63          	beq	a7,a0,ffffffffc02049e6 <schedule+0x80>
ffffffffc020498e:	0c888693          	addi	a3,a7,200
ffffffffc0204992:	00011617          	auipc	a2,0x11
ffffffffc0204996:	b9660613          	addi	a2,a2,-1130 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc020499a:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc020499c:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc020499e:	4809                	li	a6,2
ffffffffc02049a0:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049a2:	00c78863          	beq	a5,a2,ffffffffc02049b2 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049a6:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049aa:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ae:	03070163          	beq	a4,a6,ffffffffc02049d0 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049b2:	fef697e3          	bne	a3,a5,ffffffffc02049a0 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049b6:	ed89                	bnez	a1,ffffffffc02049d0 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc02049bc:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02049be:	00a88463          	beq	a7,a0,ffffffffc02049c6 <schedule+0x60>
            proc_run(next);
ffffffffc02049c2:	945ff0ef          	jal	ra,ffffffffc0204306 <proc_run>
    if (flag) {
ffffffffc02049c6:	e819                	bnez	s0,ffffffffc02049dc <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc02049ce:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049d0:	4198                	lw	a4,0(a1)
ffffffffc02049d2:	4789                	li	a5,2
ffffffffc02049d4:	fef712e3          	bne	a4,a5,ffffffffc02049b8 <schedule+0x52>
ffffffffc02049d8:	852e                	mv	a0,a1
ffffffffc02049da:	bff9                	j	ffffffffc02049b8 <schedule+0x52>
}
ffffffffc02049dc:	6402                	ld	s0,0(sp)
ffffffffc02049de:	60a2                	ld	ra,8(sp)
ffffffffc02049e0:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049e2:	bdbfb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049e6:	00011617          	auipc	a2,0x11
ffffffffc02049ea:	b4260613          	addi	a2,a2,-1214 # ffffffffc0215528 <proc_list>
ffffffffc02049ee:	86b2                	mv	a3,a2
ffffffffc02049f0:	b76d                	j	ffffffffc020499a <schedule+0x34>
        intr_disable();
ffffffffc02049f2:	bd1fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049f6:	4405                	li	s0,1
ffffffffc02049f8:	bfbd                	j	ffffffffc0204976 <schedule+0x10>

ffffffffc02049fa <hash32>:
 *
...
ffffffffc02049fa:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049fe:	2785                	addiw	a5,a5,1
ffffffffc0204a00:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a04:	02000793          	li	a5,32
ffffffffc0204a08:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a0a:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a0e:	8082                	ret

ffffffffc0204a10 <printnum>:
 * */
static void
...
ffffffffc0204a10:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a14:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a16:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a1a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a1c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a20:	f022                	sd	s0,32(sp)
ffffffffc0204a22:	ec26                	sd	s1,24(sp)
ffffffffc0204a24:	e84a                	sd	s2,16(sp)
ffffffffc0204a26:	f406                	sd	ra,40(sp)
ffffffffc0204a28:	e44e                	sd	s3,8(sp)
ffffffffc0204a2a:	84aa                	mv	s1,a0
ffffffffc0204a2c:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a2e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a32:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a34:	03067e63          	bgeu	a2,a6,ffffffffc0204a70 <printnum+0x60>
ffffffffc0204a38:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a3a:	00805763          	blez	s0,ffffffffc0204a48 <printnum+0x38>
ffffffffc0204a3e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a40:	85ca                	mv	a1,s2
ffffffffc0204a42:	854e                	mv	a0,s3
ffffffffc0204a44:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a46:	fc65                	bnez	s0,ffffffffc0204a3e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a48:	1a02                	slli	s4,s4,0x20
ffffffffc0204a4a:	00002797          	auipc	a5,0x2
ffffffffc0204a4e:	31e78793          	addi	a5,a5,798 # ffffffffc0206d68 <default_pmm_manager+0x1150>
ffffffffc0204a52:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a56:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a58:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a5a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a5e:	70a2                	ld	ra,40(sp)
ffffffffc0204a60:	69a2                	ld	s3,8(sp)
ffffffffc0204a62:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a64:	85ca                	mv	a1,s2
ffffffffc0204a66:	87a6                	mv	a5,s1
}
ffffffffc0204a68:	6942                	ld	s2,16(sp)
ffffffffc0204a6a:	64e2                	ld	s1,24(sp)
ffffffffc0204a6c:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a6e:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a70:	03065633          	divu	a2,a2,a6
ffffffffc0204a74:	8722                	mv	a4,s0
ffffffffc0204a76:	f9bff0ef          	jal	ra,ffffffffc0204a10 <printnum>
ffffffffc0204a7a:	b7f9                	j	ffffffffc0204a48 <printnum+0x38>

ffffffffc0204a7c <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a7c:	7119                	addi	sp,sp,-128
ffffffffc0204a7e:	f4a6                	sd	s1,104(sp)
ffffffffc0204a80:	f0ca                	sd	s2,96(sp)
ffffffffc0204a82:	ecce                	sd	s3,88(sp)
ffffffffc0204a84:	e8d2                	sd	s4,80(sp)
ffffffffc0204a86:	e4d6                	sd	s5,72(sp)
ffffffffc0204a88:	e0da                	sd	s6,64(sp)
ffffffffc0204a8a:	fc5e                	sd	s7,56(sp)
ffffffffc0204a8c:	f06a                	sd	s10,32(sp)
ffffffffc0204a8e:	fc86                	sd	ra,120(sp)
ffffffffc0204a90:	f8a2                	sd	s0,112(sp)
ffffffffc0204a92:	f862                	sd	s8,48(sp)
ffffffffc0204a94:	f466                	sd	s9,40(sp)
ffffffffc0204a96:	ec6e                	sd	s11,24(sp)
ffffffffc0204a98:	892a                	mv	s2,a0
ffffffffc0204a9a:	84ae                	mv	s1,a1
ffffffffc0204a9c:	8d32                	mv	s10,a2
ffffffffc0204a9e:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204aa0:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204aa4:	5b7d                	li	s6,-1
ffffffffc0204aa6:	00002a97          	auipc	s5,0x2
ffffffffc0204aaa:	2eea8a93          	addi	s5,s5,750 # ffffffffc0206d94 <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204aae:	00002b97          	auipc	s7,0x2
ffffffffc0204ab2:	4c2b8b93          	addi	s7,s7,1218 # ffffffffc0206f70 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ab6:	000d4503          	lbu	a0,0(s10)
ffffffffc0204aba:	001d0413          	addi	s0,s10,1
ffffffffc0204abe:	01350a63          	beq	a0,s3,ffffffffc0204ad2 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ac2:	c121                	beqz	a0,ffffffffc0204b02 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204ace:	ff351ae3          	bne	a0,s3,ffffffffc0204ac2 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ad2:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ad6:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ada:	4c81                	li	s9,0
ffffffffc0204adc:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204ade:	5c7d                	li	s8,-1
ffffffffc0204ae0:	5dfd                	li	s11,-1
ffffffffc0204ae2:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204ae6:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae8:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204aec:	0ff5f593          	zext.b	a1,a1
ffffffffc0204af0:	00140d13          	addi	s10,s0,1
ffffffffc0204af4:	04b56263          	bltu	a0,a1,ffffffffc0204b38 <vprintfmt+0xbc>
ffffffffc0204af8:	058a                	slli	a1,a1,0x2
ffffffffc0204afa:	95d6                	add	a1,a1,s5
ffffffffc0204afc:	4194                	lw	a3,0(a1)
ffffffffc0204afe:	96d6                	add	a3,a3,s5
...
ffffffffc0204b1e:	8082                	ret
            padc = '0';
ffffffffc0204b20:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b22:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b26:	846a                	mv	s0,s10
ffffffffc0204b28:	00140d13          	addi	s10,s0,1
ffffffffc0204b2c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b30:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b34:	fcb572e3          	bgeu	a0,a1,ffffffffc0204af8 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b38:	85a6                	mv	a1,s1
ffffffffc0204b3a:	02500513          	li	a0,37
ffffffffc0204b3e:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b40:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b44:	8d22                	mv	s10,s0
ffffffffc0204b46:	f73788e3          	beq	a5,s3,ffffffffc0204ab6 <vprintfmt+0x3a>
ffffffffc0204b4a:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b4e:	1d7d                	addi	s10,s10,-1
ffffffffc0204b50:	ff379de3          	bne	a5,s3,ffffffffc0204b4a <vprintfmt+0xce>
ffffffffc0204b54:	b78d                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b56:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b5a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b5e:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b60:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b64:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b68:	02d86463          	bltu	a6,a3,ffffffffc0204b90 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b6c:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b70:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b74:	0186873b          	addw	a4,a3,s8
ffffffffc0204b78:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b7c:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b7e:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b82:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b84:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b88:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b8c:	fed870e3          	bgeu	a6,a3,ffffffffc0204b6c <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b90:	f40ddce3          	bgez	s11,ffffffffc0204ae8 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b94:	8de2                	mv	s11,s8
ffffffffc0204b96:	5c7d                	li	s8,-1
ffffffffc0204b98:	bf81                	j	ffffffffc0204ae8 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b9a:	fffdc693          	not	a3,s11
ffffffffc0204b9e:	96fd                	srai	a3,a3,0x3f
ffffffffc0204ba0:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba4:	00144603          	lbu	a2,1(s0)
ffffffffc0204ba8:	2d81                	sext.w	s11,s11
ffffffffc0204baa:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bac:	bf35                	j	ffffffffc0204ae8 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bae:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204bba:	bfd9                	j	ffffffffc0204b90 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bbc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bbe:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bc2:	01174463          	blt	a4,a7,ffffffffc0204bca <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bc6:	1a088e63          	beqz	a7,ffffffffc0204d82 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bca:	000a3603          	ld	a2,0(s4)
ffffffffc0204bce:	46c1                	li	a3,16
ffffffffc0204bd0:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bd2:	2781                	sext.w	a5,a5
ffffffffc0204bd4:	876e                	mv	a4,s11
ffffffffc0204bd6:	85a6                	mv	a1,s1
ffffffffc0204bd8:	854a                	mv	a0,s2
ffffffffc0204bda:	e37ff0ef          	jal	ra,ffffffffc0204a10 <printnum>
            break;
ffffffffc0204bde:	bde1                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204be0:	000a2503          	lw	a0,0(s4)
ffffffffc0204be4:	85a6                	mv	a1,s1
ffffffffc0204be6:	0a21                	addi	s4,s4,8
ffffffffc0204be8:	9902                	jalr	s2
            break;
ffffffffc0204bea:	b5f1                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204bec:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bee:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bf2:	01174463          	blt	a4,a7,ffffffffc0204bfa <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bf6:	18088163          	beqz	a7,ffffffffc0204d78 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bfa:	000a3603          	ld	a2,0(s4)
ffffffffc0204bfe:	46a9                	li	a3,10
ffffffffc0204c00:	8a2e                	mv	s4,a1
ffffffffc0204c02:	bfc1                	j	ffffffffc0204bd2 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c04:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c08:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c0a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c0c:	bdf1                	j	ffffffffc0204ae8 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c0e:	85a6                	mv	a1,s1
ffffffffc0204c10:	02500513          	li	a0,37
ffffffffc0204c14:	9902                	jalr	s2
            break;
ffffffffc0204c16:	b545                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c18:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c1c:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c20:	b5e1                	j	ffffffffc0204ae8 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c22:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c24:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c28:	01174463          	blt	a4,a7,ffffffffc0204c30 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c2c:	14088163          	beqz	a7,ffffffffc0204d6e <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c30:	000a3603          	ld	a2,0(s4)
ffffffffc0204c34:	46a1                	li	a3,8
ffffffffc0204c36:	8a2e                	mv	s4,a1
ffffffffc0204c38:	bf69                	j	ffffffffc0204bd2 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c3a:	03000513          	li	a0,48
ffffffffc0204c3e:	85a6                	mv	a1,s1
ffffffffc0204c40:	e03e                	sd	a5,0(sp)
ffffffffc0204c42:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c44:	85a6                	mv	a1,s1
ffffffffc0204c46:	07800513          	li	a0,120
ffffffffc0204c4a:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c4c:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c4e:	6782                	ld	a5,0(sp)
ffffffffc0204c50:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c52:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c56:	bfb5                	j	ffffffffc0204bd2 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c58:	000a3403          	ld	s0,0(s4)
ffffffffc0204c5c:	008a0713          	addi	a4,s4,8
ffffffffc0204c60:	e03a                	sd	a4,0(sp)
ffffffffc0204c62:	14040263          	beqz	s0,ffffffffc0204da6 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c66:	0fb05763          	blez	s11,ffffffffc0204d54 <vprintfmt+0x2d8>
ffffffffc0204c6a:	02d00693          	li	a3,45
ffffffffc0204c6e:	0cd79163          	bne	a5,a3,ffffffffc0204d30 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c72:	00044783          	lbu	a5,0(s0)
ffffffffc0204c76:	0007851b          	sext.w	a0,a5
ffffffffc0204c7a:	cf85                	beqz	a5,ffffffffc0204cb2 <vprintfmt+0x236>
ffffffffc0204c7c:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c80:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c84:	000c4563          	bltz	s8,ffffffffc0204c8e <vprintfmt+0x212>
ffffffffc0204c88:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c8a:	036c0263          	beq	s8,s6,ffffffffc0204cae <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c8e:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c90:	0e0c8e63          	beqz	s9,ffffffffc0204d8c <vprintfmt+0x310>
ffffffffc0204c94:	3781                	addiw	a5,a5,-32
ffffffffc0204c96:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d8c <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c9a:	03f00513          	li	a0,63
ffffffffc0204c9e:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ca0:	000a4783          	lbu	a5,0(s4)
ffffffffc0204ca4:	3dfd                	addiw	s11,s11,-1
ffffffffc0204ca6:	0a05                	addi	s4,s4,1
ffffffffc0204ca8:	0007851b          	sext.w	a0,a5
ffffffffc0204cac:	ffe1                	bnez	a5,ffffffffc0204c84 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cae:	01b05963          	blez	s11,ffffffffc0204cc0 <vprintfmt+0x244>
ffffffffc0204cb2:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204cb4:	85a6                	mv	a1,s1
ffffffffc0204cb6:	02000513          	li	a0,32
ffffffffc0204cba:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cbc:	fe0d9be3          	bnez	s11,ffffffffc0204cb2 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cc0:	6a02                	ld	s4,0(sp)
ffffffffc0204cc2:	bbd5                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cc4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cc6:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cca:	01174463          	blt	a4,a7,ffffffffc0204cd2 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cce:	08088d63          	beqz	a7,ffffffffc0204d68 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cd2:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cd6:	0a044d63          	bltz	s0,ffffffffc0204d90 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cda:	8622                	mv	a2,s0
ffffffffc0204cdc:	8a66                	mv	s4,s9
ffffffffc0204cde:	46a9                	li	a3,10
ffffffffc0204ce0:	bdcd                	j	ffffffffc0204bd2 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204ce2:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204ce6:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204ce8:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204cea:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204cee:	8fb5                	xor	a5,a5,a3
ffffffffc0204cf0:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cf4:	02d74163          	blt	a4,a3,ffffffffc0204d16 <vprintfmt+0x29a>
ffffffffc0204cf8:	00369793          	slli	a5,a3,0x3
ffffffffc0204cfc:	97de                	add	a5,a5,s7
ffffffffc0204cfe:	639c                	ld	a5,0(a5)
ffffffffc0204d00:	cb99                	beqz	a5,ffffffffc0204d16 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d02:	86be                	mv	a3,a5
ffffffffc0204d04:	00000617          	auipc	a2,0x0
ffffffffc0204d08:	1ec60613          	addi	a2,a2,492 # ffffffffc0204ef0 <etext+0x28>
ffffffffc0204d0c:	85a6                	mv	a1,s1
ffffffffc0204d0e:	854a                	mv	a0,s2
ffffffffc0204d10:	0ce000ef          	jal	ra,ffffffffc0204dde <printfmt>
ffffffffc0204d14:	b34d                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d16:	00002617          	auipc	a2,0x2
ffffffffc0204d1a:	07260613          	addi	a2,a2,114 # ffffffffc0206d88 <default_pmm_manager+0x1170>
ffffffffc0204d1e:	85a6                	mv	a1,s1
ffffffffc0204d20:	854a                	mv	a0,s2
ffffffffc0204d22:	0bc000ef          	jal	ra,ffffffffc0204dde <printfmt>
ffffffffc0204d26:	bb41                	j	ffffffffc0204ab6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d28:	00002417          	auipc	s0,0x2
ffffffffc0204d2c:	05840413          	addi	s0,s0,88 # ffffffffc0206d80 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d30:	85e2                	mv	a1,s8
ffffffffc0204d32:	8522                	mv	a0,s0
ffffffffc0204d34:	e43e                	sd	a5,8(sp)
ffffffffc0204d36:	0e2000ef          	jal	ra,ffffffffc0204e18 <strnlen>
ffffffffc0204d3a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d3e:	01b05b63          	blez	s11,ffffffffc0204d54 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d42:	67a2                	ld	a5,8(sp)
ffffffffc0204d44:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d48:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d4a:	85a6                	mv	a1,s1
ffffffffc0204d4c:	8552                	mv	a0,s4
ffffffffc0204d4e:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d50:	fe0d9ce3          	bnez	s11,ffffffffc0204d48 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d54:	00044783          	lbu	a5,0(s0)
ffffffffc0204d58:	00140a13          	addi	s4,s0,1
ffffffffc0204d5c:	0007851b          	sext.w	a0,a5
ffffffffc0204d60:	d3a5                	beqz	a5,ffffffffc0204cc0 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d62:	05e00413          	li	s0,94
ffffffffc0204d66:	bf39                	j	ffffffffc0204c84 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d68:	000a2403          	lw	s0,0(s4)
ffffffffc0204d6c:	b7ad                	j	ffffffffc0204cd6 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d6e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d72:	46a1                	li	a3,8
ffffffffc0204d74:	8a2e                	mv	s4,a1
ffffffffc0204d76:	bdb1                	j	ffffffffc0204bd2 <vprintfmt+0x156>
ffffffffc0204d78:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d7c:	46a9                	li	a3,10
ffffffffc0204d7e:	8a2e                	mv	s4,a1
ffffffffc0204d80:	bd89                	j	ffffffffc0204bd2 <vprintfmt+0x156>
ffffffffc0204d82:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d86:	46c1                	li	a3,16
ffffffffc0204d88:	8a2e                	mv	s4,a1
ffffffffc0204d8a:	b5a1                	j	ffffffffc0204bd2 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d8c:	9902                	jalr	s2
ffffffffc0204d8e:	bf09                	j	ffffffffc0204ca0 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d90:	85a6                	mv	a1,s1
ffffffffc0204d92:	02d00513          	li	a0,45
ffffffffc0204d96:	e03e                	sd	a5,0(sp)
ffffffffc0204d98:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d9a:	6782                	ld	a5,0(sp)
ffffffffc0204d9c:	8a66                	mv	s4,s9
ffffffffc0204d9e:	40800633          	neg	a2,s0
ffffffffc0204da2:	46a9                	li	a3,10
ffffffffc0204da4:	b53d                	j	ffffffffc0204bd2 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204da6:	03b05163          	blez	s11,ffffffffc0204dc8 <vprintfmt+0x34c>
ffffffffc0204daa:	02d00693          	li	a3,45
ffffffffc0204dae:	f6d79de3          	bne	a5,a3,ffffffffc0204d28 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204db2:	00002417          	auipc	s0,0x2
ffffffffc0204db6:	fce40413          	addi	s0,s0,-50 # ffffffffc0206d80 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dba:	02800793          	li	a5,40
ffffffffc0204dbe:	02800513          	li	a0,40
ffffffffc0204dc2:	00140a13          	addi	s4,s0,1
ffffffffc0204dc6:	bd6d                	j	ffffffffc0204c80 <vprintfmt+0x204>
ffffffffc0204dc8:	00002a17          	auipc	s4,0x2
ffffffffc0204dcc:	fb9a0a13          	addi	s4,s4,-71 # ffffffffc0206d81 <default_pmm_manager+0x1169>
ffffffffc0204dd0:	02800513          	li	a0,40
ffffffffc0204dd4:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dd8:	05e00413          	li	s0,94
ffffffffc0204ddc:	b565                	j	ffffffffc0204c84 <vprintfmt+0x208>
...
ffffffffc0204df2:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204df4:	c89ff0ef          	jal	ra,ffffffffc0204a7c <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0204e02:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e04:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e06:	cb81                	beqz	a5,ffffffffc0204e16 <strlen+0x18>
        cnt ++;
ffffffffc0204e08:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e0a:	00a707b3          	add	a5,a4,a0
ffffffffc0204e0e:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e12:	fbfd                	bnez	a5,ffffffffc0204e08 <strlen+0xa>
...
ffffffffc0204e18:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e1a:	e589                	bnez	a1,ffffffffc0204e24 <strnlen+0xc>
ffffffffc0204e1c:	a811                	j	ffffffffc0204e30 <strnlen+0x18>
        cnt ++;
ffffffffc0204e1e:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e20:	00f58863          	beq	a1,a5,ffffffffc0204e30 <strnlen+0x18>
ffffffffc0204e24:	00f50733          	add	a4,a0,a5
ffffffffc0204e28:	00074703          	lbu	a4,0(a4)
ffffffffc0204e2c:	fb6d                	bnez	a4,ffffffffc0204e1e <strnlen+0x6>
ffffffffc0204e2e:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e30:	852e                	mv	a0,a1
...
ffffffffc0204e3a:	0785                	addi	a5,a5,1
...
ffffffffc0204e4a:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e4e:	cb89                	beqz	a5,ffffffffc0204e60 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e50:	0505                	addi	a0,a0,1
ffffffffc0204e52:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e54:	fee789e3          	beq	a5,a4,ffffffffc0204e46 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc0204e62:	bfed                	j	ffffffffc0204e5c <strcmp+0x16>
...
ffffffffc0204e6e:	00154783          	lbu	a5,1(a0)
        ...
        s ++;
ffffffffc0204e72:	0505                	addi	a0,a0,1
    while (*s != '\0') {
...
ffffffffc0204e82:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e86:	fec79de3          	bne	a5,a2,ffffffffc0204e80 <memset+0x6>
    }
    return s;
...
ffffffffc0204e9a:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e9e:	fec59ae3          	bne	a1,a2,ffffffffc0204e92 <memcpy+0x6>
    }
    return dst;
...
ffffffffc0204eaa:	00c58d63          	beq	a1,a2,ffffffffc0204ec4 <memcmp+0x20>
        if (*s1 != *s2) {
