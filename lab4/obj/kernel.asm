...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	675040ef          	jal	ra,ffffffffc0204ebe <memset>
...
ffffffffc0200056:	ebe58593          	addi	a1,a1,-322 # ffffffffc0204f10 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	ed650513          	addi	a0,a0,-298 # ffffffffc0204f30 <etext+0x24>
...
ffffffffc020007a:	62a040ef          	jal	ra,ffffffffc02046a4 <proc_init>
...
ffffffffc020008e:	065040ef          	jal	ra,ffffffffc02048f2 <cpu_idle>
...
ffffffffc02000ac:	e9050513          	addi	a0,a0,-368 # ffffffffc0204f38 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	14d040ef          	jal	ra,ffffffffc0204ac0 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	117040ef          	jal	ra,ffffffffc0204ac0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d7650513          	addi	a0,a0,-650 # ffffffffc0204f40 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d8050513          	addi	a0,a0,-640 # ffffffffc0204f60 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d2058593          	addi	a1,a1,-736 # ffffffffc0204f0c <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d8c50513          	addi	a0,a0,-628 # ffffffffc0204f80 <etext+0x74>
...
ffffffffc020020c:	d9850513          	addi	a0,a0,-616 # ffffffffc0204fa0 <etext+0x94>
...
ffffffffc0200220:	da450513          	addi	a0,a0,-604 # ffffffffc0204fc0 <etext+0xb4>
...
ffffffffc020024e:	d9650513          	addi	a0,a0,-618 # ffffffffc0204fe0 <etext+0xd4>
}
...
ffffffffc020025c:	db860613          	addi	a2,a2,-584 # ffffffffc0205010 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	dc450513          	addi	a0,a0,-572 # ffffffffc0205028 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	dcc60613          	addi	a2,a2,-564 # ffffffffc0205040 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	de458593          	addi	a1,a1,-540 # ffffffffc0205060 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	de450513          	addi	a0,a0,-540 # ffffffffc0205068 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	de660613          	addi	a2,a2,-538 # ffffffffc0205078 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e0658593          	addi	a1,a1,-506 # ffffffffc02050a0 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	dc650513          	addi	a0,a0,-570 # ffffffffc0205068 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e0260613          	addi	a2,a2,-510 # ffffffffc02050b0 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e1a58593          	addi	a1,a1,-486 # ffffffffc02050d0 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205068 <etext+0x15c>
...
ffffffffc02002fc:	de850513          	addi	a0,a0,-536 # ffffffffc02050e0 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dee50513          	addi	a0,a0,-530 # ffffffffc0205108 <etext+0x1fc>
...
ffffffffc0200340:	e3cc0c13          	addi	s8,s8,-452 # ffffffffc0205178 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	dec90913          	addi	s2,s2,-532 # ffffffffc0205130 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dec48493          	addi	s1,s1,-532 # ffffffffc0205138 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	deab0b13          	addi	s6,s6,-534 # ffffffffc0205140 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d02a0a13          	addi	s4,s4,-766 # ffffffffc0205060 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	df8d0d13          	addi	s10,s10,-520 # ffffffffc0205178 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2fd040ef          	jal	ra,ffffffffc0204e8a <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2e9040ef          	jal	ra,ffffffffc0204e8a <strcmp>
...
ffffffffc02003e0:	2c9040ef          	jal	ra,ffffffffc0204ea8 <strchr>
...
ffffffffc020041e:	28b040ef          	jal	ra,ffffffffc0204ea8 <strchr>
...
ffffffffc020043c:	d2850513          	addi	a0,a0,-728 # ffffffffc0205160 <etext+0x254>
...
ffffffffc0200478:	d4c50513          	addi	a0,a0,-692 # ffffffffc02051c0 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	ca650513          	addi	a0,a0,-858 # ffffffffc0206130 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	d1850513          	addi	a0,a0,-744 # ffffffffc02051e0 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	145040ef          	jal	ra,ffffffffc0204ed0 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	121040ef          	jal	ra,ffffffffc0204ed0 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	c0650513          	addi	a0,a0,-1018 # ffffffffc0205200 <commands+0x88>
...
ffffffffc0200626:	bfe60613          	addi	a2,a2,-1026 # ffffffffc0205220 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0205238 <commands+0xc0>
...
ffffffffc0200660:	bf450513          	addi	a0,a0,-1036 # ffffffffc0205250 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	bfc50513          	addi	a0,a0,-1028 # ffffffffc0205268 <commands+0xf0>
...
ffffffffc020067e:	c0650513          	addi	a0,a0,-1018 # ffffffffc0205280 <commands+0x108>
...
ffffffffc020068c:	c1050513          	addi	a0,a0,-1008 # ffffffffc0205298 <commands+0x120>
...
ffffffffc020069a:	c1a50513          	addi	a0,a0,-998 # ffffffffc02052b0 <commands+0x138>
...
ffffffffc02006a8:	c2450513          	addi	a0,a0,-988 # ffffffffc02052c8 <commands+0x150>
...
ffffffffc02006b6:	c2e50513          	addi	a0,a0,-978 # ffffffffc02052e0 <commands+0x168>
...
ffffffffc02006c4:	c3850513          	addi	a0,a0,-968 # ffffffffc02052f8 <commands+0x180>
...
ffffffffc02006d2:	c4250513          	addi	a0,a0,-958 # ffffffffc0205310 <commands+0x198>
...
ffffffffc02006e0:	c4c50513          	addi	a0,a0,-948 # ffffffffc0205328 <commands+0x1b0>
...
ffffffffc02006ee:	c5650513          	addi	a0,a0,-938 # ffffffffc0205340 <commands+0x1c8>
...
ffffffffc02006fc:	c6050513          	addi	a0,a0,-928 # ffffffffc0205358 <commands+0x1e0>
...
ffffffffc020070a:	c6a50513          	addi	a0,a0,-918 # ffffffffc0205370 <commands+0x1f8>
...
ffffffffc0200718:	c7450513          	addi	a0,a0,-908 # ffffffffc0205388 <commands+0x210>
...
ffffffffc0200726:	c7e50513          	addi	a0,a0,-898 # ffffffffc02053a0 <commands+0x228>
...
ffffffffc0200734:	c8850513          	addi	a0,a0,-888 # ffffffffc02053b8 <commands+0x240>
...
ffffffffc0200742:	c9250513          	addi	a0,a0,-878 # ffffffffc02053d0 <commands+0x258>
...
ffffffffc0200750:	c9c50513          	addi	a0,a0,-868 # ffffffffc02053e8 <commands+0x270>
...
ffffffffc020075e:	ca650513          	addi	a0,a0,-858 # ffffffffc0205400 <commands+0x288>
...
ffffffffc020076c:	cb050513          	addi	a0,a0,-848 # ffffffffc0205418 <commands+0x2a0>
...
ffffffffc020077a:	cba50513          	addi	a0,a0,-838 # ffffffffc0205430 <commands+0x2b8>
...
ffffffffc0200788:	cc450513          	addi	a0,a0,-828 # ffffffffc0205448 <commands+0x2d0>
...
ffffffffc0200796:	cce50513          	addi	a0,a0,-818 # ffffffffc0205460 <commands+0x2e8>
...
ffffffffc02007a4:	cd850513          	addi	a0,a0,-808 # ffffffffc0205478 <commands+0x300>
...
ffffffffc02007b2:	ce250513          	addi	a0,a0,-798 # ffffffffc0205490 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	cec50513          	addi	a0,a0,-788 # ffffffffc02054a8 <commands+0x330>
...
ffffffffc02007ce:	cf650513          	addi	a0,a0,-778 # ffffffffc02054c0 <commands+0x348>
...
ffffffffc02007dc:	d0050513          	addi	a0,a0,-768 # ffffffffc02054d8 <commands+0x360>
...
ffffffffc02007ea:	d0a50513          	addi	a0,a0,-758 # ffffffffc02054f0 <commands+0x378>
...
ffffffffc02007f8:	d1450513          	addi	a0,a0,-748 # ffffffffc0205508 <commands+0x390>
...
ffffffffc0200806:	d1e50513          	addi	a0,a0,-738 # ffffffffc0205520 <commands+0x3a8>
...
ffffffffc0200818:	d2450513          	addi	a0,a0,-732 # ffffffffc0205538 <commands+0x3c0>
}
...
ffffffffc020082c:	d2850513          	addi	a0,a0,-728 # ffffffffc0205550 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	d2850513          	addi	a0,a0,-728 # ffffffffc0205568 <commands+0x3f0>
...
ffffffffc0200854:	d3050513          	addi	a0,a0,-720 # ffffffffc0205580 <commands+0x408>
...
ffffffffc0200864:	d3850513          	addi	a0,a0,-712 # ffffffffc0205598 <commands+0x420>
...
ffffffffc0200878:	d3c50513          	addi	a0,a0,-708 # ffffffffc02055b0 <commands+0x438>
}
...
ffffffffc0200894:	de870713          	addi	a4,a4,-536 # ffffffffc0205678 <commands+0x500>
...
ffffffffc02008a6:	d8650513          	addi	a0,a0,-634 # ffffffffc0205628 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d5a50513          	addi	a0,a0,-678 # ffffffffc0205608 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	d0e50513          	addi	a0,a0,-754 # ffffffffc02055c8 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	d2250513          	addi	a0,a0,-734 # ffffffffc02055e8 <commands+0x470>
...
ffffffffc02008fc:	d6050513          	addi	a0,a0,-672 # ffffffffc0205658 <commands+0x4e0>
...
ffffffffc0200910:	d3c50513          	addi	a0,a0,-708 # ffffffffc0205648 <commands+0x4d0>
}
...
ffffffffc0200932:	f3270713          	addi	a4,a4,-206 # ffffffffc0205860 <commands+0x6e8>
...
ffffffffc0200944:	f0850513          	addi	a0,a0,-248 # ffffffffc0205848 <commands+0x6d0>
...
ffffffffc0200966:	d4650513          	addi	a0,a0,-698 # ffffffffc02056a8 <commands+0x530>
}
...
ffffffffc02009c0:	d8c60613          	addi	a2,a2,-628 # ffffffffc0205748 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	87050513          	addi	a0,a0,-1936 # ffffffffc0205238 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d9450513          	addi	a0,a0,-620 # ffffffffc0205768 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	da250513          	addi	a0,a0,-606 # ffffffffc0205780 <commands+0x608>
...
ffffffffc0200a6a:	ce260613          	addi	a2,a2,-798 # ffffffffc0205748 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	7c650513          	addi	a0,a0,1990 # ffffffffc0205238 <commands+0xc0>
...
ffffffffc0200a96:	cb660613          	addi	a2,a2,-842 # ffffffffc0205748 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	79a50513          	addi	a0,a0,1946 # ffffffffc0205238 <commands+0xc0>
...
ffffffffc0200e74:	a3068693          	addi	a3,a3,-1488 # ffffffffc02058a0 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a3860613          	addi	a2,a2,-1480 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a4450513          	addi	a0,a0,-1468 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205960 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	a1860613          	addi	a2,a2,-1512 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	a2450513          	addi	a0,a0,-1500 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205988 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	9f860613          	addi	a2,a2,-1544 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	a0450513          	addi	a0,a0,-1532 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	af868693          	addi	a3,a3,-1288 # ffffffffc02059c8 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	9d860613          	addi	a2,a2,-1576 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	9e450513          	addi	a0,a0,-1564 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	b6068693          	addi	a3,a3,-1184 # ffffffffc0205a50 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	9b860613          	addi	a2,a2,-1608 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	9c450513          	addi	a0,a0,-1596 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	9f068693          	addi	a3,a3,-1552 # ffffffffc0205900 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	99860613          	addi	a2,a2,-1640 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	9a450513          	addi	a0,a0,-1628 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	b1068693          	addi	a3,a3,-1264 # ffffffffc0205a40 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	97860613          	addi	a2,a2,-1672 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	98450513          	addi	a0,a0,-1660 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	95860613          	addi	a2,a2,-1704 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	96450513          	addi	a0,a0,-1692 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a9868693          	addi	a3,a3,-1384 # ffffffffc0205a08 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	93860613          	addi	a2,a2,-1736 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	94450513          	addi	a0,a0,-1724 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	b0868693          	addi	a3,a3,-1272 # ffffffffc0205a98 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	91860613          	addi	a2,a2,-1768 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	92450513          	addi	a0,a0,-1756 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205a88 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	8f860613          	addi	a2,a2,-1800 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	90450513          	addi	a0,a0,-1788 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a5868693          	addi	a3,a3,-1448 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	8d860613          	addi	a2,a2,-1832 # ffffffffc02058b0 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	8e450513          	addi	a0,a0,-1820 # ffffffffc02058c8 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	a7868693          	addi	a3,a3,-1416 # ffffffffc0205a68 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	8b860613          	addi	a2,a2,-1864 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	8c450513          	addi	a0,a0,-1852 # ffffffffc02058c8 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205900 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	89860613          	addi	a2,a2,-1896 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	8a450513          	addi	a0,a0,-1884 # ffffffffc02058c8 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	9f868693          	addi	a3,a3,-1544 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	87860613          	addi	a2,a2,-1928 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	88450513          	addi	a0,a0,-1916 # ffffffffc02058c8 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205940 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	85860613          	addi	a2,a2,-1960 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	86450513          	addi	a0,a0,-1948 # ffffffffc02058c8 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205920 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	83860613          	addi	a2,a2,-1992 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	84450513          	addi	a0,a0,-1980 # ffffffffc02058c8 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205940 <commands+0x7c8>
ffffffffc0201098:	00005617          	auipc	a2,0x5
ffffffffc020109c:	81860613          	addi	a2,a2,-2024 # ffffffffc02058b0 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00005517          	auipc	a0,0x5
ffffffffc02010a8:	82450513          	addi	a0,a0,-2012 # ffffffffc02058c8 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b3868693          	addi	a3,a3,-1224 # ffffffffc0205be8 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	7f860613          	addi	a2,a2,2040 # ffffffffc02058b0 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00005517          	auipc	a0,0x5
ffffffffc02010c8:	80450513          	addi	a0,a0,-2044 # ffffffffc02058c8 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	9b868693          	addi	a3,a3,-1608 # ffffffffc0205a88 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	7d860613          	addi	a2,a2,2008 # ffffffffc02058b0 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	7e450513          	addi	a0,a0,2020 # ffffffffc02058c8 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	93868693          	addi	a3,a3,-1736 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	7b860613          	addi	a2,a2,1976 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	7c450513          	addi	a0,a0,1988 # ffffffffc02058c8 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	8d868693          	addi	a3,a3,-1832 # ffffffffc02059e8 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	79860613          	addi	a2,a2,1944 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	7a450513          	addi	a0,a0,1956 # ffffffffc02058c8 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	a7868693          	addi	a3,a3,-1416 # ffffffffc0205ba8 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	77860613          	addi	a2,a2,1912 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	78450513          	addi	a0,a0,1924 # ffffffffc02058c8 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a3868693          	addi	a3,a3,-1480 # ffffffffc0205b88 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	75860613          	addi	a2,a2,1880 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	76450513          	addi	a0,a0,1892 # ffffffffc02058c8 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	9f068693          	addi	a3,a3,-1552 # ffffffffc0205b60 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	73860613          	addi	a2,a2,1848 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	74450513          	addi	a0,a0,1860 # ffffffffc02058c8 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	9a868693          	addi	a3,a3,-1624 # ffffffffc0205b38 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	71860613          	addi	a2,a2,1816 # ffffffffc02058b0 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	72450513          	addi	a0,a0,1828 # ffffffffc02058c8 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	97868693          	addi	a3,a3,-1672 # ffffffffc0205b28 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	6f860613          	addi	a2,a2,1784 # ffffffffc02058b0 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	70450513          	addi	a0,a0,1796 # ffffffffc02058c8 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	85868693          	addi	a3,a3,-1960 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	6d860613          	addi	a2,a2,1752 # ffffffffc02058b0 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	6e450513          	addi	a0,a0,1764 # ffffffffc02058c8 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	91868693          	addi	a3,a3,-1768 # ffffffffc0205b08 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	6b860613          	addi	a2,a2,1720 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	6c450513          	addi	a0,a0,1732 # ffffffffc02058c8 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	8c868693          	addi	a3,a3,-1848 # ffffffffc0205ad8 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	69860613          	addi	a2,a2,1688 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	6a450513          	addi	a0,a0,1700 # ffffffffc02058c8 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	89068693          	addi	a3,a3,-1904 # ffffffffc0205ac0 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	67860613          	addi	a2,a2,1656 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	68450513          	addi	a0,a0,1668 # ffffffffc02058c8 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	7d868693          	addi	a3,a3,2008 # ffffffffc0205a28 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	65860613          	addi	a2,a2,1624 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	66450513          	addi	a0,a0,1636 # ffffffffc02058c8 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	83868693          	addi	a3,a3,-1992 # ffffffffc0205aa8 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	63860613          	addi	a2,a2,1592 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	64450513          	addi	a0,a0,1604 # ffffffffc02058c8 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	93868693          	addi	a3,a3,-1736 # ffffffffc0205bc8 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	61860613          	addi	a2,a2,1560 # ffffffffc02058b0 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	62450513          	addi	a0,a0,1572 # ffffffffc02058c8 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	94868693          	addi	a3,a3,-1720 # ffffffffc0205bf8 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	5f860613          	addi	a2,a2,1528 # ffffffffc02058b0 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	60450513          	addi	a0,a0,1540 # ffffffffc02058c8 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	61068693          	addi	a3,a3,1552 # ffffffffc02058e0 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	5d860613          	addi	a2,a2,1496 # ffffffffc02058b0 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	5e450513          	addi	a0,a0,1508 # ffffffffc02058c8 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	63068693          	addi	a3,a3,1584 # ffffffffc0205920 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	5b860613          	addi	a2,a2,1464 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	5c450513          	addi	a0,a0,1476 # ffffffffc02058c8 <commands+0x750>
...
ffffffffc0201440:	7d468693          	addi	a3,a3,2004 # ffffffffc0205c10 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	46c60613          	addi	a2,a2,1132 # ffffffffc02058b0 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	47850513          	addi	a0,a0,1144 # ffffffffc02058c8 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7ac68693          	addi	a3,a3,1964 # ffffffffc0205c08 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	44c60613          	addi	a2,a2,1100 # ffffffffc02058b0 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	45850513          	addi	a0,a0,1112 # ffffffffc02058c8 <commands+0x750>
...
ffffffffc0201512:	6fa68693          	addi	a3,a3,1786 # ffffffffc0205c08 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	39a60613          	addi	a2,a2,922 # ffffffffc02058b0 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	3a650513          	addi	a0,a0,934 # ffffffffc02058c8 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	65868693          	addi	a3,a3,1624 # ffffffffc0205c38 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	2c860613          	addi	a2,a2,712 # ffffffffc02058b0 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	2d450513          	addi	a0,a0,724 # ffffffffc02058c8 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	60868693          	addi	a3,a3,1544 # ffffffffc0205c08 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2a860613          	addi	a2,a2,680 # ffffffffc02058b0 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	2b450513          	addi	a0,a0,692 # ffffffffc02058c8 <commands+0x750>
...
ffffffffc0201724:	57860613          	addi	a2,a2,1400 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	59450513          	addi	a0,a0,1428 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc0201812:	4c268693          	addi	a3,a3,1218 # ffffffffc0205cd0 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	09a60613          	addi	a2,a2,154 # ffffffffc02058b0 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	4ce50513          	addi	a0,a0,1230 # ffffffffc0205cf0 <default_pmm_manager+0x90>
...
ffffffffc0201834:	4d850513          	addi	a0,a0,1240 # ffffffffc0205d08 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	4e050513          	addi	a0,a0,1248 # ffffffffc0205d20 <default_pmm_manager+0xc0>
}
...
ffffffffc02019c6:	3a660613          	addi	a2,a2,934 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	2f250513          	addi	a0,a0,754 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	36460613          	addi	a2,a2,868 # ffffffffc0205d40 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	2d850513          	addi	a0,a0,728 # ffffffffc0205cc0 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	37260613          	addi	a2,a2,882 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	2be50513          	addi	a0,a0,702 # ffffffffc0205cc0 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	37660613          	addi	a2,a2,886 # ffffffffc0205d88 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	2a250513          	addi	a0,a0,674 # ffffffffc0205cc0 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	300030ef          	jal	ra,ffffffffc0204ebe <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	26e030ef          	jal	ra,ffffffffc0204ebe <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	ff260613          	addi	a2,a2,-14 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	0fe50513          	addi	a0,a0,254 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	fda60613          	addi	a2,a2,-38 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	0e650513          	addi	a0,a0,230 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	fc060613          	addi	a2,a2,-64 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	0cc50513          	addi	a0,a0,204 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	fa660613          	addi	a2,a2,-90 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	0b250513          	addi	a0,a0,178 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d7078793          	addi	a5,a5,-656 # ffffffffc0205c60 <default_pmm_manager>
...
ffffffffc0201f02:	ec250513          	addi	a0,a0,-318 # ffffffffc0205dc0 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e8c50513          	addi	a0,a0,-372 # ffffffffc0205dd8 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e8450513          	addi	a0,a0,-380 # ffffffffc0205df0 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e4450513          	addi	a0,a0,-444 # ffffffffc0205e18 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e4050513          	addi	a0,a0,-448 # ffffffffc0205e30 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e8850513          	addi	a0,a0,-376 # ffffffffc0206118 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f0a58593          	addi	a1,a1,-246 # ffffffffc0206250 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	327020ef          	jal	ra,ffffffffc0204e78 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	32d020ef          	jal	ra,ffffffffc0204e8a <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2af020ef          	jal	ra,ffffffffc0204e42 <strlen>
...
ffffffffc0202458:	e7450513          	addi	a0,a0,-396 # ffffffffc02062c8 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c0a68693          	addi	a3,a3,-1014 # ffffffffc0206178 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	33a60613          	addi	a2,a2,826 # ffffffffc02058b0 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	82e50513          	addi	a0,a0,-2002 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	baa68693          	addi	a3,a3,-1110 # ffffffffc0206138 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	31a60613          	addi	a2,a2,794 # ffffffffc02058b0 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	80e50513          	addi	a0,a0,-2034 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	6e860613          	addi	a2,a2,1768 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	7f450513          	addi	a0,a0,2036 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	77460613          	addi	a2,a2,1908 # ffffffffc0205d40 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	7d850513          	addi	a0,a0,2008 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	75c60613          	addi	a2,a2,1884 # ffffffffc0205d40 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	7c050513          	addi	a0,a0,1984 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	87468693          	addi	a3,a3,-1932 # ffffffffc0205e70 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2ac60613          	addi	a2,a2,684 # ffffffffc02058b0 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	7a050513          	addi	a0,a0,1952 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	83468693          	addi	a3,a3,-1996 # ffffffffc0205e50 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	28c60613          	addi	a2,a2,652 # ffffffffc02058b0 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	78050513          	addi	a0,a0,1920 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0202644:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205f00 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	26860613          	addi	a2,a2,616 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	75c50513          	addi	a0,a0,1884 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	87068693          	addi	a3,a3,-1936 # ffffffffc0205ed0 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	24860613          	addi	a2,a2,584 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	73c50513          	addi	a0,a0,1852 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	82868693          	addi	a3,a3,-2008 # ffffffffc0205ea8 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	22860613          	addi	a2,a2,552 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	71c50513          	addi	a0,a0,1820 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	8e868693          	addi	a3,a3,-1816 # ffffffffc0205f88 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	20860613          	addi	a2,a2,520 # ffffffffc02058b0 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	6fc50513          	addi	a0,a0,1788 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	96868693          	addi	a3,a3,-1688 # ffffffffc0206028 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	1e860613          	addi	a2,a2,488 # ffffffffc02058b0 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	6dc50513          	addi	a0,a0,1756 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	88068693          	addi	a3,a3,-1920 # ffffffffc0205f60 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	1c860613          	addi	a2,a2,456 # ffffffffc02058b0 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0202706:	59660613          	addi	a2,a2,1430 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	6a250513          	addi	a0,a0,1698 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	8a668693          	addi	a3,a3,-1882 # ffffffffc0205fc0 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	18e60613          	addi	a2,a2,398 # ffffffffc02058b0 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	68250513          	addi	a0,a0,1666 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	94e68693          	addi	a3,a3,-1714 # ffffffffc0206088 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	16e60613          	addi	a2,a2,366 # ffffffffc02058b0 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	66250513          	addi	a0,a0,1634 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	91668693          	addi	a3,a3,-1770 # ffffffffc0206070 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	14e60613          	addi	a2,a2,334 # ffffffffc02058b0 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	64250513          	addi	a0,a0,1602 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	8c668693          	addi	a3,a3,-1850 # ffffffffc0206040 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	12e60613          	addi	a2,a2,302 # ffffffffc02058b0 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	62250513          	addi	a0,a0,1570 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a5e68693          	addi	a3,a3,-1442 # ffffffffc02061f8 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	10e60613          	addi	a2,a2,270 # ffffffffc02058b0 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	60250513          	addi	a0,a0,1538 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	85668693          	addi	a3,a3,-1962 # ffffffffc0206010 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	0ee60613          	addi	a2,a2,238 # ffffffffc02058b0 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	5e250513          	addi	a0,a0,1506 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	82668693          	addi	a3,a3,-2010 # ffffffffc0206000 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	0ce60613          	addi	a2,a2,206 # ffffffffc02058b0 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	5c250513          	addi	a0,a0,1474 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	8fe68693          	addi	a3,a3,-1794 # ffffffffc02060f8 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0ae60613          	addi	a2,a2,174 # ffffffffc02058b0 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	5a250513          	addi	a0,a0,1442 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	7d668693          	addi	a3,a3,2006 # ffffffffc0205ff0 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	08e60613          	addi	a2,a2,142 # ffffffffc02058b0 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	58250513          	addi	a0,a0,1410 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	70e68693          	addi	a3,a3,1806 # ffffffffc0205f48 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	06e60613          	addi	a2,a2,110 # ffffffffc02058b0 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	56250513          	addi	a0,a0,1378 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	84668693          	addi	a3,a3,-1978 # ffffffffc02060a0 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	04e60613          	addi	a2,a2,78 # ffffffffc02058b0 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	54250513          	addi	a0,a0,1346 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	6b668693          	addi	a3,a3,1718 # ffffffffc0205f30 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	02e60613          	addi	a2,a2,46 # ffffffffc02058b0 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	52250513          	addi	a0,a0,1314 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	3fe60613          	addi	a2,a2,1022 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	41a50513          	addi	a0,a0,1050 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	81e68693          	addi	a3,a3,-2018 # ffffffffc02060d0 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	ff660613          	addi	a2,a2,-10 # ffffffffc02058b0 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	4ea50513          	addi	a0,a0,1258 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	7b668693          	addi	a3,a3,1974 # ffffffffc0206088 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	fd660613          	addi	a2,a2,-42 # ffffffffc02058b0 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	4ca50513          	addi	a0,a0,1226 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	7c668693          	addi	a3,a3,1990 # ffffffffc02060b8 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	fb660613          	addi	a2,a2,-74 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4aa50513          	addi	a0,a0,1194 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	77668693          	addi	a3,a3,1910 # ffffffffc0206088 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f9660613          	addi	a2,a2,-106 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	48a50513          	addi	a0,a0,1162 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8ae68693          	addi	a3,a3,-1874 # ffffffffc02061e0 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f7660613          	addi	a2,a2,-138 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	46a50513          	addi	a0,a0,1130 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	85668693          	addi	a3,a3,-1962 # ffffffffc02061a8 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f5660613          	addi	a2,a2,-170 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	44a50513          	addi	a0,a0,1098 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	81e68693          	addi	a3,a3,-2018 # ffffffffc0206190 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f3660613          	addi	a2,a2,-202 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	42a50513          	addi	a0,a0,1066 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	76668693          	addi	a3,a3,1894 # ffffffffc02060f8 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f1660613          	addi	a2,a2,-234 # ffffffffc02058b0 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	40a50513          	addi	a0,a0,1034 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	57e68693          	addi	a3,a3,1406 # ffffffffc0205f30 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	ef660613          	addi	a2,a2,-266 # ffffffffc02058b0 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	3ea50513          	addi	a0,a0,1002 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	2c660613          	addi	a2,a2,710 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	3d250513          	addi	a0,a0,978 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	55e68693          	addi	a3,a3,1374 # ffffffffc0205f48 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	ebe60613          	addi	a2,a2,-322 # ffffffffc02058b0 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	3b250513          	addi	a0,a0,946 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	5b668693          	addi	a3,a3,1462 # ffffffffc0205fc0 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e9e60613          	addi	a2,a2,-354 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	39250513          	addi	a0,a0,914 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	87668693          	addi	a3,a3,-1930 # ffffffffc02062a0 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e7e60613          	addi	a2,a2,-386 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	37250513          	addi	a0,a0,882 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	81e68693          	addi	a3,a3,-2018 # ffffffffc0206268 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e5e60613          	addi	a2,a2,-418 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	35250513          	addi	a0,a0,850 # ffffffffc0205db0 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	7ce68693          	addi	a3,a3,1998 # ffffffffc0206238 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e3e60613          	addi	a2,a2,-450 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	33250513          	addi	a0,a0,818 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	7f868693          	addi	a3,a3,2040 # ffffffffc02062e8 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	db860613          	addi	a2,a2,-584 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2ac50513          	addi	a0,a0,684 # ffffffffc0205db0 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	21e60613          	addi	a2,a2,542 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	16a50513          	addi	a0,a0,362 # ffffffffc0205cc0 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	52c010ef          	jal	ra,ffffffffc02040ac <swapfs_init>
...
ffffffffc0202bde:	75650513          	addi	a0,a0,1878 # ffffffffc0206330 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	71c50513          	addi	a0,a0,1820 # ffffffffc0206348 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	73850513          	addi	a0,a0,1848 # ffffffffc02063b8 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	76c50513          	addi	a0,a0,1900 # ffffffffc0206408 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	78050513          	addi	a0,a0,1920 # ffffffffc0206490 <default_pmm_manager+0x830>
...
ffffffffc0202e58:	6e450513          	addi	a0,a0,1764 # ffffffffc0206538 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	66050513          	addi	a0,a0,1632 # ffffffffc0206588 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	96668693          	addi	a3,a3,-1690 # ffffffffc02058a0 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	96e60613          	addi	a2,a2,-1682 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	3d250513          	addi	a0,a0,978 # ffffffffc0206320 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e0a60613          	addi	a2,a2,-502 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d5650513          	addi	a0,a0,-682 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	59a68693          	addi	a3,a3,1434 # ffffffffc0206510 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	93260613          	addi	a2,a2,-1742 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	39650513          	addi	a0,a0,918 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	49a68693          	addi	a3,a3,1178 # ffffffffc0206430 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	91260613          	addi	a2,a2,-1774 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	37650513          	addi	a0,a0,886 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	34a60613          	addi	a2,a2,842 # ffffffffc0206300 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	35e50513          	addi	a0,a0,862 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	52a68693          	addi	a3,a3,1322 # ffffffffc02064f8 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	8da60613          	addi	a2,a2,-1830 # ffffffffc02058b0 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	33e50513          	addi	a0,a0,830 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d9a60613          	addi	a2,a2,-614 # ffffffffc0205d88 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	cc650513          	addi	a0,a0,-826 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	44268693          	addi	a3,a3,1090 # ffffffffc0206448 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	8a260613          	addi	a2,a2,-1886 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	30650513          	addi	a0,a0,774 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	35a68693          	addi	a3,a3,858 # ffffffffc0206380 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	88260613          	addi	a2,a2,-1918 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	2e650513          	addi	a0,a0,742 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	89a68693          	addi	a3,a3,-1894 # ffffffffc02058e0 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	86260613          	addi	a2,a2,-1950 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	2c650513          	addi	a0,a0,710 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a2268693          	addi	a3,a3,-1502 # ffffffffc0205a88 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	84260613          	addi	a2,a2,-1982 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	2a650513          	addi	a0,a0,678 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	31268693          	addi	a3,a3,786 # ffffffffc0206398 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	82260613          	addi	a2,a2,-2014 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	28650513          	addi	a0,a0,646 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	2ca68693          	addi	a3,a3,714 # ffffffffc0206370 <default_pmm_manager+0x710>
ffffffffc02030ae:	00003617          	auipc	a2,0x3
ffffffffc02030b2:	80260613          	addi	a2,a2,-2046 # ffffffffc02058b0 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	26650513          	addi	a0,a0,614 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	4b268693          	addi	a3,a3,1202 # ffffffffc0206578 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	7e260613          	addi	a2,a2,2018 # ffffffffc02058b0 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	24650513          	addi	a0,a0,582 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	bb260613          	addi	a2,a2,-1102 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	bce50513          	addi	a0,a0,-1074 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	46a68693          	addi	a3,a3,1130 # ffffffffc0206568 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7aa60613          	addi	a2,a2,1962 # ffffffffc02058b0 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	20e50513          	addi	a0,a0,526 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	39a68693          	addi	a3,a3,922 # ffffffffc02064b8 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	78a60613          	addi	a2,a2,1930 # ffffffffc02058b0 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	1ee50513          	addi	a0,a0,494 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	32a68693          	addi	a3,a3,810 # ffffffffc0206468 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	76a60613          	addi	a2,a2,1898 # ffffffffc02058b0 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	1ce50513          	addi	a0,a0,462 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	29268693          	addi	a3,a3,658 # ffffffffc02063f0 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	74a60613          	addi	a2,a2,1866 # ffffffffc02058b0 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1ae50513          	addi	a0,a0,430 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	3e268693          	addi	a3,a3,994 # ffffffffc0206560 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	72a60613          	addi	a2,a2,1834 # ffffffffc02058b0 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	18e50513          	addi	a0,a0,398 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	20a68693          	addi	a3,a3,522 # ffffffffc02063a8 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	70a60613          	addi	a2,a2,1802 # ffffffffc02058b0 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	16e50513          	addi	a0,a0,366 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	32a68693          	addi	a3,a3,810 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	6ea60613          	addi	a2,a2,1770 # ffffffffc02058b0 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	14e50513          	addi	a0,a0,334 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	30a68693          	addi	a3,a3,778 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	6ca60613          	addi	a2,a2,1738 # ffffffffc02058b0 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	12e50513          	addi	a0,a0,302 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	2ca68693          	addi	a3,a3,714 # ffffffffc02064c8 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6aa60613          	addi	a2,a2,1706 # ffffffffc02058b0 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	10e50513          	addi	a0,a0,270 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2aa68693          	addi	a3,a3,682 # ffffffffc02064c8 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	68a60613          	addi	a2,a2,1674 # ffffffffc02058b0 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	0ee50513          	addi	a0,a0,238 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	29a68693          	addi	a3,a3,666 # ffffffffc02064d8 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	66a60613          	addi	a2,a2,1642 # ffffffffc02058b0 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	0ce50513          	addi	a0,a0,206 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	27a68693          	addi	a3,a3,634 # ffffffffc02064d8 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	64a60613          	addi	a2,a2,1610 # ffffffffc02058b0 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0ae50513          	addi	a0,a0,174 # ffffffffc0206320 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	23a68693          	addi	a3,a3,570 # ffffffffc02064b8 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	62a60613          	addi	a2,a2,1578 # ffffffffc02058b0 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	08e50513          	addi	a0,a0,142 # ffffffffc0206320 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	32ab0b13          	addi	s6,s6,810 # ffffffffc0206608 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	30ab8b93          	addi	s7,s7,778 # ffffffffc02065f0 <default_pmm_manager+0x990>
...
ffffffffc020335a:	619000ef          	jal	ra,ffffffffc0204172 <swapfs_write>
...
ffffffffc020339c:	21050513          	addi	a0,a0,528 # ffffffffc02065a8 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	22e68693          	addi	a3,a3,558 # ffffffffc02065d8 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	4fe60613          	addi	a2,a2,1278 # ffffffffc02058b0 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f6250513          	addi	a0,a0,-158 # ffffffffc0206320 <default_pmm_manager+0x6c0>
...
ffffffffc02033f8:	4ed000ef          	jal	ra,ffffffffc02040e4 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02033fc:	00093583          	ld	a1,0(s2)
ffffffffc0203400:	8626                	mv	a2,s1
ffffffffc0203402:	00003517          	auipc	a0,0x3
ffffffffc0203406:	25650513          	addi	a0,a0,598 # ffffffffc0206658 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	22468693          	addi	a3,a3,548 # ffffffffc0206648 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	48460613          	addi	a2,a2,1156 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	ee850513          	addi	a0,a0,-280 # ffffffffc0206320 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	23050513          	addi	a0,a0,560 # ffffffffc0206698 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	23a50513          	addi	a0,a0,570 # ffffffffc02066d8 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	23e50513          	addi	a0,a0,574 # ffffffffc0206700 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	24850513          	addi	a0,a0,584 # ffffffffc0206728 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	25450513          	addi	a0,a0,596 # ffffffffc0206750 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	20e50513          	addi	a0,a0,526 # ffffffffc0206728 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	1a650513          	addi	a0,a0,422 # ffffffffc02066d8 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	1dc50513          	addi	a0,a0,476 # ffffffffc0206728 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	13250513          	addi	a0,a0,306 # ffffffffc0206698 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	18050513          	addi	a0,a0,384 # ffffffffc0206700 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	1b650513          	addi	a0,a0,438 # ffffffffc0206750 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	12050513          	addi	a0,a0,288 # ffffffffc02066d8 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	ef268693          	addi	a3,a3,-270 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	2b260613          	addi	a2,a2,690 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	0b650513          	addi	a0,a0,182 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	1ea68693          	addi	a3,a3,490 # ffffffffc0206800 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	29260613          	addi	a2,a2,658 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	09650513          	addi	a0,a0,150 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	1a268693          	addi	a3,a3,418 # ffffffffc02067d8 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	27260613          	addi	a2,a2,626 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	07650513          	addi	a0,a0,118 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	17268693          	addi	a3,a3,370 # ffffffffc02067c8 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	25260613          	addi	a2,a2,594 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	05650513          	addi	a0,a0,86 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	14268693          	addi	a3,a3,322 # ffffffffc02067b8 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	23260613          	addi	a2,a2,562 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	03650513          	addi	a0,a0,54 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	11268693          	addi	a3,a3,274 # ffffffffc02067a8 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	21260613          	addi	a2,a2,530 # ffffffffc02058b0 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	01650513          	addi	a0,a0,22 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	0e268693          	addi	a3,a3,226 # ffffffffc0206798 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	1f260613          	addi	a2,a2,498 # ffffffffc02058b0 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	ff650513          	addi	a0,a0,-10 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	0b268693          	addi	a3,a3,178 # ffffffffc0206788 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	1d260613          	addi	a2,a2,466 # ffffffffc02058b0 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	fd650513          	addi	a0,a0,-42 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	08268693          	addi	a3,a3,130 # ffffffffc0206778 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	1b260613          	addi	a2,a2,434 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	fb650513          	addi	a0,a0,-74 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	06268693          	addi	a3,a3,98 # ffffffffc0206778 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	19260613          	addi	a2,a2,402 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f9650513          	addi	a0,a0,-106 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	db268693          	addi	a3,a3,-590 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	17260613          	addi	a2,a2,370 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f7650513          	addi	a0,a0,-138 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d9268693          	addi	a3,a3,-622 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	15260613          	addi	a2,a2,338 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f5650513          	addi	a0,a0,-170 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d7268693          	addi	a3,a3,-654 # ffffffffc02064e8 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	13260613          	addi	a2,a2,306 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f3650513          	addi	a0,a0,-202 # ffffffffc02066c0 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	05868693          	addi	a3,a3,88 # ffffffffc0206810 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	0f060613          	addi	a2,a2,240 # ffffffffc02058b0 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	ef450513          	addi	a0,a0,-268 # ffffffffc02066c0 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	04868693          	addi	a3,a3,72 # ffffffffc0206820 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	0d060613          	addi	a2,a2,208 # ffffffffc02058b0 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	ed450513          	addi	a0,a0,-300 # ffffffffc02066c0 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	02068693          	addi	a3,a3,32 # ffffffffc0206830 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	09860613          	addi	a2,a2,152 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	e9c50513          	addi	a0,a0,-356 # ffffffffc02066c0 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	03468693          	addi	a3,a3,52 # ffffffffc0206868 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	07460613          	addi	a2,a2,116 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	04050513          	addi	a0,a0,64 # ffffffffc0206888 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	f1c68693          	addi	a3,a3,-228 # ffffffffc0206898 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	f2c60613          	addi	a2,a2,-212 # ffffffffc02058b0 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	ef850513          	addi	a0,a0,-264 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f3c68693          	addi	a3,a3,-196 # ffffffffc02068d8 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	f0c60613          	addi	a2,a2,-244 # ffffffffc02058b0 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	ed850513          	addi	a0,a0,-296 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	efc68693          	addi	a3,a3,-260 # ffffffffc02068b8 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	eec60613          	addi	a2,a2,-276 # ffffffffc02058b0 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	eb850513          	addi	a0,a0,-328 # ffffffffc0206888 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	93a68693          	addi	a3,a3,-1734 # ffffffffc02063a8 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e3a60613          	addi	a2,a2,-454 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	e0650513          	addi	a0,a0,-506 # ffffffffc0206888 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	8e668693          	addi	a3,a3,-1818 # ffffffffc02063a8 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	de660613          	addi	a2,a2,-538 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	db250513          	addi	a0,a0,-590 # ffffffffc0206888 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e6250513          	addi	a0,a0,-414 # ffffffffc02069f8 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e7e68693          	addi	a3,a3,-386 # ffffffffc0206a20 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	d0660613          	addi	a2,a2,-762 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	cd250513          	addi	a0,a0,-814 # ffffffffc0206888 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e5450513          	addi	a0,a0,-428 # ffffffffc0206a38 <default_pmm_manager+0xdd8>
...
ffffffffc0203d7c:	d3850513          	addi	a0,a0,-712 # ffffffffc0206ab0 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d3e50513          	addi	a0,a0,-706 # ffffffffc0206ad0 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b6a68693          	addi	a3,a3,-1174 # ffffffffc0206910 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	b0260613          	addi	a2,a2,-1278 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	ace50513          	addi	a0,a0,-1330 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	bd268693          	addi	a3,a3,-1070 # ffffffffc0206998 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	ae260613          	addi	a2,a2,-1310 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	aae50513          	addi	a0,a0,-1362 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	be268693          	addi	a3,a3,-1054 # ffffffffc02069c8 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	ac260613          	addi	a2,a2,-1342 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	a8e50513          	addi	a0,a0,-1394 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	af268693          	addi	a3,a3,-1294 # ffffffffc02068f8 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	aa260613          	addi	a2,a2,-1374 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a6e50513          	addi	a0,a0,-1426 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b5268693          	addi	a3,a3,-1198 # ffffffffc0206978 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a8260613          	addi	a2,a2,-1406 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a4e50513          	addi	a0,a0,-1458 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b4268693          	addi	a3,a3,-1214 # ffffffffc0206988 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a6260613          	addi	a2,a2,-1438 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	ae268693          	addi	a3,a3,-1310 # ffffffffc0206948 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a4260613          	addi	a2,a2,-1470 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	a0e50513          	addi	a0,a0,-1522 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	ad268693          	addi	a3,a3,-1326 # ffffffffc0206958 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	a2260613          	addi	a2,a2,-1502 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	9ee50513          	addi	a0,a0,-1554 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	ac268693          	addi	a3,a3,-1342 # ffffffffc0206968 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	a0260613          	addi	a2,a2,-1534 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	9ce50513          	addi	a0,a0,-1586 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	c2268693          	addi	a3,a3,-990 # ffffffffc0206ae8 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	9e260613          	addi	a2,a2,-1566 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	9ae50513          	addi	a0,a0,-1618 # ffffffffc0206888 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	4ba68693          	addi	a3,a3,1210 # ffffffffc02063a8 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	9ba60613          	addi	a2,a2,-1606 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	98650513          	addi	a0,a0,-1658 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206a58 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	99a60613          	addi	a2,a2,-1638 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	96650513          	addi	a0,a0,-1690 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206a78 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	97a60613          	addi	a2,a2,-1670 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	94650513          	addi	a0,a0,-1722 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	e1a60613          	addi	a2,a2,-486 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d6650513          	addi	a0,a0,-666 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d3260613          	addi	a2,a2,-718 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d4e50513          	addi	a0,a0,-690 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	b0a68693          	addi	a3,a3,-1270 # ffffffffc0206a88 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	92a60613          	addi	a2,a2,-1750 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	8f650513          	addi	a0,a0,-1802 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	3fa68693          	addi	a3,a3,1018 # ffffffffc0206398 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	90a60613          	addi	a2,a2,-1782 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	8d650513          	addi	a0,a0,-1834 # ffffffffc0206888 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	3b268693          	addi	a3,a3,946 # ffffffffc0206370 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	8ea60613          	addi	a2,a2,-1814 # ffffffffc02058b0 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	8b650513          	addi	a0,a0,-1866 # ffffffffc0206888 <default_pmm_manager+0xc28>
...
ffffffffc0204004:	c159                	beqz	a0,ffffffffc020408a <do_pgfault+0xac>
ffffffffc0204006:	651c                	ld	a5,8(a0)
ffffffffc0204008:	08f46163          	bltu	s0,a5,ffffffffc020408a <do_pgfault+0xac>
...
ffffffffc0204012:	ebb1                	bnez	a5,ffffffffc0204066 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
...
ffffffffc0204018:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc020401a:	85a2                	mv	a1,s0
ffffffffc020401c:	4605                	li	a2,1
ffffffffc020401e:	b1bfd0ef          	jal	ra,ffffffffc0201b38 <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0204022:	610c                	ld	a1,0(a0)
ffffffffc0204024:	c1b9                	beqz	a1,ffffffffc020406a <do_pgfault+0x8c>
        ...
        */
        if (swap_init_ok) {
ffffffffc0204026:	00011797          	auipc	a5,0x11
ffffffffc020402a:	5727a783          	lw	a5,1394(a5) # ffffffffc0215598 <swap_init_ok>
ffffffffc020402e:	c7bd                	beqz	a5,ffffffffc020409c <do_pgfault+0xbe>
...
ffffffffc0204030:	85a2                	mv	a1,s0
ffffffffc0204032:	0030                	addi	a2,sp,8
ffffffffc0204034:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0204036:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);  
ffffffffc0204038:	b92ff0ef          	jal	ra,ffffffffc02033ca <swap_in>
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc020403c:	65a2                	ld	a1,8(sp)
ffffffffc020403e:	6c88                	ld	a0,24(s1)
ffffffffc0204040:	86ca                	mv	a3,s2
ffffffffc0204042:	8622                	mv	a2,s0
ffffffffc0204044:	db7fd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0204048:	6622                	ld	a2,8(sp)
ffffffffc020404a:	4685                	li	a3,1
ffffffffc020404c:	85a2                	mv	a1,s0
ffffffffc020404e:	8526                	mv	a0,s1
ffffffffc0204050:	a5aff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0204054:	67a2                	ld	a5,8(sp)
   ...
   ret = 0;
ffffffffc0204056:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0204058:	ff80                	sd	s0,56(a5)
failed:
    return ret;
}
...
ffffffffc0204062:	6145                	addi	sp,sp,48
ffffffffc0204064:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0204066:	4959                	li	s2,22
ffffffffc0204068:	b775                	j	ffffffffc0204014 <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc020406a:	6c88                	ld	a0,24(s1)
ffffffffc020406c:	864a                	mv	a2,s2
ffffffffc020406e:	85a2                	mv	a1,s0
ffffffffc0204070:	a21fe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
ffffffffc0204074:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0204076:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204078:	f3ed                	bnez	a5,ffffffffc020405a <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc020407a:	00003517          	auipc	a0,0x3
ffffffffc020407e:	ab650513          	addi	a0,a0,-1354 # ffffffffc0206b30 <default_pmm_manager+0xed0>
ffffffffc0204082:	8fefc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204086:	5571                	li	a0,-4
            goto failed;
ffffffffc0204088:	bfc9                	j	ffffffffc020405a <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc020408a:	85a2                	mv	a1,s0
ffffffffc020408c:	00003517          	auipc	a0,0x3
ffffffffc0204090:	a7450513          	addi	a0,a0,-1420 # ffffffffc0206b00 <default_pmm_manager+0xea0>
ffffffffc0204094:	8ecfc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc0204098:	5575                	li	a0,-3
        goto failed;
ffffffffc020409a:	b7c1                	j	ffffffffc020405a <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc020409c:	00003517          	auipc	a0,0x3
ffffffffc02040a0:	abc50513          	addi	a0,a0,-1348 # ffffffffc0206b58 <default_pmm_manager+0xef8>
ffffffffc02040a4:	8dcfc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040a8:	5571                	li	a0,-4
            goto failed;
ffffffffc02040aa:	bf45                	j	ffffffffc020405a <do_pgfault+0x7c>

ffffffffc02040ac <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
void
swapfs_init(void) {
ffffffffc02040ac:	1141                	addi	sp,sp,-16
...
ffffffffc02040b0:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040b2:	cb6fc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040b6:	cd01                	beqz	a0,ffffffffc02040ce <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040b8:	4505                	li	a0,1
ffffffffc02040ba:	cb4fc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040be:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040c0:	810d                	srli	a0,a0,0x3
ffffffffc02040c2:	00011797          	auipc	a5,0x11
ffffffffc02040c6:	4ca7b323          	sd	a0,1222(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc02040ca:	0141                	addi	sp,sp,16
ffffffffc02040cc:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc02040ce:	00003617          	auipc	a2,0x3
ffffffffc02040d2:	ab260613          	addi	a2,a2,-1358 # ffffffffc0206b80 <default_pmm_manager+0xf20>
ffffffffc02040d6:	45b5                	li	a1,13
ffffffffc02040d8:	00003517          	auipc	a0,0x3
ffffffffc02040dc:	ac850513          	addi	a0,a0,-1336 # ffffffffc0206ba0 <default_pmm_manager+0xf40>
ffffffffc02040e0:	b66fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02040e4 <swapfs_read>:
...
ffffffffc02040e8:	00855793          	srli	a5,a0,0x8
ffffffffc02040ec:	cbb1                	beqz	a5,ffffffffc0204140 <swapfs_read+0x5c>
ffffffffc02040ee:	00011717          	auipc	a4,0x11
ffffffffc02040f2:	49a73703          	ld	a4,1178(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc02040f6:	04e7f563          	bgeu	a5,a4,ffffffffc0204140 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc02040fa:	00011617          	auipc	a2,0x11
ffffffffc02040fe:	47663603          	ld	a2,1142(a2) # ffffffffc0215570 <pages>
ffffffffc0204102:	8d91                	sub	a1,a1,a2
ffffffffc0204104:	4065d613          	srai	a2,a1,0x6
ffffffffc0204108:	00003717          	auipc	a4,0x3
ffffffffc020410c:	ec873703          	ld	a4,-312(a4) # ffffffffc0206fd0 <nbase>
ffffffffc0204110:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204112:	00c61713          	slli	a4,a2,0xc
ffffffffc0204116:	8331                	srli	a4,a4,0xc
ffffffffc0204118:	00011697          	auipc	a3,0x11
ffffffffc020411c:	4506b683          	ld	a3,1104(a3) # ffffffffc0215568 <npage>
ffffffffc0204120:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204124:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204126:	02d77963          	bgeu	a4,a3,ffffffffc0204158 <swapfs_read+0x74>
}
ffffffffc020412a:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020412c:	00011797          	auipc	a5,0x11
ffffffffc0204130:	4547b783          	ld	a5,1108(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc0204134:	46a1                	li	a3,8
ffffffffc0204136:	963e                	add	a2,a2,a5
ffffffffc0204138:	4505                	li	a0,1
}
ffffffffc020413a:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020413c:	c38fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204140:	86aa                	mv	a3,a0
ffffffffc0204142:	00003617          	auipc	a2,0x3
ffffffffc0204146:	a7660613          	addi	a2,a2,-1418 # ffffffffc0206bb8 <default_pmm_manager+0xf58>
ffffffffc020414a:	45d1                	li	a1,20
ffffffffc020414c:	00003517          	auipc	a0,0x3
ffffffffc0204150:	a5450513          	addi	a0,a0,-1452 # ffffffffc0206ba0 <default_pmm_manager+0xf40>
ffffffffc0204154:	af2fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc0204158:	86b2                	mv	a3,a2
ffffffffc020415a:	06900593          	li	a1,105
ffffffffc020415e:	00002617          	auipc	a2,0x2
ffffffffc0204162:	b3a60613          	addi	a2,a2,-1222 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc0204166:	00002517          	auipc	a0,0x2
ffffffffc020416a:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc020416e:	ad8fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204172 <swapfs_write>:
...
ffffffffc0204176:	00855793          	srli	a5,a0,0x8
ffffffffc020417a:	cbb1                	beqz	a5,ffffffffc02041ce <swapfs_write+0x5c>
ffffffffc020417c:	00011717          	auipc	a4,0x11
ffffffffc0204180:	40c73703          	ld	a4,1036(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc0204184:	04e7f563          	bgeu	a5,a4,ffffffffc02041ce <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc0204188:	00011617          	auipc	a2,0x11
ffffffffc020418c:	3e863603          	ld	a2,1000(a2) # ffffffffc0215570 <pages>
ffffffffc0204190:	8d91                	sub	a1,a1,a2
ffffffffc0204192:	4065d613          	srai	a2,a1,0x6
ffffffffc0204196:	00003717          	auipc	a4,0x3
ffffffffc020419a:	e3a73703          	ld	a4,-454(a4) # ffffffffc0206fd0 <nbase>
ffffffffc020419e:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041a0:	00c61713          	slli	a4,a2,0xc
ffffffffc02041a4:	8331                	srli	a4,a4,0xc
ffffffffc02041a6:	00011697          	auipc	a3,0x11
ffffffffc02041aa:	3c26b683          	ld	a3,962(a3) # ffffffffc0215568 <npage>
ffffffffc02041ae:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041b2:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041b4:	02d77963          	bgeu	a4,a3,ffffffffc02041e6 <swapfs_write+0x74>
}
ffffffffc02041b8:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ba:	00011797          	auipc	a5,0x11
ffffffffc02041be:	3c67b783          	ld	a5,966(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc02041c2:	46a1                	li	a3,8
ffffffffc02041c4:	963e                	add	a2,a2,a5
ffffffffc02041c6:	4505                	li	a0,1
}
ffffffffc02041c8:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ca:	bcefc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc02041ce:	86aa                	mv	a3,a0
ffffffffc02041d0:	00003617          	auipc	a2,0x3
ffffffffc02041d4:	9e860613          	addi	a2,a2,-1560 # ffffffffc0206bb8 <default_pmm_manager+0xf58>
ffffffffc02041d8:	45e5                	li	a1,25
ffffffffc02041da:	00003517          	auipc	a0,0x3
ffffffffc02041de:	9c650513          	addi	a0,a0,-1594 # ffffffffc0206ba0 <default_pmm_manager+0xf40>
ffffffffc02041e2:	a64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02041e6:	86b2                	mv	a3,a2
ffffffffc02041e8:	06900593          	li	a1,105
ffffffffc02041ec:	00002617          	auipc	a2,0x2
ffffffffc02041f0:	aac60613          	addi	a2,a2,-1364 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02041f4:	00002517          	auipc	a0,0x2
ffffffffc02041f8:	acc50513          	addi	a0,a0,-1332 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc02041fc:	a4afc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204200 <kernel_thread_entry>:
.text
.globl kernel_thread_entry
kernel_thread_entry:        # void kernel_thread(void)
	move a0, s1
ffffffffc0204200:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204202:	9402                	jalr	s0

	jal do_exit
ffffffffc0204204:	484000ef          	jal	ra,ffffffffc0204688 <do_exit>

ffffffffc0204208 <alloc_proc>:
...
alloc_proc(void) {
ffffffffc0204208:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc020420a:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc020420e:	e022                	sd	s0,0(sp)
ffffffffc0204210:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204212:	e3cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc0204216:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204218:	c521                	beqz	a0,ffffffffc0204260 <alloc_proc+0x58>
...
ffffffffc020421a:	57fd                	li	a5,-1
ffffffffc020421c:	1782                	slli	a5,a5,0x20
ffffffffc020421e:	e11c                	sd	a5,0(a0)
    proc->runs = 0;
    proc->kstack =0;
    proc->need_resched = 0;                              
    proc->parent = NULL;                                 
...
ffffffffc0204220:	07000613          	li	a2,112
ffffffffc0204224:	4581                	li	a1,0
    proc->runs = 0;
ffffffffc0204226:	00052423          	sw	zero,8(a0)
    proc->kstack =0;
ffffffffc020422a:	00053823          	sd	zero,16(a0)
    proc->need_resched = 0;                              
ffffffffc020422e:	00052c23          	sw	zero,24(a0)
    proc->parent = NULL;                                 
ffffffffc0204232:	02053023          	sd	zero,32(a0)
    proc->mm = NULL; 
ffffffffc0204236:	02053423          	sd	zero,40(a0)
    memset(&(proc->context), 0, sizeof(struct context));  //上下文用这个解决
ffffffffc020423a:	03050513          	addi	a0,a0,48
ffffffffc020423e:	481000ef          	jal	ra,ffffffffc0204ebe <memset>
    proc->tf = NULL;
    proc->cr3 = boot_cr3; //实验手册给了
ffffffffc0204242:	00011797          	auipc	a5,0x11
ffffffffc0204246:	3167b783          	ld	a5,790(a5) # ffffffffc0215558 <boot_cr3>
    proc->tf = NULL;
ffffffffc020424a:	0a043023          	sd	zero,160(s0)
    proc->cr3 = boot_cr3; //实验手册给了
ffffffffc020424e:	f45c                	sd	a5,168(s0)
    proc->flags = 0;
ffffffffc0204250:	0a042823          	sw	zero,176(s0)
    memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc0204254:	463d                	li	a2,15
ffffffffc0204256:	4581                	li	a1,0
ffffffffc0204258:	0b440513          	addi	a0,s0,180
ffffffffc020425c:	463000ef          	jal	ra,ffffffffc0204ebe <memset>
...
ffffffffc020426e:	3467b783          	ld	a5,838(a5) # ffffffffc02155b0 <current>
ffffffffc0204272:	73c8                	ld	a0,160(a5)
ffffffffc0204274:	8f9fc06f          	j	ffffffffc0200b6c <forkrets>
...
static int
init_main(void *arg) {
ffffffffc0204278:	7179                	addi	sp,sp,-48
ffffffffc020427a:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc020427c:	00011497          	auipc	s1,0x11
ffffffffc0204280:	29c48493          	addi	s1,s1,668 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc0204284:	f022                	sd	s0,32(sp)
ffffffffc0204286:	e84a                	sd	s2,16(sp)
ffffffffc0204288:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020428a:	00011917          	auipc	s2,0x11
ffffffffc020428e:	32693903          	ld	s2,806(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc020429a:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc020429c:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042a0:	41f000ef          	jal	ra,ffffffffc0204ebe <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042a4:	0b490593          	addi	a1,s2,180
ffffffffc02042a8:	463d                	li	a2,15
ffffffffc02042aa:	8526                	mv	a0,s1
ffffffffc02042ac:	425000ef          	jal	ra,ffffffffc0204ed0 <memcpy>
ffffffffc02042b0:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042b2:	85ce                	mv	a1,s3
ffffffffc02042b4:	00003517          	auipc	a0,0x3
ffffffffc02042b8:	92450513          	addi	a0,a0,-1756 # ffffffffc0206bd8 <default_pmm_manager+0xf78>
ffffffffc02042bc:	ec5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042c0:	85a2                	mv	a1,s0
ffffffffc02042c2:	00003517          	auipc	a0,0x3
ffffffffc02042c6:	93e50513          	addi	a0,a0,-1730 # ffffffffc0206c00 <default_pmm_manager+0xfa0>
ffffffffc02042ca:	eb7fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042ce:	00003517          	auipc	a0,0x3
ffffffffc02042d2:	94250513          	addi	a0,a0,-1726 # ffffffffc0206c10 <default_pmm_manager+0xfb0>
ffffffffc02042d6:	eabfb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc02042da:	70a2                	ld	ra,40(sp)
ffffffffc02042dc:	7402                	ld	s0,32(sp)
ffffffffc02042de:	64e2                	ld	s1,24(sp)
ffffffffc02042e0:	6942                	ld	s2,16(sp)
ffffffffc02042e2:	69a2                	ld	s3,8(sp)
ffffffffc02042e4:	4501                	li	a0,0
ffffffffc02042e6:	6145                	addi	sp,sp,48
...
ffffffffc02042ec:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc02042ee:	00011917          	auipc	s2,0x11
ffffffffc02042f2:	2c290913          	addi	s2,s2,706 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc02042fe:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204300:	02a48963          	beq	s1,a0,ffffffffc0204332 <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020430a:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020430c:	e3a1                	bnez	a5,ffffffffc020434c <proc_run+0x62>
            lcr3(next->cr3);
...
ffffffffc0204310:	80000737          	lui	a4,0x80000
            current = proc;
ffffffffc0204314:	00a93023          	sd	a0,0(s2)
ffffffffc0204318:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020431c:	8fd9                	or	a5,a5,a4
ffffffffc020431e:	18079073          	csrw	satp,a5
            switch_to(&(prev->context), &(next->context));
ffffffffc0204322:	03050593          	addi	a1,a0,48
ffffffffc0204326:	03048513          	addi	a0,s1,48
ffffffffc020432a:	5e4000ef          	jal	ra,ffffffffc020490e <switch_to>
    if (flag) {
ffffffffc020432e:	00099863          	bnez	s3,ffffffffc020433e <proc_run+0x54>
}
ffffffffc0204332:	70a2                	ld	ra,40(sp)
ffffffffc0204334:	7482                	ld	s1,32(sp)
ffffffffc0204336:	6962                	ld	s2,24(sp)
ffffffffc0204338:	69c2                	ld	s3,16(sp)
ffffffffc020433a:	6145                	addi	sp,sp,48
...
ffffffffc0204346:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204348:	a74fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc020434c:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020434e:	a74fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204352:	6522                	ld	a0,8(sp)
ffffffffc0204354:	4985                	li	s3,1
ffffffffc0204356:	bf65                	j	ffffffffc020430e <proc_run+0x24>

ffffffffc0204358 <do_fork>:
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204358:	00011717          	auipc	a4,0x11
ffffffffc020435c:	27072703          	lw	a4,624(a4) # ffffffffc02155c8 <nr_process>
ffffffffc0204360:	6785                	lui	a5,0x1
ffffffffc0204362:	26f75063          	bge	a4,a5,ffffffffc02045c2 <do_fork+0x26a>
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204366:	7179                	addi	sp,sp,-48
ffffffffc0204368:	f022                	sd	s0,32(sp)
ffffffffc020436a:	ec26                	sd	s1,24(sp)
ffffffffc020436c:	e84a                	sd	s2,16(sp)
ffffffffc020436e:	f406                	sd	ra,40(sp)
ffffffffc0204370:	e44e                	sd	s3,8(sp)
ffffffffc0204372:	84ae                	mv	s1,a1
ffffffffc0204374:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL)
ffffffffc0204376:	e93ff0ef          	jal	ra,ffffffffc0204208 <alloc_proc>
ffffffffc020437a:	892a                	mv	s2,a0
ffffffffc020437c:	24050863          	beqz	a0,ffffffffc02045cc <do_fork+0x274>
    proc->parent = current; // 继承父进程
ffffffffc0204380:	00011997          	auipc	s3,0x11
ffffffffc0204384:	23098993          	addi	s3,s3,560 # ffffffffc02155b0 <current>
ffffffffc0204388:	0009b783          	ld	a5,0(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020438c:	4509                	li	a0,2
    proc->parent = current; // 继承父进程
ffffffffc020438e:	02f93023          	sd	a5,32(s2)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204392:	e9afd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc0204396:	1e050063          	beqz	a0,ffffffffc0204576 <do_fork+0x21e>
    return page - pages + nbase;
ffffffffc020439a:	00011697          	auipc	a3,0x11
ffffffffc020439e:	1d66b683          	ld	a3,470(a3) # ffffffffc0215570 <pages>
ffffffffc02043a2:	40d506b3          	sub	a3,a0,a3
ffffffffc02043a6:	8699                	srai	a3,a3,0x6
ffffffffc02043a8:	00003517          	auipc	a0,0x3
ffffffffc02043ac:	c2853503          	ld	a0,-984(a0) # ffffffffc0206fd0 <nbase>
ffffffffc02043b0:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043b2:	00c69793          	slli	a5,a3,0xc
ffffffffc02043b6:	83b1                	srli	a5,a5,0xc
ffffffffc02043b8:	00011717          	auipc	a4,0x11
ffffffffc02043bc:	1b073703          	ld	a4,432(a4) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043c0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043c2:	22e7f763          	bgeu	a5,a4,ffffffffc02045f0 <do_fork+0x298>
    assert(current->mm == NULL);
ffffffffc02043c6:	0009b783          	ld	a5,0(s3)
ffffffffc02043ca:	00011717          	auipc	a4,0x11
ffffffffc02043ce:	1b673703          	ld	a4,438(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043d2:	96ba                	add	a3,a3,a4
ffffffffc02043d4:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043d6:	00d93823          	sd	a3,16(s2)
    assert(current->mm == NULL);
ffffffffc02043da:	1e079b63          	bnez	a5,ffffffffc02045d0 <do_fork+0x278>
...
ffffffffc02043e6:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043e8:	0ad93023          	sd	a3,160(s2)
    *(proc->tf) = *tf;
...
ffffffffc020440e:	ff1612e3          	bne	a2,a7,ffffffffc02043f2 <do_fork+0x9a>
    proc->tf->gpr.a0 = 0;
ffffffffc0204412:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204416:	10048f63          	beqz	s1,ffffffffc0204534 <do_fork+0x1dc>
ffffffffc020441a:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020441c:	00000797          	auipc	a5,0x0
ffffffffc0204420:	e4e78793          	addi	a5,a5,-434 # ffffffffc020426a <forkret>
ffffffffc0204424:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204428:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020442c:	100027f3          	csrr	a5,sstatus
ffffffffc0204430:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204432:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204434:	12079063          	bnez	a5,ffffffffc0204554 <do_fork+0x1fc>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204438:	00006817          	auipc	a6,0x6
ffffffffc020443c:	c2080813          	addi	a6,a6,-992 # ffffffffc020a058 <last_pid.1>
ffffffffc0204440:	00082783          	lw	a5,0(a6)
ffffffffc0204444:	6709                	lui	a4,0x2
ffffffffc0204446:	0017851b          	addiw	a0,a5,1
ffffffffc020444a:	00a82023          	sw	a0,0(a6)
ffffffffc020444e:	06e55c63          	bge	a0,a4,ffffffffc02044c6 <do_fork+0x16e>
    if (last_pid >= next_safe) {
ffffffffc0204452:	00006317          	auipc	t1,0x6
ffffffffc0204456:	c0a30313          	addi	t1,t1,-1014 # ffffffffc020a05c <next_safe.0>
ffffffffc020445a:	00032783          	lw	a5,0(t1)
ffffffffc020445e:	00011417          	auipc	s0,0x11
ffffffffc0204462:	0ca40413          	addi	s0,s0,202 # ffffffffc0215528 <proc_list>
ffffffffc0204466:	06f55863          	bge	a0,a5,ffffffffc02044d6 <do_fork+0x17e>
        proc->pid = get_pid();                    // 分配id
ffffffffc020446a:	00a92223          	sw	a0,4(s2)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020446e:	45a9                	li	a1,10
ffffffffc0204470:	2501                	sext.w	a0,a0
ffffffffc0204472:	5cc000ef          	jal	ra,ffffffffc0204a3e <hash32>
...
ffffffffc0204486:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204488:	6514                	ld	a3,8(a0)
ffffffffc020448a:	0d890793          	addi	a5,s2,216
ffffffffc020448e:	6418                	ld	a4,8(s0)
    prev->next = next->prev = elm;
ffffffffc0204490:	e29c                	sd	a5,0(a3)
ffffffffc0204492:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc0204494:	0ed93023          	sd	a3,224(s2)
        list_add(&proc_list, &(proc->list_link)); 
ffffffffc0204498:	0c890793          	addi	a5,s2,200
    elm->prev = prev;
ffffffffc020449c:	0ca93c23          	sd	a0,216(s2)
    prev->next = next->prev = elm;
ffffffffc02044a0:	e31c                	sd	a5,0(a4)
ffffffffc02044a2:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044a4:	0ce93823          	sd	a4,208(s2)
    elm->prev = prev;
ffffffffc02044a8:	0c893423          	sd	s0,200(s2)
    if (flag) {
ffffffffc02044ac:	e8c5                	bnez	s1,ffffffffc020455c <do_fork+0x204>
    wakeup_proc(proc);
ffffffffc02044ae:	854a                	mv	a0,s2
ffffffffc02044b0:	4c8000ef          	jal	ra,ffffffffc0204978 <wakeup_proc>
    ret = proc->pid;
ffffffffc02044b4:	00492503          	lw	a0,4(s2)
}
ffffffffc02044b8:	70a2                	ld	ra,40(sp)
ffffffffc02044ba:	7402                	ld	s0,32(sp)
ffffffffc02044bc:	64e2                	ld	s1,24(sp)
ffffffffc02044be:	6942                	ld	s2,16(sp)
ffffffffc02044c0:	69a2                	ld	s3,8(sp)
ffffffffc02044c2:	6145                	addi	sp,sp,48
...
ffffffffc02044ce:	00006317          	auipc	t1,0x6
ffffffffc02044d2:	b8e30313          	addi	t1,t1,-1138 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044d6:	00011417          	auipc	s0,0x11
ffffffffc02044da:	05240413          	addi	s0,s0,82 # ffffffffc0215528 <proc_list>
ffffffffc02044de:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
...
ffffffffc02044ee:	068e0f63          	beq	t3,s0,ffffffffc020456c <do_fork+0x214>
ffffffffc02044f2:	88ae                	mv	a7,a1
ffffffffc02044f4:	87f2                	mv	a5,t3
ffffffffc02044f6:	6609                	lui	a2,0x2
ffffffffc02044f8:	a811                	j	ffffffffc020450c <do_fork+0x1b4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02044fa:	00e6d663          	bge	a3,a4,ffffffffc0204506 <do_fork+0x1ae>
ffffffffc02044fe:	00c75463          	bge	a4,a2,ffffffffc0204506 <do_fork+0x1ae>
ffffffffc0204502:	863a                	mv	a2,a4
ffffffffc0204504:	4885                	li	a7,1
ffffffffc0204506:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204508:	00878d63          	beq	a5,s0,ffffffffc0204522 <do_fork+0x1ca>
            if (proc->pid == last_pid) {
ffffffffc020450c:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204510:	fed715e3          	bne	a4,a3,ffffffffc02044fa <do_fork+0x1a2>
                if (++ last_pid >= next_safe) {
ffffffffc0204514:	2685                	addiw	a3,a3,1
ffffffffc0204516:	04c6d663          	bge	a3,a2,ffffffffc0204562 <do_fork+0x20a>
ffffffffc020451a:	679c                	ld	a5,8(a5)
ffffffffc020451c:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020451e:	fe8797e3          	bne	a5,s0,ffffffffc020450c <do_fork+0x1b4>
ffffffffc0204522:	c581                	beqz	a1,ffffffffc020452a <do_fork+0x1d2>
ffffffffc0204524:	00d82023          	sw	a3,0(a6)
ffffffffc0204528:	8536                	mv	a0,a3
ffffffffc020452a:	f40880e3          	beqz	a7,ffffffffc020446a <do_fork+0x112>
ffffffffc020452e:	00c32023          	sw	a2,0(t1)
ffffffffc0204532:	bf25                	j	ffffffffc020446a <do_fork+0x112>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204534:	84b6                	mv	s1,a3
ffffffffc0204536:	ea84                	sd	s1,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204538:	00000797          	auipc	a5,0x0
ffffffffc020453c:	d3278793          	addi	a5,a5,-718 # ffffffffc020426a <forkret>
ffffffffc0204540:	02f93823          	sd	a5,48(s2)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204544:	02d93c23          	sd	a3,56(s2)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204548:	100027f3          	csrr	a5,sstatus
ffffffffc020454c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020454e:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204550:	ee0784e3          	beqz	a5,ffffffffc0204438 <do_fork+0xe0>
        intr_disable();
ffffffffc0204554:	86efc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204558:	4485                	li	s1,1
ffffffffc020455a:	bdf9                	j	ffffffffc0204438 <do_fork+0xe0>
        intr_enable();
ffffffffc020455c:	860fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204560:	b7b9                	j	ffffffffc02044ae <do_fork+0x156>
                    if (last_pid >= MAX_PID) {
ffffffffc0204562:	01d6c363          	blt	a3,t4,ffffffffc0204568 <do_fork+0x210>
                        last_pid = 1;
ffffffffc0204566:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204568:	4585                	li	a1,1
ffffffffc020456a:	b751                	j	ffffffffc02044ee <do_fork+0x196>
ffffffffc020456c:	cda9                	beqz	a1,ffffffffc02045c6 <do_fork+0x26e>
ffffffffc020456e:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204572:	8536                	mv	a0,a3
ffffffffc0204574:	bddd                	j	ffffffffc020446a <do_fork+0x112>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204576:	01093683          	ld	a3,16(s2)
    return pa2page(PADDR(kva));
ffffffffc020457a:	c02007b7          	lui	a5,0xc0200
ffffffffc020457e:	0af6e163          	bltu	a3,a5,ffffffffc0204620 <do_fork+0x2c8>
ffffffffc0204582:	00011797          	auipc	a5,0x11
ffffffffc0204586:	ffe7b783          	ld	a5,-2(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc020458a:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020458e:	83b1                	srli	a5,a5,0xc
ffffffffc0204590:	00011717          	auipc	a4,0x11
ffffffffc0204594:	fd873703          	ld	a4,-40(a4) # ffffffffc0215568 <npage>
ffffffffc0204598:	06e7f863          	bgeu	a5,a4,ffffffffc0204608 <do_fork+0x2b0>
    return &pages[PPN(pa) - nbase];
ffffffffc020459c:	00003717          	auipc	a4,0x3
ffffffffc02045a0:	a3473703          	ld	a4,-1484(a4) # ffffffffc0206fd0 <nbase>
ffffffffc02045a4:	8f99                	sub	a5,a5,a4
ffffffffc02045a6:	079a                	slli	a5,a5,0x6
ffffffffc02045a8:	00011517          	auipc	a0,0x11
ffffffffc02045ac:	fc853503          	ld	a0,-56(a0) # ffffffffc0215570 <pages>
ffffffffc02045b0:	953e                	add	a0,a0,a5
ffffffffc02045b2:	4589                	li	a1,2
ffffffffc02045b4:	d0afd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045b8:	854a                	mv	a0,s2
ffffffffc02045ba:	b44fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045be:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045c0:	bde5                	j	ffffffffc02044b8 <do_fork+0x160>
...
ffffffffc02045ca:	b545                	j	ffffffffc020446a <do_fork+0x112>
    ret = -E_NO_MEM;
ffffffffc02045cc:	5571                	li	a0,-4
    return ret;
ffffffffc02045ce:	b5ed                	j	ffffffffc02044b8 <do_fork+0x160>
    assert(current->mm == NULL);
ffffffffc02045d0:	00002697          	auipc	a3,0x2
ffffffffc02045d4:	66068693          	addi	a3,a3,1632 # ffffffffc0206c30 <default_pmm_manager+0xfd0>
ffffffffc02045d8:	00001617          	auipc	a2,0x1
ffffffffc02045dc:	2d860613          	addi	a2,a2,728 # ffffffffc02058b0 <commands+0x738>
ffffffffc02045e0:	10b00593          	li	a1,267
ffffffffc02045e4:	00002517          	auipc	a0,0x2
ffffffffc02045e8:	66450513          	addi	a0,a0,1636 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
ffffffffc02045ec:	e5bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045f0:	00001617          	auipc	a2,0x1
ffffffffc02045f4:	6a860613          	addi	a2,a2,1704 # ffffffffc0205c98 <default_pmm_manager+0x38>
ffffffffc02045f8:	06900593          	li	a1,105
ffffffffc02045fc:	00001517          	auipc	a0,0x1
ffffffffc0204600:	6c450513          	addi	a0,a0,1732 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0204604:	e43fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204608:	00001617          	auipc	a2,0x1
ffffffffc020460c:	76060613          	addi	a2,a2,1888 # ffffffffc0205d68 <default_pmm_manager+0x108>
ffffffffc0204610:	06200593          	li	a1,98
ffffffffc0204614:	00001517          	auipc	a0,0x1
ffffffffc0204618:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc020461c:	e2bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204620:	00001617          	auipc	a2,0x1
ffffffffc0204624:	72060613          	addi	a2,a2,1824 # ffffffffc0205d40 <default_pmm_manager+0xe0>
ffffffffc0204628:	06e00593          	li	a1,110
ffffffffc020462c:	00001517          	auipc	a0,0x1
ffffffffc0204630:	69450513          	addi	a0,a0,1684 # ffffffffc0205cc0 <default_pmm_manager+0x60>
ffffffffc0204634:	e13fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204638 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204638:	7129                	addi	sp,sp,-320
ffffffffc020463a:	fa22                	sd	s0,304(sp)
ffffffffc020463c:	f626                	sd	s1,296(sp)
ffffffffc020463e:	f24a                	sd	s2,288(sp)
ffffffffc0204640:	84ae                	mv	s1,a1
ffffffffc0204642:	892a                	mv	s2,a0
ffffffffc0204644:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204646:	4581                	li	a1,0
ffffffffc0204648:	12000613          	li	a2,288
ffffffffc020464c:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020464e:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204650:	06f000ef          	jal	ra,ffffffffc0204ebe <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc0204654:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc0204656:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0204658:	100027f3          	csrr	a5,sstatus
ffffffffc020465c:	edd7f793          	andi	a5,a5,-291
ffffffffc0204660:	1207e793          	ori	a5,a5,288
ffffffffc0204664:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204666:	860a                	mv	a2,sp
ffffffffc0204668:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020466c:	00000797          	auipc	a5,0x0
ffffffffc0204670:	b9478793          	addi	a5,a5,-1132 # ffffffffc0204200 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204674:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204676:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204678:	ce1ff0ef          	jal	ra,ffffffffc0204358 <do_fork>
}
ffffffffc020467c:	70f2                	ld	ra,312(sp)
ffffffffc020467e:	7452                	ld	s0,304(sp)
ffffffffc0204680:	74b2                	ld	s1,296(sp)
ffffffffc0204682:	7912                	ld	s2,288(sp)
ffffffffc0204684:	6131                	addi	sp,sp,320
ffffffffc0204686:	8082                	ret

ffffffffc0204688 <do_exit>:
do_exit(int error_code) {
ffffffffc0204688:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc020468a:	00002617          	auipc	a2,0x2
ffffffffc020468e:	5d660613          	addi	a2,a2,1494 # ffffffffc0206c60 <default_pmm_manager+0x1000>
ffffffffc0204692:	16900593          	li	a1,361
ffffffffc0204696:	00002517          	auipc	a0,0x2
ffffffffc020469a:	5b250513          	addi	a0,a0,1458 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
do_exit(int error_code) {
ffffffffc020469e:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046a0:	da7fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02046a4 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc02046a4:	7179                	addi	sp,sp,-48
ffffffffc02046a6:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046a8:	00011797          	auipc	a5,0x11
ffffffffc02046ac:	e8078793          	addi	a5,a5,-384 # ffffffffc0215528 <proc_list>
ffffffffc02046b0:	f406                	sd	ra,40(sp)
ffffffffc02046b2:	f022                	sd	s0,32(sp)
ffffffffc02046b4:	e84a                	sd	s2,16(sp)
ffffffffc02046b6:	e44e                	sd	s3,8(sp)
ffffffffc02046b8:	0000d497          	auipc	s1,0xd
ffffffffc02046bc:	e6048493          	addi	s1,s1,-416 # ffffffffc0211518 <hash_list>
ffffffffc02046c0:	e79c                	sd	a5,8(a5)
ffffffffc02046c2:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc02046c4:	00011717          	auipc	a4,0x11
ffffffffc02046c8:	e5470713          	addi	a4,a4,-428 # ffffffffc0215518 <name.2>
ffffffffc02046cc:	87a6                	mv	a5,s1
ffffffffc02046ce:	e79c                	sd	a5,8(a5)
ffffffffc02046d0:	e39c                	sd	a5,0(a5)
ffffffffc02046d2:	07c1                	addi	a5,a5,16
ffffffffc02046d4:	fef71de3          	bne	a4,a5,ffffffffc02046ce <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046d8:	b31ff0ef          	jal	ra,ffffffffc0204208 <alloc_proc>
ffffffffc02046dc:	00011917          	auipc	s2,0x11
ffffffffc02046e0:	edc90913          	addi	s2,s2,-292 # ffffffffc02155b8 <idleproc>
ffffffffc02046e4:	00a93023          	sd	a0,0(s2)
ffffffffc02046e8:	18050d63          	beqz	a0,ffffffffc0204882 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046ec:	07000513          	li	a0,112
ffffffffc02046f0:	95efd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046f4:	07000613          	li	a2,112
ffffffffc02046f8:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046fa:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046fc:	7c2000ef          	jal	ra,ffffffffc0204ebe <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204700:	00093503          	ld	a0,0(s2)
ffffffffc0204704:	85a2                	mv	a1,s0
ffffffffc0204706:	07000613          	li	a2,112
ffffffffc020470a:	03050513          	addi	a0,a0,48
ffffffffc020470e:	7da000ef          	jal	ra,ffffffffc0204ee8 <memcmp>
ffffffffc0204712:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204714:	453d                	li	a0,15
ffffffffc0204716:	938fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020471e:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204720:	79e000ef          	jal	ra,ffffffffc0204ebe <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204724:	00093503          	ld	a0,0(s2)
ffffffffc0204728:	463d                	li	a2,15
ffffffffc020472a:	85a2                	mv	a1,s0
ffffffffc020472c:	0b450513          	addi	a0,a0,180
ffffffffc0204730:	7b8000ef          	jal	ra,ffffffffc0204ee8 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204734:	00093783          	ld	a5,0(s2)
ffffffffc0204738:	00011717          	auipc	a4,0x11
ffffffffc020473c:	e2073703          	ld	a4,-480(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc0204740:	77d4                	ld	a3,168(a5)
ffffffffc0204742:	0ee68463          	beq	a3,a4,ffffffffc020482a <proc_init+0x186>
...
ffffffffc0204746:	4709                	li	a4,2
ffffffffc0204748:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020474a:	00003717          	auipc	a4,0x3
ffffffffc020474e:	8b670713          	addi	a4,a4,-1866 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204752:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
...
ffffffffc020475a:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020475c:	4641                	li	a2,16
ffffffffc020475e:	4581                	li	a1,0
ffffffffc0204760:	8522                	mv	a0,s0
ffffffffc0204762:	75c000ef          	jal	ra,ffffffffc0204ebe <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204766:	463d                	li	a2,15
ffffffffc0204768:	00002597          	auipc	a1,0x2
ffffffffc020476c:	54058593          	addi	a1,a1,1344 # ffffffffc0206ca8 <default_pmm_manager+0x1048>
ffffffffc0204770:	8522                	mv	a0,s0
ffffffffc0204772:	75e000ef          	jal	ra,ffffffffc0204ed0 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204776:	00011717          	auipc	a4,0x11
ffffffffc020477a:	e5270713          	addi	a4,a4,-430 # ffffffffc02155c8 <nr_process>
ffffffffc020477e:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204780:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204784:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204786:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204788:	00002597          	auipc	a1,0x2
ffffffffc020478c:	52858593          	addi	a1,a1,1320 # ffffffffc0206cb0 <default_pmm_manager+0x1050>
ffffffffc0204790:	00000517          	auipc	a0,0x0
ffffffffc0204794:	ae850513          	addi	a0,a0,-1304 # ffffffffc0204278 <init_main>
    nr_process ++;
ffffffffc0204798:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc020479a:	00011797          	auipc	a5,0x11
ffffffffc020479e:	e0d7bb23          	sd	a3,-490(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047a2:	e97ff0ef          	jal	ra,ffffffffc0204638 <kernel_thread>
ffffffffc02047a6:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047a8:	0ea05963          	blez	a0,ffffffffc020489a <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047ac:	6789                	lui	a5,0x2
ffffffffc02047ae:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047b2:	17f9                	addi	a5,a5,-2
ffffffffc02047b4:	2501                	sext.w	a0,a0
ffffffffc02047b6:	02e7e363          	bltu	a5,a4,ffffffffc02047dc <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047ba:	45a9                	li	a1,10
ffffffffc02047bc:	282000ef          	jal	ra,ffffffffc0204a3e <hash32>
ffffffffc02047c0:	02051793          	slli	a5,a0,0x20
ffffffffc02047c4:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047c8:	96a6                	add	a3,a3,s1
ffffffffc02047ca:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047cc:	a029                	j	ffffffffc02047d6 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc02047ce:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02047d2:	0a870563          	beq	a4,s0,ffffffffc020487c <proc_init+0x1d8>
    return listelm->next;
ffffffffc02047d6:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02047d8:	fef69be3          	bne	a3,a5,ffffffffc02047ce <proc_init+0x12a>
    return NULL;
ffffffffc02047dc:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047de:	0b478493          	addi	s1,a5,180
ffffffffc02047e2:	4641                	li	a2,16
ffffffffc02047e4:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc02047e6:	00011417          	auipc	s0,0x11
ffffffffc02047ea:	dda40413          	addi	s0,s0,-550 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047ee:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047f0:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047f2:	6cc000ef          	jal	ra,ffffffffc0204ebe <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047f6:	463d                	li	a2,15
ffffffffc02047f8:	00002597          	auipc	a1,0x2
ffffffffc02047fc:	4e858593          	addi	a1,a1,1256 # ffffffffc0206ce0 <default_pmm_manager+0x1080>
ffffffffc0204800:	8526                	mv	a0,s1
ffffffffc0204802:	6ce000ef          	jal	ra,ffffffffc0204ed0 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204806:	00093783          	ld	a5,0(s2)
ffffffffc020480a:	c7e1                	beqz	a5,ffffffffc02048d2 <proc_init+0x22e>
ffffffffc020480c:	43dc                	lw	a5,4(a5)
ffffffffc020480e:	e3f1                	bnez	a5,ffffffffc02048d2 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204810:	601c                	ld	a5,0(s0)
ffffffffc0204812:	c3c5                	beqz	a5,ffffffffc02048b2 <proc_init+0x20e>
ffffffffc0204814:	43d8                	lw	a4,4(a5)
ffffffffc0204816:	4785                	li	a5,1
ffffffffc0204818:	08f71d63          	bne	a4,a5,ffffffffc02048b2 <proc_init+0x20e>
}
ffffffffc020481c:	70a2                	ld	ra,40(sp)
ffffffffc020481e:	7402                	ld	s0,32(sp)
ffffffffc0204820:	64e2                	ld	s1,24(sp)
ffffffffc0204822:	6942                	ld	s2,16(sp)
ffffffffc0204824:	69a2                	ld	s3,8(sp)
ffffffffc0204826:	6145                	addi	sp,sp,48
ffffffffc0204828:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020482a:	73d8                	ld	a4,160(a5)
ffffffffc020482c:	ff09                	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
ffffffffc020482e:	f0099ce3          	bnez	s3,ffffffffc0204746 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204832:	6394                	ld	a3,0(a5)
ffffffffc0204834:	577d                	li	a4,-1
ffffffffc0204836:	1702                	slli	a4,a4,0x20
ffffffffc0204838:	f0e697e3          	bne	a3,a4,ffffffffc0204746 <proc_init+0xa2>
ffffffffc020483c:	4798                	lw	a4,8(a5)
ffffffffc020483e:	f00714e3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204842:	6b98                	ld	a4,16(a5)
ffffffffc0204844:	f00711e3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
ffffffffc0204848:	4f98                	lw	a4,24(a5)
ffffffffc020484a:	2701                	sext.w	a4,a4
ffffffffc020484c:	ee071de3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
ffffffffc0204850:	7398                	ld	a4,32(a5)
ffffffffc0204852:	ee071ae3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204856:	7798                	ld	a4,40(a5)
ffffffffc0204858:	ee0717e3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
ffffffffc020485c:	0b07a703          	lw	a4,176(a5)
ffffffffc0204860:	8d59                	or	a0,a0,a4
ffffffffc0204862:	0005071b          	sext.w	a4,a0
ffffffffc0204866:	ee0710e3          	bnez	a4,ffffffffc0204746 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc020486a:	00002517          	auipc	a0,0x2
ffffffffc020486e:	42650513          	addi	a0,a0,1062 # ffffffffc0206c90 <default_pmm_manager+0x1030>
ffffffffc0204872:	90ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc0204876:	00093783          	ld	a5,0(s2)
ffffffffc020487a:	b5f1                	j	ffffffffc0204746 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc020487c:	f2878793          	addi	a5,a5,-216
ffffffffc0204880:	bfb9                	j	ffffffffc02047de <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc0204882:	00002617          	auipc	a2,0x2
ffffffffc0204886:	3f660613          	addi	a2,a2,1014 # ffffffffc0206c78 <default_pmm_manager+0x1018>
ffffffffc020488a:	18100593          	li	a1,385
ffffffffc020488e:	00002517          	auipc	a0,0x2
ffffffffc0204892:	3ba50513          	addi	a0,a0,954 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
ffffffffc0204896:	bb1fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020489a:	00002617          	auipc	a2,0x2
ffffffffc020489e:	42660613          	addi	a2,a2,1062 # ffffffffc0206cc0 <default_pmm_manager+0x1060>
ffffffffc02048a2:	1a100593          	li	a1,417
ffffffffc02048a6:	00002517          	auipc	a0,0x2
ffffffffc02048aa:	3a250513          	addi	a0,a0,930 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
ffffffffc02048ae:	b99fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048b2:	00002697          	auipc	a3,0x2
ffffffffc02048b6:	45e68693          	addi	a3,a3,1118 # ffffffffc0206d10 <default_pmm_manager+0x10b0>
ffffffffc02048ba:	00001617          	auipc	a2,0x1
ffffffffc02048be:	ff660613          	addi	a2,a2,-10 # ffffffffc02058b0 <commands+0x738>
ffffffffc02048c2:	1a800593          	li	a1,424
ffffffffc02048c6:	00002517          	auipc	a0,0x2
ffffffffc02048ca:	38250513          	addi	a0,a0,898 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
ffffffffc02048ce:	b79fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048d2:	00002697          	auipc	a3,0x2
ffffffffc02048d6:	41668693          	addi	a3,a3,1046 # ffffffffc0206ce8 <default_pmm_manager+0x1088>
ffffffffc02048da:	00001617          	auipc	a2,0x1
ffffffffc02048de:	fd660613          	addi	a2,a2,-42 # ffffffffc02058b0 <commands+0x738>
ffffffffc02048e2:	1a700593          	li	a1,423
ffffffffc02048e6:	00002517          	auipc	a0,0x2
ffffffffc02048ea:	36250513          	addi	a0,a0,866 # ffffffffc0206c48 <default_pmm_manager+0xfe8>
ffffffffc02048ee:	b59fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048f2 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc02048f2:	1141                	addi	sp,sp,-16
ffffffffc02048f4:	e022                	sd	s0,0(sp)
ffffffffc02048f6:	e406                	sd	ra,8(sp)
ffffffffc02048f8:	00011417          	auipc	s0,0x11
ffffffffc02048fc:	cb840413          	addi	s0,s0,-840 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204900:	6018                	ld	a4,0(s0)
ffffffffc0204902:	4f1c                	lw	a5,24(a4)
ffffffffc0204904:	2781                	sext.w	a5,a5
ffffffffc0204906:	dff5                	beqz	a5,ffffffffc0204902 <cpu_idle+0x10>
            schedule();
ffffffffc0204908:	0a2000ef          	jal	ra,ffffffffc02049aa <schedule>
ffffffffc020490c:	bfd5                	j	ffffffffc0204900 <cpu_idle+0xe>

ffffffffc020490e <switch_to>:
.text
...
ffffffffc020490e:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204912:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204916:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204918:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020491a:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020491e:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204922:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204926:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020492a:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020492e:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204932:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204936:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020493a:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020493e:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204942:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204946:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020494a:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020494c:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020494e:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204952:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204956:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020495a:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020495e:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204962:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204966:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020496a:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020496e:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204972:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204976:	8082                	ret

ffffffffc0204978 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204978:	411c                	lw	a5,0(a0)
ffffffffc020497a:	4705                	li	a4,1
ffffffffc020497c:	37f9                	addiw	a5,a5,-2
ffffffffc020497e:	00f77563          	bgeu	a4,a5,ffffffffc0204988 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc0204982:	4789                	li	a5,2
ffffffffc0204984:	c11c                	sw	a5,0(a0)
ffffffffc0204986:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204988:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020498a:	00002697          	auipc	a3,0x2
ffffffffc020498e:	3ae68693          	addi	a3,a3,942 # ffffffffc0206d38 <default_pmm_manager+0x10d8>
ffffffffc0204992:	00001617          	auipc	a2,0x1
ffffffffc0204996:	f1e60613          	addi	a2,a2,-226 # ffffffffc02058b0 <commands+0x738>
ffffffffc020499a:	45a5                	li	a1,9
ffffffffc020499c:	00002517          	auipc	a0,0x2
ffffffffc02049a0:	3dc50513          	addi	a0,a0,988 # ffffffffc0206d78 <default_pmm_manager+0x1118>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049a4:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049a6:	aa1fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049aa <schedule>:
}

void
schedule(void) {
ffffffffc02049aa:	1141                	addi	sp,sp,-16
ffffffffc02049ac:	e406                	sd	ra,8(sp)
ffffffffc02049ae:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049b0:	100027f3          	csrr	a5,sstatus
ffffffffc02049b4:	8b89                	andi	a5,a5,2
ffffffffc02049b6:	4401                	li	s0,0
ffffffffc02049b8:	efbd                	bnez	a5,ffffffffc0204a36 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049ba:	00011897          	auipc	a7,0x11
ffffffffc02049be:	bf68b883          	ld	a7,-1034(a7) # ffffffffc02155b0 <current>
ffffffffc02049c2:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049c6:	00011517          	auipc	a0,0x11
ffffffffc02049ca:	bf253503          	ld	a0,-1038(a0) # ffffffffc02155b8 <idleproc>
ffffffffc02049ce:	04a88e63          	beq	a7,a0,ffffffffc0204a2a <schedule+0x80>
ffffffffc02049d2:	0c888693          	addi	a3,a7,200
ffffffffc02049d6:	00011617          	auipc	a2,0x11
ffffffffc02049da:	b5260613          	addi	a2,a2,-1198 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc02049de:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc02049e0:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049e2:	4809                	li	a6,2
ffffffffc02049e4:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049e6:	00c78863          	beq	a5,a2,ffffffffc02049f6 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ea:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049ee:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049f2:	03070163          	beq	a4,a6,ffffffffc0204a14 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049f6:	fef697e3          	bne	a3,a5,ffffffffc02049e4 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049fa:	ed89                	bnez	a1,ffffffffc0204a14 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc02049fc:	451c                	lw	a5,8(a0)
ffffffffc02049fe:	2785                	addiw	a5,a5,1
ffffffffc0204a00:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a02:	00a88463          	beq	a7,a0,ffffffffc0204a0a <schedule+0x60>
            proc_run(next);
ffffffffc0204a06:	8e5ff0ef          	jal	ra,ffffffffc02042ea <proc_run>
    if (flag) {
ffffffffc0204a0a:	e819                	bnez	s0,ffffffffc0204a20 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204a18:	fef712e3          	bne	a4,a5,ffffffffc02049fc <schedule+0x52>
ffffffffc0204a1c:	852e                	mv	a0,a1
ffffffffc0204a1e:	bff9                	j	ffffffffc02049fc <schedule+0x52>
}
ffffffffc0204a20:	6402                	ld	s0,0(sp)
ffffffffc0204a22:	60a2                	ld	ra,8(sp)
ffffffffc0204a24:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a26:	b97fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a2a:	00011617          	auipc	a2,0x11
ffffffffc0204a2e:	afe60613          	addi	a2,a2,-1282 # ffffffffc0215528 <proc_list>
ffffffffc0204a32:	86b2                	mv	a3,a2
ffffffffc0204a34:	b76d                	j	ffffffffc02049de <schedule+0x34>
        intr_disable();
ffffffffc0204a36:	b8dfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a3a:	4405                	li	s0,1
ffffffffc0204a3c:	bfbd                	j	ffffffffc02049ba <schedule+0x10>

ffffffffc0204a3e <hash32>:
 *
...
ffffffffc0204a3e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a42:	2785                	addiw	a5,a5,1
ffffffffc0204a44:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a48:	02000793          	li	a5,32
ffffffffc0204a4c:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a4e:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a52:	8082                	ret

ffffffffc0204a54 <printnum>:
 * */
static void
...
ffffffffc0204a54:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a58:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a5a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a5e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a60:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a64:	f022                	sd	s0,32(sp)
ffffffffc0204a66:	ec26                	sd	s1,24(sp)
ffffffffc0204a68:	e84a                	sd	s2,16(sp)
ffffffffc0204a6a:	f406                	sd	ra,40(sp)
ffffffffc0204a6c:	e44e                	sd	s3,8(sp)
ffffffffc0204a6e:	84aa                	mv	s1,a0
ffffffffc0204a70:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a72:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a76:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a78:	03067e63          	bgeu	a2,a6,ffffffffc0204ab4 <printnum+0x60>
ffffffffc0204a7c:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a7e:	00805763          	blez	s0,ffffffffc0204a8c <printnum+0x38>
ffffffffc0204a82:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a84:	85ca                	mv	a1,s2
ffffffffc0204a86:	854e                	mv	a0,s3
ffffffffc0204a88:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a8a:	fc65                	bnez	s0,ffffffffc0204a82 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a8c:	1a02                	slli	s4,s4,0x20
ffffffffc0204a8e:	00002797          	auipc	a5,0x2
ffffffffc0204a92:	30278793          	addi	a5,a5,770 # ffffffffc0206d90 <default_pmm_manager+0x1130>
ffffffffc0204a96:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a9a:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a9c:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a9e:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204aa2:	70a2                	ld	ra,40(sp)
ffffffffc0204aa4:	69a2                	ld	s3,8(sp)
ffffffffc0204aa6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aa8:	85ca                	mv	a1,s2
ffffffffc0204aaa:	87a6                	mv	a5,s1
}
ffffffffc0204aac:	6942                	ld	s2,16(sp)
ffffffffc0204aae:	64e2                	ld	s1,24(sp)
ffffffffc0204ab0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ab2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ab4:	03065633          	divu	a2,a2,a6
ffffffffc0204ab8:	8722                	mv	a4,s0
ffffffffc0204aba:	f9bff0ef          	jal	ra,ffffffffc0204a54 <printnum>
ffffffffc0204abe:	b7f9                	j	ffffffffc0204a8c <printnum+0x38>

ffffffffc0204ac0 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204ac0:	7119                	addi	sp,sp,-128
ffffffffc0204ac2:	f4a6                	sd	s1,104(sp)
ffffffffc0204ac4:	f0ca                	sd	s2,96(sp)
ffffffffc0204ac6:	ecce                	sd	s3,88(sp)
ffffffffc0204ac8:	e8d2                	sd	s4,80(sp)
ffffffffc0204aca:	e4d6                	sd	s5,72(sp)
ffffffffc0204acc:	e0da                	sd	s6,64(sp)
ffffffffc0204ace:	fc5e                	sd	s7,56(sp)
ffffffffc0204ad0:	f06a                	sd	s10,32(sp)
ffffffffc0204ad2:	fc86                	sd	ra,120(sp)
ffffffffc0204ad4:	f8a2                	sd	s0,112(sp)
ffffffffc0204ad6:	f862                	sd	s8,48(sp)
ffffffffc0204ad8:	f466                	sd	s9,40(sp)
ffffffffc0204ada:	ec6e                	sd	s11,24(sp)
ffffffffc0204adc:	892a                	mv	s2,a0
ffffffffc0204ade:	84ae                	mv	s1,a1
ffffffffc0204ae0:	8d32                	mv	s10,a2
ffffffffc0204ae2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ae4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204ae8:	5b7d                	li	s6,-1
ffffffffc0204aea:	00002a97          	auipc	s5,0x2
ffffffffc0204aee:	2d2a8a93          	addi	s5,s5,722 # ffffffffc0206dbc <default_pmm_manager+0x115c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204af2:	00002b97          	auipc	s7,0x2
ffffffffc0204af6:	4a6b8b93          	addi	s7,s7,1190 # ffffffffc0206f98 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204afa:	000d4503          	lbu	a0,0(s10)
ffffffffc0204afe:	001d0413          	addi	s0,s10,1
ffffffffc0204b02:	01350a63          	beq	a0,s3,ffffffffc0204b16 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b06:	c121                	beqz	a0,ffffffffc0204b46 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204b08:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b0a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b0c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b0e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b12:	ff351ae3          	bne	a0,s3,ffffffffc0204b06 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b16:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b1a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b1e:	4c81                	li	s9,0
ffffffffc0204b20:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b22:	5c7d                	li	s8,-1
ffffffffc0204b24:	5dfd                	li	s11,-1
ffffffffc0204b26:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b2a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b2c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b30:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b34:	00140d13          	addi	s10,s0,1
ffffffffc0204b38:	04b56263          	bltu	a0,a1,ffffffffc0204b7c <vprintfmt+0xbc>
ffffffffc0204b3c:	058a                	slli	a1,a1,0x2
ffffffffc0204b3e:	95d6                	add	a1,a1,s5
ffffffffc0204b40:	4194                	lw	a3,0(a1)
ffffffffc0204b42:	96d6                	add	a3,a3,s5
ffffffffc0204b44:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b46:	70e6                	ld	ra,120(sp)
ffffffffc0204b48:	7446                	ld	s0,112(sp)
ffffffffc0204b4a:	74a6                	ld	s1,104(sp)
ffffffffc0204b4c:	7906                	ld	s2,96(sp)
ffffffffc0204b4e:	69e6                	ld	s3,88(sp)
ffffffffc0204b50:	6a46                	ld	s4,80(sp)
ffffffffc0204b52:	6aa6                	ld	s5,72(sp)
ffffffffc0204b54:	6b06                	ld	s6,64(sp)
ffffffffc0204b56:	7be2                	ld	s7,56(sp)
ffffffffc0204b58:	7c42                	ld	s8,48(sp)
ffffffffc0204b5a:	7ca2                	ld	s9,40(sp)
ffffffffc0204b5c:	7d02                	ld	s10,32(sp)
ffffffffc0204b5e:	6de2                	ld	s11,24(sp)
ffffffffc0204b60:	6109                	addi	sp,sp,128
ffffffffc0204b62:	8082                	ret
            padc = '0';
ffffffffc0204b64:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b66:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b6a:	846a                	mv	s0,s10
ffffffffc0204b6c:	00140d13          	addi	s10,s0,1
ffffffffc0204b70:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b74:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b78:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b3c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b7c:	85a6                	mv	a1,s1
ffffffffc0204b7e:	02500513          	li	a0,37
ffffffffc0204b82:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b84:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b88:	8d22                	mv	s10,s0
ffffffffc0204b8a:	f73788e3          	beq	a5,s3,ffffffffc0204afa <vprintfmt+0x3a>
ffffffffc0204b8e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b92:	1d7d                	addi	s10,s10,-1
ffffffffc0204b94:	ff379de3          	bne	a5,s3,ffffffffc0204b8e <vprintfmt+0xce>
ffffffffc0204b98:	b78d                	j	ffffffffc0204afa <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b9a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b9e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba2:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204ba4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204ba8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bac:	02d86463          	bltu	a6,a3,ffffffffc0204bd4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bb0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bb4:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bb8:	0186873b          	addw	a4,a3,s8
ffffffffc0204bbc:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bc0:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bc2:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bc6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bc8:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bcc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bd0:	fed870e3          	bgeu	a6,a3,ffffffffc0204bb0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204bd4:	f40ddce3          	bgez	s11,ffffffffc0204b2c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bd8:	8de2                	mv	s11,s8
ffffffffc0204bda:	5c7d                	li	s8,-1
ffffffffc0204bdc:	bf81                	j	ffffffffc0204b2c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bde:	fffdc693          	not	a3,s11
ffffffffc0204be2:	96fd                	srai	a3,a3,0x3f
ffffffffc0204be4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be8:	00144603          	lbu	a2,1(s0)
ffffffffc0204bec:	2d81                	sext.w	s11,s11
ffffffffc0204bee:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bf0:	bf35                	j	ffffffffc0204b2c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bf2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204bfe:	bfd9                	j	ffffffffc0204bd4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c00:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c02:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c06:	01174463          	blt	a4,a7,ffffffffc0204c0e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c0a:	1a088e63          	beqz	a7,ffffffffc0204dc6 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c0e:	000a3603          	ld	a2,0(s4)
ffffffffc0204c12:	46c1                	li	a3,16
ffffffffc0204c14:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c16:	2781                	sext.w	a5,a5
ffffffffc0204c18:	876e                	mv	a4,s11
ffffffffc0204c1a:	85a6                	mv	a1,s1
ffffffffc0204c1c:	854a                	mv	a0,s2
ffffffffc0204c1e:	e37ff0ef          	jal	ra,ffffffffc0204a54 <printnum>
            break;
ffffffffc0204c22:	bde1                	j	ffffffffc0204afa <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c24:	000a2503          	lw	a0,0(s4)
ffffffffc0204c28:	85a6                	mv	a1,s1
ffffffffc0204c2a:	0a21                	addi	s4,s4,8
ffffffffc0204c2c:	9902                	jalr	s2
            break;
ffffffffc0204c2e:	b5f1                	j	ffffffffc0204afa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c30:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c32:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c36:	01174463          	blt	a4,a7,ffffffffc0204c3e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c3a:	18088163          	beqz	a7,ffffffffc0204dbc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c3e:	000a3603          	ld	a2,0(s4)
ffffffffc0204c42:	46a9                	li	a3,10
ffffffffc0204c44:	8a2e                	mv	s4,a1
ffffffffc0204c46:	bfc1                	j	ffffffffc0204c16 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c48:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c4c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c4e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c50:	bdf1                	j	ffffffffc0204b2c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c52:	85a6                	mv	a1,s1
ffffffffc0204c54:	02500513          	li	a0,37
ffffffffc0204c58:	9902                	jalr	s2
            break;
ffffffffc0204c5a:	b545                	j	ffffffffc0204afa <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c5c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c60:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c62:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c64:	b5e1                	j	ffffffffc0204b2c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c66:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c68:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c6c:	01174463          	blt	a4,a7,ffffffffc0204c74 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c70:	14088163          	beqz	a7,ffffffffc0204db2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c74:	000a3603          	ld	a2,0(s4)
ffffffffc0204c78:	46a1                	li	a3,8
ffffffffc0204c7a:	8a2e                	mv	s4,a1
ffffffffc0204c7c:	bf69                	j	ffffffffc0204c16 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c7e:	03000513          	li	a0,48
ffffffffc0204c82:	85a6                	mv	a1,s1
ffffffffc0204c84:	e03e                	sd	a5,0(sp)
ffffffffc0204c86:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c88:	85a6                	mv	a1,s1
ffffffffc0204c8a:	07800513          	li	a0,120
ffffffffc0204c8e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c90:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c92:	6782                	ld	a5,0(sp)
ffffffffc0204c94:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c96:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c9a:	bfb5                	j	ffffffffc0204c16 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c9c:	000a3403          	ld	s0,0(s4)
ffffffffc0204ca0:	008a0713          	addi	a4,s4,8
ffffffffc0204ca4:	e03a                	sd	a4,0(sp)
ffffffffc0204ca6:	14040263          	beqz	s0,ffffffffc0204dea <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204caa:	0fb05763          	blez	s11,ffffffffc0204d98 <vprintfmt+0x2d8>
ffffffffc0204cae:	02d00693          	li	a3,45
ffffffffc0204cb2:	0cd79163          	bne	a5,a3,ffffffffc0204d74 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb6:	00044783          	lbu	a5,0(s0)
ffffffffc0204cba:	0007851b          	sext.w	a0,a5
ffffffffc0204cbe:	cf85                	beqz	a5,ffffffffc0204cf6 <vprintfmt+0x236>
ffffffffc0204cc0:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cc4:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cc8:	000c4563          	bltz	s8,ffffffffc0204cd2 <vprintfmt+0x212>
ffffffffc0204ccc:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cce:	036c0263          	beq	s8,s6,ffffffffc0204cf2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204cd2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cd4:	0e0c8e63          	beqz	s9,ffffffffc0204dd0 <vprintfmt+0x310>
ffffffffc0204cd8:	3781                	addiw	a5,a5,-32
ffffffffc0204cda:	0ef47b63          	bgeu	s0,a5,ffffffffc0204dd0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cde:	03f00513          	li	a0,63
ffffffffc0204ce2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce4:	000a4783          	lbu	a5,0(s4)
ffffffffc0204ce8:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cea:	0a05                	addi	s4,s4,1
ffffffffc0204cec:	0007851b          	sext.w	a0,a5
ffffffffc0204cf0:	ffe1                	bnez	a5,ffffffffc0204cc8 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cf2:	01b05963          	blez	s11,ffffffffc0204d04 <vprintfmt+0x244>
ffffffffc0204cf6:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204cf8:	85a6                	mv	a1,s1
ffffffffc0204cfa:	02000513          	li	a0,32
ffffffffc0204cfe:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d00:	fe0d9be3          	bnez	s11,ffffffffc0204cf6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d04:	6a02                	ld	s4,0(sp)
ffffffffc0204d06:	bbd5                	j	ffffffffc0204afa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d08:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d0a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d0e:	01174463          	blt	a4,a7,ffffffffc0204d16 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d12:	08088d63          	beqz	a7,ffffffffc0204dac <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d16:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d1a:	0a044d63          	bltz	s0,ffffffffc0204dd4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d1e:	8622                	mv	a2,s0
ffffffffc0204d20:	8a66                	mv	s4,s9
ffffffffc0204d22:	46a9                	li	a3,10
ffffffffc0204d24:	bdcd                	j	ffffffffc0204c16 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d26:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d2a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d2c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d2e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d32:	8fb5                	xor	a5,a5,a3
ffffffffc0204d34:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d38:	02d74163          	blt	a4,a3,ffffffffc0204d5a <vprintfmt+0x29a>
ffffffffc0204d3c:	00369793          	slli	a5,a3,0x3
ffffffffc0204d40:	97de                	add	a5,a5,s7
ffffffffc0204d42:	639c                	ld	a5,0(a5)
ffffffffc0204d44:	cb99                	beqz	a5,ffffffffc0204d5a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d46:	86be                	mv	a3,a5
ffffffffc0204d48:	00000617          	auipc	a2,0x0
ffffffffc0204d4c:	1f060613          	addi	a2,a2,496 # ffffffffc0204f38 <etext+0x2c>
ffffffffc0204d50:	85a6                	mv	a1,s1
ffffffffc0204d52:	854a                	mv	a0,s2
ffffffffc0204d54:	0ce000ef          	jal	ra,ffffffffc0204e22 <printfmt>
ffffffffc0204d58:	b34d                	j	ffffffffc0204afa <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d5a:	00002617          	auipc	a2,0x2
ffffffffc0204d5e:	05660613          	addi	a2,a2,86 # ffffffffc0206db0 <default_pmm_manager+0x1150>
ffffffffc0204d62:	85a6                	mv	a1,s1
ffffffffc0204d64:	854a                	mv	a0,s2
ffffffffc0204d66:	0bc000ef          	jal	ra,ffffffffc0204e22 <printfmt>
ffffffffc0204d6a:	bb41                	j	ffffffffc0204afa <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d6c:	00002417          	auipc	s0,0x2
ffffffffc0204d70:	03c40413          	addi	s0,s0,60 # ffffffffc0206da8 <default_pmm_manager+0x1148>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d74:	85e2                	mv	a1,s8
ffffffffc0204d76:	8522                	mv	a0,s0
ffffffffc0204d78:	e43e                	sd	a5,8(sp)
ffffffffc0204d7a:	0e2000ef          	jal	ra,ffffffffc0204e5c <strnlen>
ffffffffc0204d7e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d82:	01b05b63          	blez	s11,ffffffffc0204d98 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d86:	67a2                	ld	a5,8(sp)
ffffffffc0204d88:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d8c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d8e:	85a6                	mv	a1,s1
ffffffffc0204d90:	8552                	mv	a0,s4
ffffffffc0204d92:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d94:	fe0d9ce3          	bnez	s11,ffffffffc0204d8c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d98:	00044783          	lbu	a5,0(s0)
ffffffffc0204d9c:	00140a13          	addi	s4,s0,1
ffffffffc0204da0:	0007851b          	sext.w	a0,a5
ffffffffc0204da4:	d3a5                	beqz	a5,ffffffffc0204d04 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204da6:	05e00413          	li	s0,94
ffffffffc0204daa:	bf39                	j	ffffffffc0204cc8 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dac:	000a2403          	lw	s0,0(s4)
ffffffffc0204db0:	b7ad                	j	ffffffffc0204d1a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204db2:	000a6603          	lwu	a2,0(s4)
ffffffffc0204db6:	46a1                	li	a3,8
ffffffffc0204db8:	8a2e                	mv	s4,a1
ffffffffc0204dba:	bdb1                	j	ffffffffc0204c16 <vprintfmt+0x156>
ffffffffc0204dbc:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dc0:	46a9                	li	a3,10
ffffffffc0204dc2:	8a2e                	mv	s4,a1
ffffffffc0204dc4:	bd89                	j	ffffffffc0204c16 <vprintfmt+0x156>
ffffffffc0204dc6:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dca:	46c1                	li	a3,16
ffffffffc0204dcc:	8a2e                	mv	s4,a1
ffffffffc0204dce:	b5a1                	j	ffffffffc0204c16 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204dd0:	9902                	jalr	s2
ffffffffc0204dd2:	bf09                	j	ffffffffc0204ce4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204dd4:	85a6                	mv	a1,s1
ffffffffc0204dd6:	02d00513          	li	a0,45
ffffffffc0204dda:	e03e                	sd	a5,0(sp)
ffffffffc0204ddc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204dde:	6782                	ld	a5,0(sp)
ffffffffc0204de0:	8a66                	mv	s4,s9
ffffffffc0204de2:	40800633          	neg	a2,s0
ffffffffc0204de6:	46a9                	li	a3,10
ffffffffc0204de8:	b53d                	j	ffffffffc0204c16 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dea:	03b05163          	blez	s11,ffffffffc0204e0c <vprintfmt+0x34c>
ffffffffc0204dee:	02d00693          	li	a3,45
ffffffffc0204df2:	f6d79de3          	bne	a5,a3,ffffffffc0204d6c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204df6:	00002417          	auipc	s0,0x2
ffffffffc0204dfa:	fb240413          	addi	s0,s0,-78 # ffffffffc0206da8 <default_pmm_manager+0x1148>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dfe:	02800793          	li	a5,40
ffffffffc0204e02:	02800513          	li	a0,40
ffffffffc0204e06:	00140a13          	addi	s4,s0,1
ffffffffc0204e0a:	bd6d                	j	ffffffffc0204cc4 <vprintfmt+0x204>
ffffffffc0204e0c:	00002a17          	auipc	s4,0x2
ffffffffc0204e10:	f9da0a13          	addi	s4,s4,-99 # ffffffffc0206da9 <default_pmm_manager+0x1149>
ffffffffc0204e14:	02800513          	li	a0,40
ffffffffc0204e18:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e1c:	05e00413          	li	s0,94
ffffffffc0204e20:	b565                	j	ffffffffc0204cc8 <vprintfmt+0x208>
...
ffffffffc0204e36:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e38:	c89ff0ef          	jal	ra,ffffffffc0204ac0 <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0204e46:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e48:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e4a:	cb81                	beqz	a5,ffffffffc0204e5a <strlen+0x18>
        cnt ++;
ffffffffc0204e4c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e4e:	00a707b3          	add	a5,a4,a0
ffffffffc0204e52:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e56:	fbfd                	bnez	a5,ffffffffc0204e4c <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e5c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e5e:	e589                	bnez	a1,ffffffffc0204e68 <strnlen+0xc>
ffffffffc0204e60:	a811                	j	ffffffffc0204e74 <strnlen+0x18>
        cnt ++;
ffffffffc0204e62:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e64:	00f58863          	beq	a1,a5,ffffffffc0204e74 <strnlen+0x18>
ffffffffc0204e68:	00f50733          	add	a4,a0,a5
ffffffffc0204e6c:	00074703          	lbu	a4,0(a4)
ffffffffc0204e70:	fb6d                	bnez	a4,ffffffffc0204e62 <strnlen+0x6>
ffffffffc0204e72:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e74:	852e                	mv	a0,a1
ffffffffc0204e76:	8082                	ret

ffffffffc0204e78 <strcpy>:
char *
...
ffffffffc0204e8e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e92:	cb89                	beqz	a5,ffffffffc0204ea4 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e94:	0505                	addi	a0,a0,1
ffffffffc0204e96:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e98:	fee789e3          	beq	a5,a4,ffffffffc0204e8a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e9c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ea0:	9d19                	subw	a0,a0,a4
ffffffffc0204ea2:	8082                	ret
ffffffffc0204ea4:	4501                	li	a0,0
ffffffffc0204ea6:	bfed                	j	ffffffffc0204ea0 <strcmp+0x16>

ffffffffc0204ea8 <strchr>:
...
ffffffffc0204eac:	c799                	beqz	a5,ffffffffc0204eba <strchr+0x12>
        if (*s == c) {
ffffffffc0204eae:	00f58763          	beq	a1,a5,ffffffffc0204ebc <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204eb2:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204eb6:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204eb8:	fbfd                	bnez	a5,ffffffffc0204eae <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204ebe:	ca01                	beqz	a2,ffffffffc0204ece <memset+0x10>
ffffffffc0204ec0:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ec2:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ec4:	0785                	addi	a5,a5,1
ffffffffc0204ec6:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204eca:	fec79de3          	bne	a5,a2,ffffffffc0204ec4 <memset+0x6>
    }
    return s;
...
ffffffffc0204ed0 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204ed0:	ca19                	beqz	a2,ffffffffc0204ee6 <memcpy+0x16>
ffffffffc0204ed2:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204ed4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204ed6:	0005c703          	lbu	a4,0(a1)
ffffffffc0204eda:	0585                	addi	a1,a1,1
ffffffffc0204edc:	0785                	addi	a5,a5,1
ffffffffc0204ede:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204ee2:	fec59ae3          	bne	a1,a2,ffffffffc0204ed6 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ee8:	c205                	beqz	a2,ffffffffc0204f08 <memcmp+0x20>
ffffffffc0204eea:	962e                	add	a2,a2,a1
ffffffffc0204eec:	a019                	j	ffffffffc0204ef2 <memcmp+0xa>
ffffffffc0204eee:	00c58d63          	beq	a1,a2,ffffffffc0204f08 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204ef2:	00054783          	lbu	a5,0(a0)
ffffffffc0204ef6:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204efa:	0505                	addi	a0,a0,1
ffffffffc0204efc:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204efe:	fee788e3          	beq	a5,a4,ffffffffc0204eee <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f02:	40e7853b          	subw	a0,a5,a4
