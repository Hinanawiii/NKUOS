...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	3c6040ef          	jal	ra,ffffffffc0204410 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	3f258593          	addi	a1,a1,1010 # ffffffffc0204440 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	40a50513          	addi	a0,a0,1034 # ffffffffc0204460 <etext+0x26>
...
ffffffffc020006e:	672030ef          	jal	ra,ffffffffc02036e0 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	6b1030ef          	jal	ra,ffffffffc0203f5e <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	67b030ef          	jal	ra,ffffffffc0203f5e <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	36450513          	addi	a0,a0,868 # ffffffffc0204468 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	36e50513          	addi	a0,a0,878 # ffffffffc0204488 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	31458593          	addi	a1,a1,788 # ffffffffc020443a <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	37a50513          	addi	a0,a0,890 # ffffffffc02044a8 <etext+0x6e>
...
ffffffffc0200146:	38650513          	addi	a0,a0,902 # ffffffffc02044c8 <etext+0x8e>
...
ffffffffc020015a:	39250513          	addi	a0,a0,914 # ffffffffc02044e8 <etext+0xae>
...
ffffffffc0200188:	38450513          	addi	a0,a0,900 # ffffffffc0204508 <etext+0xce>
}
...
ffffffffc0200196:	3a660613          	addi	a2,a2,934 # ffffffffc0204538 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	3b250513          	addi	a0,a0,946 # ffffffffc0204550 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	3ba60613          	addi	a2,a2,954 # ffffffffc0204568 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	3d258593          	addi	a1,a1,978 # ffffffffc0204588 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	3d250513          	addi	a0,a0,978 # ffffffffc0204590 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	3d460613          	addi	a2,a2,980 # ffffffffc02045a0 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	3f458593          	addi	a1,a1,1012 # ffffffffc02045c8 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	3b450513          	addi	a0,a0,948 # ffffffffc0204590 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	3f060613          	addi	a2,a2,1008 # ffffffffc02045d8 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	40858593          	addi	a1,a1,1032 # ffffffffc02045f8 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	39850513          	addi	a0,a0,920 # ffffffffc0204590 <etext+0x156>
...
ffffffffc0200236:	3d650513          	addi	a0,a0,982 # ffffffffc0204608 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	3dc50513          	addi	a0,a0,988 # ffffffffc0204630 <etext+0x1f6>
...
ffffffffc020026e:	42ec0c13          	addi	s8,s8,1070 # ffffffffc0204698 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00006917          	auipc	s2,0x6
ffffffffc0200276:	83690913          	addi	s2,s2,-1994 # ffffffffc0205aa8 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	3de48493          	addi	s1,s1,990 # ffffffffc0204658 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	3dcb0b13          	addi	s6,s6,988 # ffffffffc0204660 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2fca0a13          	addi	s4,s4,764 # ffffffffc0204588 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	048040ef          	jal	ra,ffffffffc02042e0 <readline>
...
ffffffffc02002b2:	3ead0d13          	addi	s10,s10,1002 # ffffffffc0204698 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	120040ef          	jal	ra,ffffffffc02043dc <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	10c040ef          	jal	ra,ffffffffc02043dc <strcmp>
...
ffffffffc020030e:	0ec040ef          	jal	ra,ffffffffc02043fa <strchr>
...
ffffffffc020034c:	0ae040ef          	jal	ra,ffffffffc02043fa <strchr>
...
ffffffffc020036a:	31a50513          	addi	a0,a0,794 # ffffffffc0204680 <etext+0x246>
...
ffffffffc02003a6:	33e50513          	addi	a0,a0,830 # ffffffffc02046e0 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	24050513          	addi	a0,a0,576 # ffffffffc02055f8 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	30a50513          	addi	a0,a0,778 # ffffffffc0204700 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	76b030ef          	jal	ra,ffffffffc0204422 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	747030ef          	jal	ra,ffffffffc0204422 <memcpy>
    return 0;
}
...
ffffffffc0200528:	1fc50513          	addi	a0,a0,508 # ffffffffc0204720 <commands+0x88>
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7700306f          	j	ffffffffc0203cb8 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020054c:	00004617          	auipc	a2,0x4
ffffffffc0200550:	1f460613          	addi	a2,a2,500 # ffffffffc0204740 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	20050513          	addi	a0,a0,512 # ffffffffc0204758 <commands+0xc0>
...
ffffffffc020058e:	1e650513          	addi	a0,a0,486 # ffffffffc0204770 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	31650513          	addi	a0,a0,790 # ffffffffc0204a58 <commands+0x3c0>
}
...
ffffffffc020075a:	31a50513          	addi	a0,a0,794 # ffffffffc0204a70 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	31a50513          	addi	a0,a0,794 # ffffffffc0204a88 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	32250513          	addi	a0,a0,802 # ffffffffc0204aa0 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	32a50513          	addi	a0,a0,810 # ffffffffc0204ab8 <commands+0x420>
...
ffffffffc02007a6:	32e50513          	addi	a0,a0,814 # ffffffffc0204ad0 <commands+0x438>
}
...
ffffffffc02007c2:	3da70713          	addi	a4,a4,986 # ffffffffc0204b98 <commands+0x500>
...
ffffffffc02007d4:	37850513          	addi	a0,a0,888 # ffffffffc0204b48 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	34c50513          	addi	a0,a0,844 # ffffffffc0204b28 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	30050513          	addi	a0,a0,768 # ffffffffc0204ae8 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	31450513          	addi	a0,a0,788 # ffffffffc0204b08 <commands+0x470>
...
ffffffffc020082a:	35250513          	addi	a0,a0,850 # ffffffffc0204b78 <commands+0x4e0>
...
ffffffffc020083e:	32e50513          	addi	a0,a0,814 # ffffffffc0204b68 <commands+0x4d0>
}
...
ffffffffc0200860:	52470713          	addi	a4,a4,1316 # ffffffffc0204d80 <commands+0x6e8>
...
ffffffffc0200872:	4fa50513          	addi	a0,a0,1274 # ffffffffc0204d68 <commands+0x6d0>
...
ffffffffc0200894:	33850513          	addi	a0,a0,824 # ffffffffc0204bc8 <commands+0x530>
}
...
ffffffffc02008a8:	34450513          	addi	a0,a0,836 # ffffffffc0204be8 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	35a50513          	addi	a0,a0,858 # ffffffffc0204c08 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	36850513          	addi	a0,a0,872 # ffffffffc0204c20 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	36e50513          	addi	a0,a0,878 # ffffffffc0204c30 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	38450513          	addi	a0,a0,900 # ffffffffc0204c50 <commands+0x5b8>
...
ffffffffc02008ee:	37e60613          	addi	a2,a2,894 # ffffffffc0204c68 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	e6250513          	addi	a0,a0,-414 # ffffffffc0204758 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	38650513          	addi	a0,a0,902 # ffffffffc0204c88 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	39450513          	addi	a0,a0,916 # ffffffffc0204ca0 <commands+0x608>
...
ffffffffc0200998:	2d460613          	addi	a2,a2,724 # ffffffffc0204c68 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	db850513          	addi	a0,a0,-584 # ffffffffc0204758 <commands+0xc0>
...
ffffffffc02009c4:	2a860613          	addi	a2,a2,680 # ffffffffc0204c68 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d8c50513          	addi	a0,a0,-628 # ffffffffc0204758 <commands+0xc0>
...
ffffffffc0200b6e:	6f65b583          	ld	a1,1782(a1) # ffffffffc0206260 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	6f263603          	ld	a2,1778(a2) # ffffffffc0206268 <nbase>
...
ffffffffc0200dc6:	ffe68693          	addi	a3,a3,-2 # ffffffffc0204dc0 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	00660613          	addi	a2,a2,6 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	01250513          	addi	a0,a0,18 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	09e68693          	addi	a3,a3,158 # ffffffffc0204e80 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	fe660613          	addi	a2,a2,-26 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	ff250513          	addi	a0,a0,-14 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	0a668693          	addi	a3,a3,166 # ffffffffc0204ea8 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	fc660613          	addi	a2,a2,-58 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	fd250513          	addi	a0,a0,-46 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	0c668693          	addi	a3,a3,198 # ffffffffc0204ee8 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	fa660613          	addi	a2,a2,-90 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	fb250513          	addi	a0,a0,-78 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	12e68693          	addi	a3,a3,302 # ffffffffc0204f70 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f8660613          	addi	a2,a2,-122 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f9250513          	addi	a0,a0,-110 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	fbe68693          	addi	a3,a3,-66 # ffffffffc0204e20 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	f6660613          	addi	a2,a2,-154 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	f7250513          	addi	a0,a0,-142 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	0de68693          	addi	a3,a3,222 # ffffffffc0204f60 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	f4660613          	addi	a2,a2,-186 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	f5250513          	addi	a0,a0,-174 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	0a668693          	addi	a3,a3,166 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	f2660613          	addi	a2,a2,-218 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	f3250513          	addi	a0,a0,-206 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	06668693          	addi	a3,a3,102 # ffffffffc0204f28 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	f0660613          	addi	a2,a2,-250 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	f1250513          	addi	a0,a0,-238 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	0d668693          	addi	a3,a3,214 # ffffffffc0204fb8 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	ee660613          	addi	a2,a2,-282 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	ef250513          	addi	a0,a0,-270 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	0a668693          	addi	a3,a3,166 # ffffffffc0204fa8 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	ec660613          	addi	a2,a2,-314 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	ed250513          	addi	a0,a0,-302 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	02668693          	addi	a3,a3,38 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	ea660613          	addi	a2,a2,-346 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	eb250513          	addi	a0,a0,-334 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	04668693          	addi	a3,a3,70 # ffffffffc0204f88 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e8660613          	addi	a2,a2,-378 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e9250513          	addi	a0,a0,-366 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	ebe68693          	addi	a3,a3,-322 # ffffffffc0204e20 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	e6660613          	addi	a2,a2,-410 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	e7250513          	addi	a0,a0,-398 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	fc668693          	addi	a3,a3,-58 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	e4660613          	addi	a2,a2,-442 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	e5250513          	addi	a0,a0,-430 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	ebe68693          	addi	a3,a3,-322 # ffffffffc0204e60 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	e2660613          	addi	a2,a2,-474 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	e3250513          	addi	a0,a0,-462 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	e7e68693          	addi	a3,a3,-386 # ffffffffc0204e40 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	e0660613          	addi	a2,a2,-506 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	e1250513          	addi	a0,a0,-494 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	e7e68693          	addi	a3,a3,-386 # ffffffffc0204e60 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	de660613          	addi	a2,a2,-538 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	df250513          	addi	a0,a0,-526 # ffffffffc0204de8 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	10668693          	addi	a3,a3,262 # ffffffffc0205108 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	dc660613          	addi	a2,a2,-570 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	dd250513          	addi	a0,a0,-558 # ffffffffc0204de8 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f8668693          	addi	a3,a3,-122 # ffffffffc0204fa8 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	da660613          	addi	a2,a2,-602 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	db250513          	addi	a0,a0,-590 # ffffffffc0204de8 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	f0668693          	addi	a3,a3,-250 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d8660613          	addi	a2,a2,-634 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d9250513          	addi	a0,a0,-622 # ffffffffc0204de8 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	ea668693          	addi	a3,a3,-346 # ffffffffc0204f08 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	d6660613          	addi	a2,a2,-666 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	d7250513          	addi	a0,a0,-654 # ffffffffc0204de8 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	04668693          	addi	a3,a3,70 # ffffffffc02050c8 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	d4660613          	addi	a2,a2,-698 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	d5250513          	addi	a0,a0,-686 # ffffffffc0204de8 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	00668693          	addi	a3,a3,6 # ffffffffc02050a8 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	d2660613          	addi	a2,a2,-730 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	d3250513          	addi	a0,a0,-718 # ffffffffc0204de8 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	fbe68693          	addi	a3,a3,-66 # ffffffffc0205080 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	d0660613          	addi	a2,a2,-762 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	d1250513          	addi	a0,a0,-750 # ffffffffc0204de8 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	f7668693          	addi	a3,a3,-138 # ffffffffc0205058 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	ce660613          	addi	a2,a2,-794 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	cf250513          	addi	a0,a0,-782 # ffffffffc0204de8 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	f4668693          	addi	a3,a3,-186 # ffffffffc0205048 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	cc660613          	addi	a2,a2,-826 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	cd250513          	addi	a0,a0,-814 # ffffffffc0204de8 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	e2668693          	addi	a3,a3,-474 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	ca660613          	addi	a2,a2,-858 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	cb250513          	addi	a0,a0,-846 # ffffffffc0204de8 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	ee668693          	addi	a3,a3,-282 # ffffffffc0205028 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c8660613          	addi	a2,a2,-890 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c9250513          	addi	a0,a0,-878 # ffffffffc0204de8 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e9668693          	addi	a3,a3,-362 # ffffffffc0204ff8 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	c6660613          	addi	a2,a2,-922 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	c7250513          	addi	a0,a0,-910 # ffffffffc0204de8 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	e5e68693          	addi	a3,a3,-418 # ffffffffc0204fe0 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	c4660613          	addi	a2,a2,-954 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	c5250513          	addi	a0,a0,-942 # ffffffffc0204de8 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	da668693          	addi	a3,a3,-602 # ffffffffc0204f48 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	c2660613          	addi	a2,a2,-986 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	c3250513          	addi	a0,a0,-974 # ffffffffc0204de8 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	e0668693          	addi	a3,a3,-506 # ffffffffc0204fc8 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	c1250513          	addi	a0,a0,-1006 # ffffffffc0204de8 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	f0668693          	addi	a3,a3,-250 # ffffffffc02050e8 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	be660613          	addi	a2,a2,-1050 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	bf250513          	addi	a0,a0,-1038 # ffffffffc0204de8 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	f1668693          	addi	a3,a3,-234 # ffffffffc0205118 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	bc660613          	addi	a2,a2,-1082 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	bd250513          	addi	a0,a0,-1070 # ffffffffc0204de8 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	bde68693          	addi	a3,a3,-1058 # ffffffffc0204e00 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	ba660613          	addi	a2,a2,-1114 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	bb250513          	addi	a0,a0,-1102 # ffffffffc0204de8 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	bfe68693          	addi	a3,a3,-1026 # ffffffffc0204e40 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b9250513          	addi	a0,a0,-1134 # ffffffffc0204de8 <commands+0x750>
...
ffffffffc020139e:	d9668693          	addi	a3,a3,-618 # ffffffffc0205130 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	a2e60613          	addi	a2,a2,-1490 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0204de8 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	d6e68693          	addi	a3,a3,-658 # ffffffffc0205128 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	a0e60613          	addi	a2,a2,-1522 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	a1a50513          	addi	a0,a0,-1510 # ffffffffc0204de8 <commands+0x750>
...
ffffffffc0201476:	cb668693          	addi	a3,a3,-842 # ffffffffc0205128 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	95660613          	addi	a2,a2,-1706 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	96250513          	addi	a0,a0,-1694 # ffffffffc0204de8 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	c1068693          	addi	a3,a3,-1008 # ffffffffc0205158 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	88060613          	addi	a2,a2,-1920 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	88c50513          	addi	a0,a0,-1908 # ffffffffc0204de8 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	bc068693          	addi	a3,a3,-1088 # ffffffffc0205128 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	86060613          	addi	a2,a2,-1952 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	86c50513          	addi	a0,a0,-1940 # ffffffffc0204de8 <commands+0x750>
...
ffffffffc020158e:	c2e60613          	addi	a2,a2,-978 # ffffffffc02051b8 <default_pmm_manager+0x38>
ffffffffc0201592:	06800593          	li	a1,104
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	c4250513          	addi	a0,a0,-958 # ffffffffc02051d8 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	c4260613          	addi	a2,a2,-958 # ffffffffc02051e8 <default_pmm_manager+0x68>
ffffffffc02015ae:	07300593          	li	a1,115
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	c2650513          	addi	a0,a0,-986 # ffffffffc02051d8 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc02015ee:	f7eb0b13          	addi	s6,s6,-130 # ffffffffc0211568 <check_mm_struct>
...
ffffffffc0201722:	b42b3b03          	ld	s6,-1214(s6) # ffffffffc0206260 <error_string+0x38>
...
ffffffffc0201760:	4b1020ef          	jal	ra,ffffffffc0204410 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	a94b3b03          	ld	s6,-1388(s6) # ffffffffc0206260 <error_string+0x38>
...
ffffffffc0201802:	40f020ef          	jal	ra,ffffffffc0204410 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	9b260613          	addi	a2,a2,-1614 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	9ce50513          	addi	a0,a0,-1586 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	99a60613          	addi	a2,a2,-1638 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	9b650513          	addi	a0,a0,-1610 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	98060613          	addi	a2,a2,-1664 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	99c50513          	addi	a0,a0,-1636 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	96660613          	addi	a2,a2,-1690 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	98250513          	addi	a0,a0,-1662 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02019f8:	86c43403          	ld	s0,-1940(s0) # ffffffffc0206260 <error_string+0x38>
...
ffffffffc0201aba:	6ca78793          	addi	a5,a5,1738 # ffffffffc0205180 <default_pmm_manager>
...
ffffffffc0201ac8:	78450513          	addi	a0,a0,1924 # ffffffffc0205248 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	74050513          	addi	a0,a0,1856 # ffffffffc0205260 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	76050513          	addi	a0,a0,1888 # ffffffffc0205290 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	75e50513          	addi	a0,a0,1886 # ffffffffc02052a8 <default_pmm_manager+0x128>
...
ffffffffc0201b5c:	a1b78793          	addi	a5,a5,-1509 # ffffffffc0212573 <end+0xfff>
...
ffffffffc0201bda:	72250513          	addi	a0,a0,1826 # ffffffffc02052f8 <default_pmm_manager+0x178>
...
ffffffffc0201dfe:	466cbc83          	ld	s9,1126(s9) # ffffffffc0206260 <error_string+0x38>
...
ffffffffc0201e82:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fdeda8c>
...
ffffffffc0201ea2:	74250513          	addi	a0,a0,1858 # ffffffffc02055e0 <default_pmm_manager+0x460>
...
ffffffffc0201f26:	64051e63          	bnez	a0,ffffffffc0202582 <pmm_init+0xacc>
    assert(page_ref(p) == 1);
ffffffffc0201f2a:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fdeda8c>
...
ffffffffc0201f58:	7c458593          	addi	a1,a1,1988 # ffffffffc0205718 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	46a020ef          	jal	ra,ffffffffc02043ca <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	470020ef          	jal	ra,ffffffffc02043dc <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb8c>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	3ee020ef          	jal	ra,ffffffffc0204394 <strlen>
...
ffffffffc020209c:	6f850513          	addi	a0,a0,1784 # ffffffffc0205790 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	4a268693          	addi	a3,a3,1186 # ffffffffc0205640 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	c2a60613          	addi	a2,a2,-982 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02021ae:	1d200593          	li	a1,466
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	08650513          	addi	a0,a0,134 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	44268693          	addi	a3,a3,1090 # ffffffffc0205600 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	c0a60613          	addi	a2,a2,-1014 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02021ce:	1d100593          	li	a1,465
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	06650513          	addi	a0,a0,102 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	03060613          	addi	a2,a2,48 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc02021e8:	1d100593          	li	a1,465
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	04c50513          	addi	a0,a0,76 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	0d460613          	addi	a2,a2,212 # ffffffffc02052d0 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	03050513          	addi	a0,a0,48 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	0bc60613          	addi	a2,a2,188 # ffffffffc02052d0 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	01850513          	addi	a0,a0,24 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	10c68693          	addi	a3,a3,268 # ffffffffc0205338 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b9c60613          	addi	a2,a2,-1124 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020223c:	19700593          	li	a1,407
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	ff850513          	addi	a0,a0,-8 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	0cc68693          	addi	a3,a3,204 # ffffffffc0205318 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	b7c60613          	addi	a2,a2,-1156 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020225c:	19600593          	li	a1,406
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	fd850513          	addi	a0,a0,-40 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	15868693          	addi	a3,a3,344 # ffffffffc02053c8 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	b5860613          	addi	a2,a2,-1192 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202280:	19e00593          	li	a1,414
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	fb450513          	addi	a0,a0,-76 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	10868693          	addi	a3,a3,264 # ffffffffc0205398 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	b3860613          	addi	a2,a2,-1224 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02022a0:	19c00593          	li	a1,412
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f9450513          	addi	a0,a0,-108 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	0c068693          	addi	a3,a3,192 # ffffffffc0205370 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	b1860613          	addi	a2,a2,-1256 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02022c0:	19800593          	li	a1,408
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	f7450513          	addi	a0,a0,-140 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	18068693          	addi	a3,a3,384 # ffffffffc0205450 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	af860613          	addi	a2,a2,-1288 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02022e0:	1a700593          	li	a1,423
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	f5450513          	addi	a0,a0,-172 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	20068693          	addi	a3,a3,512 # ffffffffc02054f0 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	ad860613          	addi	a2,a2,-1320 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202300:	1ac00593          	li	a1,428
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	f3450513          	addi	a0,a0,-204 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	11868693          	addi	a3,a3,280 # ffffffffc0205428 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	ab860613          	addi	a2,a2,-1352 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202320:	1a400593          	li	a1,420
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	f1450513          	addi	a0,a0,-236 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	ede60613          	addi	a2,a2,-290 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc020233a:	1a300593          	li	a1,419
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	efa50513          	addi	a0,a0,-262 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	13e68693          	addi	a3,a3,318 # ffffffffc0205488 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020235a:	1b100593          	li	a1,433
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	eda50513          	addi	a0,a0,-294 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	1e668693          	addi	a3,a3,486 # ffffffffc0205550 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	a5e60613          	addi	a2,a2,-1442 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020237a:	1b000593          	li	a1,432
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	eba50513          	addi	a0,a0,-326 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	1ae68693          	addi	a3,a3,430 # ffffffffc0205538 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020239a:	1af00593          	li	a1,431
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e9a50513          	addi	a0,a0,-358 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	15e68693          	addi	a3,a3,350 # ffffffffc0205508 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02023ba:	1ae00593          	li	a1,430
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	e7a50513          	addi	a0,a0,-390 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	2f668693          	addi	a3,a3,758 # ffffffffc02056c0 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	9fe60613          	addi	a2,a2,-1538 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02023da:	1dc00593          	li	a1,476
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	e5a50513          	addi	a0,a0,-422 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	0ee68693          	addi	a3,a3,238 # ffffffffc02054d8 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	9de60613          	addi	a2,a2,-1570 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02023fa:	1ab00593          	li	a1,427
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	e3a50513          	addi	a0,a0,-454 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	0be68693          	addi	a3,a3,190 # ffffffffc02054c8 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	9be60613          	addi	a2,a2,-1602 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020241a:	1aa00593          	li	a1,426
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	e1a50513          	addi	a0,a0,-486 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	19668693          	addi	a3,a3,406 # ffffffffc02055c0 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	99e60613          	addi	a2,a2,-1634 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020243a:	1ec00593          	li	a1,492
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	dfa50513          	addi	a0,a0,-518 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	06e68693          	addi	a3,a3,110 # ffffffffc02054b8 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020245a:	1a900593          	li	a1,425
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	dda50513          	addi	a0,a0,-550 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	fa668693          	addi	a3,a3,-90 # ffffffffc0205410 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	95e60613          	addi	a2,a2,-1698 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020247a:	1b600593          	li	a1,438
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	dba50513          	addi	a0,a0,-582 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	0de68693          	addi	a3,a3,222 # ffffffffc0205568 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	93e60613          	addi	a2,a2,-1730 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020249a:	1b300593          	li	a1,435
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d9a50513          	addi	a0,a0,-614 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	f4e68693          	addi	a3,a3,-178 # ffffffffc02053f8 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	91e60613          	addi	a2,a2,-1762 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02024ba:	1b200593          	li	a1,434
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	d7a50513          	addi	a0,a0,-646 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	d4660613          	addi	a2,a2,-698 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc02024d2:	06d00593          	li	a1,109
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	d0250513          	addi	a0,a0,-766 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	0b668693          	addi	a3,a3,182 # ffffffffc0205598 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02024f2:	1bd00593          	li	a1,445
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	d4250513          	addi	a0,a0,-702 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	04e68693          	addi	a3,a3,78 # ffffffffc0205550 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202512:	1bb00593          	li	a1,443
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	d2250513          	addi	a0,a0,-734 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	05e68693          	addi	a3,a3,94 # ffffffffc0205580 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	8a660613          	addi	a2,a2,-1882 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202532:	1ba00593          	li	a1,442
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	d0250513          	addi	a0,a0,-766 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	00e68693          	addi	a3,a3,14 # ffffffffc0205550 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	88660613          	addi	a2,a2,-1914 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202552:	1b700593          	li	a1,439
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	ce250513          	addi	a0,a0,-798 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	14668693          	addi	a3,a3,326 # ffffffffc02056a8 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	86660613          	addi	a2,a2,-1946 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202572:	1db00593          	li	a1,475
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	cc250513          	addi	a0,a0,-830 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	0ee68693          	addi	a3,a3,238 # ffffffffc0205670 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	84660613          	addi	a2,a2,-1978 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202592:	1da00593          	li	a1,474
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	ca250513          	addi	a0,a0,-862 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	0b668693          	addi	a3,a3,182 # ffffffffc0205658 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	82660613          	addi	a2,a2,-2010 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02025b2:	1d600593          	li	a1,470
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c8250513          	addi	a0,a0,-894 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	ffe68693          	addi	a3,a3,-2 # ffffffffc02055c0 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	80660613          	addi	a2,a2,-2042 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02025d2:	1c400593          	li	a1,452
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	c6250513          	addi	a0,a0,-926 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	e1668693          	addi	a3,a3,-490 # ffffffffc02053f8 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	7e660613          	addi	a2,a2,2022 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02025f2:	19f00593          	li	a1,415
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	c4250513          	addi	a0,a0,-958 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	c0e60613          	addi	a2,a2,-1010 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc020260a:	1a200593          	li	a1,418
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	c2a50513          	addi	a0,a0,-982 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	df668693          	addi	a3,a3,-522 # ffffffffc0205410 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	7ae60613          	addi	a2,a2,1966 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020262a:	1a000593          	li	a1,416
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	e4e68693          	addi	a3,a3,-434 # ffffffffc0205488 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	78e60613          	addi	a2,a2,1934 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020264a:	1a800593          	li	a1,424
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	bea50513          	addi	a0,a0,-1046 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	10e68693          	addi	a3,a3,270 # ffffffffc0205768 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	76e60613          	addi	a2,a2,1902 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020266a:	1e400593          	li	a1,484
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	bca50513          	addi	a0,a0,-1078 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	0b668693          	addi	a3,a3,182 # ffffffffc0205730 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	74e60613          	addi	a2,a2,1870 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020268a:	1e100593          	li	a1,481
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	baa50513          	addi	a0,a0,-1110 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	06668693          	addi	a3,a3,102 # ffffffffc0205700 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	72e60613          	addi	a2,a2,1838 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02026aa:	1dd00593          	li	a1,477
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b8a50513          	addi	a0,a0,-1142 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc020270e:	e5e53503          	ld	a0,-418(a0) # ffffffffc0211568 <check_mm_struct>
...
ffffffffc0202724:	09068693          	addi	a3,a3,144 # ffffffffc02057b0 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	6a860613          	addi	a2,a2,1704 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202730:	17e00593          	li	a1,382
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	b0450513          	addi	a0,a0,-1276 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02027a4:	ac06b683          	ld	a3,-1344(a3) # ffffffffc0206260 <error_string+0x38>
...
ffffffffc02027dc:	ff068693          	addi	a3,a3,-16 # ffffffffc02057c8 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	5f060613          	addi	a2,a2,1520 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02027e8:	1f400593          	li	a1,500
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	a4c50513          	addi	a0,a0,-1460 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	a1660613          	addi	a2,a2,-1514 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc0202802:	06d00593          	li	a1,109
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	9d250513          	addi	a0,a0,-1582 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	fd668693          	addi	a3,a3,-42 # ffffffffc02057e8 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	5b660613          	addi	a2,a2,1462 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202822:	1f700593          	li	a1,503
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	a1250513          	addi	a0,a0,-1518 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	a0e60613          	addi	a2,a2,-1522 # ffffffffc02052d0 <default_pmm_manager+0x150>
ffffffffc02028ca:	06f00593          	li	a1,111
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	90a50513          	addi	a0,a0,-1782 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	f1e68693          	addi	a3,a3,-226 # ffffffffc02057f8 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	4ee60613          	addi	a2,a2,1262 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02028ea:	1fe00593          	li	a1,510
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	94a50513          	addi	a0,a0,-1718 # ffffffffc0205238 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	ece68693          	addi	a3,a3,-306 # ffffffffc02057c8 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	4ce60613          	addi	a2,a2,1230 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020290a:	1fd00593          	li	a1,509
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	92a50513          	addi	a0,a0,-1750 # ffffffffc0205238 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	450010ef          	jal	ra,ffffffffc0203d86 <swapfs_init>
...
ffffffffc0202994:	ea850513          	addi	a0,a0,-344 # ffffffffc0205838 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	e7050513          	addi	a0,a0,-400 # ffffffffc0205850 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	339000ef          	jal	ra,ffffffffc0203524 <mm_create>
...
ffffffffc02029fa:	b7278793          	addi	a5,a5,-1166 # ffffffffc0211568 <check_mm_struct>
...
ffffffffc0202a20:	34d000ef          	jal	ra,ffffffffc020356c <vma_create>
...
ffffffffc0202a2c:	3af000ef          	jal	ra,ffffffffc02035da <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	e9050513          	addi	a0,a0,-368 # ffffffffc02058c0 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	ec450513          	addi	a0,a0,-316 # ffffffffc0205910 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	ed850513          	addi	a0,a0,-296 # ffffffffc0205998 <default_pmm_manager+0x818>
...
ffffffffc0202ad2:	aa07a123          	sw	zero,-1374(a5) # ffffffffc0211570 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0202ae0:	a945a583          	lw	a1,-1388(a1) # ffffffffc0211570 <pgfault_num>
ffffffffc0202ae4:	4805                	li	a6,1
ffffffffc0202ae6:	0000f797          	auipc	a5,0xf
ffffffffc0202aea:	a8a78793          	addi	a5,a5,-1398 # ffffffffc0211570 <pgfault_num>
...
ffffffffc0202ba0:	6ccc0c13          	addi	s8,s8,1740 # ffffffffc0206268 <nbase>
...
ffffffffc0202c10:	e3450513          	addi	a0,a0,-460 # ffffffffc0205a40 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	275000ef          	jal	ra,ffffffffc02036aa <mm_destroy>
...
ffffffffc0202c62:	e1250513          	addi	a0,a0,-494 # ffffffffc0205a70 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	e2650513          	addi	a0,a0,-474 # ffffffffc0205a90 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	14468693          	addi	a3,a3,324 # ffffffffc0204dc0 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	14c60613          	addi	a2,a2,332 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202c8c:	0bc00593          	li	a1,188
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b9850513          	addi	a0,a0,-1128 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	d7c68693          	addi	a3,a3,-644 # ffffffffc0205a18 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	12c60613          	addi	a2,a2,300 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202cac:	0fc00593          	li	a1,252
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	b7850513          	addi	a0,a0,-1160 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	52c60613          	addi	a2,a2,1324 # ffffffffc02051e8 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07300593          	li	a1,115
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	51050513          	addi	a0,a0,1296 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	4e460613          	addi	a2,a2,1252 # ffffffffc02051b8 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06800593          	li	a1,104
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	4f850513          	addi	a0,a0,1272 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	c6468693          	addi	a3,a3,-924 # ffffffffc0205950 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	0dc60613          	addi	a2,a2,220 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202cfc:	0dd00593          	li	a1,221
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	b2850513          	addi	a0,a0,-1240 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	c2c68693          	addi	a3,a3,-980 # ffffffffc0205938 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	0bc60613          	addi	a2,a2,188 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202d1c:	0dc00593          	li	a1,220
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	b0850513          	addi	a0,a0,-1272 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	adc60613          	addi	a2,a2,-1316 # ffffffffc0205808 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	af050513          	addi	a0,a0,-1296 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	cbc68693          	addi	a3,a3,-836 # ffffffffc0205a00 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	08460613          	addi	a2,a2,132 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202d54:	0fb00593          	li	a1,251
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	ad050513          	addi	a0,a0,-1328 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c8c68693          	addi	a3,a3,-884 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	06460613          	addi	a2,a2,100 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202d74:	09f00593          	li	a1,159
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	ab050513          	addi	a0,a0,-1360 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	c6c68693          	addi	a3,a3,-916 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	04460613          	addi	a2,a2,68 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202d94:	0a100593          	li	a1,161
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a9050513          	addi	a0,a0,-1392 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	20468693          	addi	a3,a3,516 # ffffffffc0204fa8 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	02460613          	addi	a2,a2,36 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202db4:	0f300593          	li	a1,243
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	a7050513          	addi	a0,a0,-1424 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	ca468693          	addi	a3,a3,-860 # ffffffffc0205a68 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	00460613          	addi	a2,a2,4 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202dd4:	10200593          	li	a1,258
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	a5050513          	addi	a0,a0,-1456 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	abc68693          	addi	a3,a3,-1348 # ffffffffc02058a0 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	fe460613          	addi	a2,a2,-28 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202df4:	0cc00593          	li	a1,204
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	a3050513          	addi	a0,a0,-1488 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	aac68693          	addi	a3,a3,-1364 # ffffffffc02058b0 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	fc460613          	addi	a2,a2,-60 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202e14:	0cf00593          	li	a1,207
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	a1050513          	addi	a0,a0,-1520 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	ad468693          	addi	a3,a3,-1324 # ffffffffc02058f8 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	fa460613          	addi	a2,a2,-92 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202e34:	0d700593          	li	a1,215
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	9f050513          	addi	a0,a0,-1552 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	fbc68693          	addi	a3,a3,-68 # ffffffffc0204e00 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f8460613          	addi	a2,a2,-124 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202e54:	0bf00593          	li	a1,191
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	9d050513          	addi	a0,a0,-1584 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	b6c68693          	addi	a3,a3,-1172 # ffffffffc02059d0 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	f6460613          	addi	a2,a2,-156 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202e74:	09700593          	li	a1,151
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	9b050513          	addi	a0,a0,-1616 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	b4c68693          	addi	a3,a3,-1204 # ffffffffc02059d0 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	f4460613          	addi	a2,a2,-188 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202e94:	09900593          	li	a1,153
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	99050513          	addi	a0,a0,-1648 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	b3c68693          	addi	a3,a3,-1220 # ffffffffc02059e0 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	f2460613          	addi	a2,a2,-220 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202eb4:	09b00593          	li	a1,155
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	97050513          	addi	a0,a0,-1680 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	b1c68693          	addi	a3,a3,-1252 # ffffffffc02059e0 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	f0460613          	addi	a2,a2,-252 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202ed4:	09d00593          	li	a1,157
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	95050513          	addi	a0,a0,-1712 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	adc68693          	addi	a3,a3,-1316 # ffffffffc02059c0 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	ee460613          	addi	a2,a2,-284 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202ef4:	09300593          	li	a1,147
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	93050513          	addi	a0,a0,-1744 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	abc68693          	addi	a3,a3,-1348 # ffffffffc02059c0 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	ec460613          	addi	a2,a2,-316 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202f14:	09500593          	li	a1,149
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	91050513          	addi	a0,a0,-1776 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	95468693          	addi	a3,a3,-1708 # ffffffffc0205878 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	ea460613          	addi	a2,a2,-348 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202f34:	0c400593          	li	a1,196
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	8f050513          	addi	a0,a0,-1808 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	94468693          	addi	a3,a3,-1724 # ffffffffc0205888 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e8460613          	addi	a2,a2,-380 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202f54:	0c700593          	li	a1,199
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	8d050513          	addi	a0,a0,-1840 # ffffffffc0205828 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	a0c68693          	addi	a3,a3,-1524 # ffffffffc0205970 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	e6460613          	addi	a2,a2,-412 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0202f74:	0ea00593          	li	a1,234
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	8b050513          	addi	a0,a0,-1872 # ffffffffc0205828 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	b4cb0b13          	addi	s6,s6,-1204 # ffffffffc0205b10 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	b2cb8b93          	addi	s7,s7,-1236 # ffffffffc0205af8 <default_pmm_manager+0x978>
...
ffffffffc0203040:	619000ef          	jal	ra,ffffffffc0203e58 <swapfs_write>
...
ffffffffc0203082:	a3250513          	addi	a0,a0,-1486 # ffffffffc0205ab0 <default_pmm_manager+0x930>
...
ffffffffc0203094:	a5068693          	addi	a3,a3,-1456 # ffffffffc0205ae0 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	d3860613          	addi	a2,a2,-712 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02030a0:	06800593          	li	a1,104
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	78450513          	addi	a0,a0,1924 # ffffffffc0205828 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	4e1000ef          	jal	ra,ffffffffc0203dbe <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	a7850513          	addi	a0,a0,-1416 # ffffffffc0205b60 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	a4668693          	addi	a3,a3,-1466 # ffffffffc0205b50 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	cbe60613          	addi	a2,a2,-834 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020311a:	07e00593          	li	a1,126
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	70a50513          	addi	a0,a0,1802 # ffffffffc0205828 <default_pmm_manager+0x6a8>
...
ffffffffc0203160:	4146a683          	lw	a3,1044(a3) # ffffffffc0211570 <pgfault_num>
ffffffffc0203164:	4711                	li	a4,4
ffffffffc0203166:	0ae69d63          	bne	a3,a4,ffffffffc0203220 <_clock_check_swap+0xd0>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc020316a:	6705                	lui	a4,0x1
ffffffffc020316c:	4629                	li	a2,10
ffffffffc020316e:	0000e797          	auipc	a5,0xe
ffffffffc0203172:	40278793          	addi	a5,a5,1026 # ffffffffc0211570 <pgfault_num>
...
ffffffffc020317e:	22d71163          	bne	a4,a3,ffffffffc02033a0 <_clock_check_swap+0x250>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc020318e:	1ee69963          	bne	a3,a4,ffffffffc0203380 <_clock_check_swap+0x230>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc020319e:	1cd71163          	bne	a4,a3,ffffffffc0203360 <_clock_check_swap+0x210>
...
ffffffffc02031b0:	18d71863          	bne	a4,a3,ffffffffc0203340 <_clock_check_swap+0x1f0>
    assert(pgfault_num==5);
ffffffffc02031b4:	4394                	lw	a3,0(a5)
ffffffffc02031b6:	2681                	sext.w	a3,a3
ffffffffc02031b8:	16e69463          	bne	a3,a4,ffffffffc0203320 <_clock_check_swap+0x1d0>
    assert(pgfault_num==5);
ffffffffc02031bc:	4398                	lw	a4,0(a5)
ffffffffc02031be:	2701                	sext.w	a4,a4
ffffffffc02031c0:	14d71063          	bne	a4,a3,ffffffffc0203300 <_clock_check_swap+0x1b0>
    assert(pgfault_num==5);
ffffffffc02031c4:	4394                	lw	a3,0(a5)
ffffffffc02031c6:	2681                	sext.w	a3,a3
ffffffffc02031c8:	10e69c63          	bne	a3,a4,ffffffffc02032e0 <_clock_check_swap+0x190>
    assert(pgfault_num==5);
ffffffffc02031cc:	4398                	lw	a4,0(a5)
ffffffffc02031ce:	2701                	sext.w	a4,a4
ffffffffc02031d0:	0ed71863          	bne	a4,a3,ffffffffc02032c0 <_clock_check_swap+0x170>
    assert(pgfault_num==5);
ffffffffc02031d4:	4394                	lw	a3,0(a5)
ffffffffc02031d6:	2681                	sext.w	a3,a3
ffffffffc02031d8:	0ce69463          	bne	a3,a4,ffffffffc02032a0 <_clock_check_swap+0x150>
    *(unsigned char *)0x5000 = 0x0e;
...
ffffffffc02031ea:	08d71b63          	bne	a4,a3,ffffffffc0203280 <_clock_check_swap+0x130>
...
ffffffffc02031f6:	06e69563          	bne	a3,a4,ffffffffc0203260 <_clock_check_swap+0x110>
    assert(pgfault_num==6);
ffffffffc02031fa:	439c                	lw	a5,0(a5)
ffffffffc02031fc:	4719                	li	a4,6
ffffffffc02031fe:	2781                	sext.w	a5,a5
ffffffffc0203200:	04e79063          	bne	a5,a4,ffffffffc0203240 <_clock_check_swap+0xf0>
    cprintf("countttttttttttttttttttt:%d\n",count);
ffffffffc0203204:	0000e597          	auipc	a1,0xe
ffffffffc0203208:	35c5a583          	lw	a1,860(a1) # ffffffffc0211560 <count>
ffffffffc020320c:	00003517          	auipc	a0,0x3
ffffffffc0203210:	9f450513          	addi	a0,a0,-1548 # ffffffffc0205c00 <default_pmm_manager+0xa80>
ffffffffc0203214:	ea7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203218:	60a2                	ld	ra,8(sp)
...
ffffffffc0203224:	7d068693          	addi	a3,a3,2000 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc0203228:	00002617          	auipc	a2,0x2
ffffffffc020322c:	ba860613          	addi	a2,a2,-1112 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203230:	09100593          	li	a1,145
ffffffffc0203234:	00003517          	auipc	a0,0x3
ffffffffc0203238:	96c50513          	addi	a0,a0,-1684 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020323c:	938fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203240:	00003697          	auipc	a3,0x3
ffffffffc0203244:	9b068693          	addi	a3,a3,-1616 # ffffffffc0205bf0 <default_pmm_manager+0xa70>
ffffffffc0203248:	00002617          	auipc	a2,0x2
ffffffffc020324c:	b8860613          	addi	a2,a2,-1144 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203250:	0a800593          	li	a1,168
ffffffffc0203254:	00003517          	auipc	a0,0x3
ffffffffc0203258:	94c50513          	addi	a0,a0,-1716 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020325c:	918fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203260:	00003697          	auipc	a3,0x3
ffffffffc0203264:	96868693          	addi	a3,a3,-1688 # ffffffffc0205bc8 <default_pmm_manager+0xa48>
ffffffffc0203268:	00002617          	auipc	a2,0x2
ffffffffc020326c:	b6860613          	addi	a2,a2,-1176 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203270:	0a600593          	li	a1,166
ffffffffc0203274:	00003517          	auipc	a0,0x3
ffffffffc0203278:	92c50513          	addi	a0,a0,-1748 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020327c:	8f8fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203280:	00003697          	auipc	a3,0x3
ffffffffc0203284:	93868693          	addi	a3,a3,-1736 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc0203288:	00002617          	auipc	a2,0x2
ffffffffc020328c:	b4860613          	addi	a2,a2,-1208 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203290:	0a500593          	li	a1,165
ffffffffc0203294:	00003517          	auipc	a0,0x3
ffffffffc0203298:	90c50513          	addi	a0,a0,-1780 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020329c:	8d8fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032a0:	00003697          	auipc	a3,0x3
ffffffffc02032a4:	91868693          	addi	a3,a3,-1768 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc02032a8:	00002617          	auipc	a2,0x2
ffffffffc02032ac:	b2860613          	addi	a2,a2,-1240 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02032b0:	0a300593          	li	a1,163
ffffffffc02032b4:	00003517          	auipc	a0,0x3
ffffffffc02032b8:	8ec50513          	addi	a0,a0,-1812 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc02032bc:	8b8fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032c0:	00003697          	auipc	a3,0x3
ffffffffc02032c4:	8f868693          	addi	a3,a3,-1800 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc02032c8:	00002617          	auipc	a2,0x2
ffffffffc02032cc:	b0860613          	addi	a2,a2,-1272 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02032d0:	0a100593          	li	a1,161
ffffffffc02032d4:	00003517          	auipc	a0,0x3
ffffffffc02032d8:	8cc50513          	addi	a0,a0,-1844 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc02032dc:	898fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032e0:	00003697          	auipc	a3,0x3
ffffffffc02032e4:	8d868693          	addi	a3,a3,-1832 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc02032e8:	00002617          	auipc	a2,0x2
ffffffffc02032ec:	ae860613          	addi	a2,a2,-1304 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02032f0:	09f00593          	li	a1,159
ffffffffc02032f4:	00003517          	auipc	a0,0x3
ffffffffc02032f8:	8ac50513          	addi	a0,a0,-1876 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc02032fc:	878fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203300:	00003697          	auipc	a3,0x3
ffffffffc0203304:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc0203308:	00002617          	auipc	a2,0x2
ffffffffc020330c:	ac860613          	addi	a2,a2,-1336 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203310:	09d00593          	li	a1,157
ffffffffc0203314:	00003517          	auipc	a0,0x3
ffffffffc0203318:	88c50513          	addi	a0,a0,-1908 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020331c:	858fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203320:	00003697          	auipc	a3,0x3
ffffffffc0203324:	89868693          	addi	a3,a3,-1896 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc0203328:	00002617          	auipc	a2,0x2
ffffffffc020332c:	aa860613          	addi	a2,a2,-1368 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203330:	09b00593          	li	a1,155
ffffffffc0203334:	00003517          	auipc	a0,0x3
ffffffffc0203338:	86c50513          	addi	a0,a0,-1940 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020333c:	838fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203340:	00003697          	auipc	a3,0x3
ffffffffc0203344:	87868693          	addi	a3,a3,-1928 # ffffffffc0205bb8 <default_pmm_manager+0xa38>
ffffffffc0203348:	00002617          	auipc	a2,0x2
ffffffffc020334c:	a8860613          	addi	a2,a2,-1400 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203350:	09900593          	li	a1,153
ffffffffc0203354:	00003517          	auipc	a0,0x3
ffffffffc0203358:	84c50513          	addi	a0,a0,-1972 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020335c:	818fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203360:	00002697          	auipc	a3,0x2
ffffffffc0203364:	69068693          	addi	a3,a3,1680 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc0203368:	00002617          	auipc	a2,0x2
ffffffffc020336c:	a6860613          	addi	a2,a2,-1432 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203370:	09700593          	li	a1,151
ffffffffc0203374:	00003517          	auipc	a0,0x3
ffffffffc0203378:	82c50513          	addi	a0,a0,-2004 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020337c:	ff9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203380:	00002697          	auipc	a3,0x2
ffffffffc0203384:	67068693          	addi	a3,a3,1648 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc0203388:	00002617          	auipc	a2,0x2
ffffffffc020338c:	a4860613          	addi	a2,a2,-1464 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203390:	09500593          	li	a1,149
ffffffffc0203394:	00003517          	auipc	a0,0x3
ffffffffc0203398:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc020339c:	fd9fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02033a0:	00002697          	auipc	a3,0x2
ffffffffc02033a4:	65068693          	addi	a3,a3,1616 # ffffffffc02059f0 <default_pmm_manager+0x870>
ffffffffc02033a8:	00002617          	auipc	a2,0x2
ffffffffc02033ac:	a2860613          	addi	a2,a2,-1496 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02033b0:	09300593          	li	a1,147
ffffffffc02033b4:	00002517          	auipc	a0,0x2
ffffffffc02033b8:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc02033bc:	fb9fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033c0 <_clock_swap_out_victim>:
    count++;
ffffffffc02033c0:	0000e717          	auipc	a4,0xe
ffffffffc02033c4:	1a070713          	addi	a4,a4,416 # ffffffffc0211560 <count>
ffffffffc02033c8:	431c                	lw	a5,0(a4)
{
ffffffffc02033ca:	7179                	addi	sp,sp,-48
ffffffffc02033cc:	ec26                	sd	s1,24(sp)
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02033ce:	7504                	ld	s1,40(a0)
{
ffffffffc02033d0:	f406                	sd	ra,40(sp)
ffffffffc02033d2:	f022                	sd	s0,32(sp)
ffffffffc02033d4:	e84a                	sd	s2,16(sp)
ffffffffc02033d6:	e44e                	sd	s3,8(sp)
    count++;
ffffffffc02033d8:	2785                	addiw	a5,a5,1
ffffffffc02033da:	c31c                	sw	a5,0(a4)
         assert(head != NULL);
ffffffffc02033dc:	ccd9                	beqz	s1,ffffffffc020347a <_clock_swap_out_victim+0xba>
     assert(in_tick==0);
ffffffffc02033de:	ee55                	bnez	a2,ffffffffc020349a <_clock_swap_out_victim+0xda>
    if(head==list_next(head)){
ffffffffc02033e0:	649c                	ld	a5,8(s1)
ffffffffc02033e2:	06f48e63          	beq	s1,a5,ffffffffc020345e <_clock_swap_out_victim+0x9e>
        list_entry_t *entry = curr_ptr;
ffffffffc02033e6:	0000e417          	auipc	s0,0xe
ffffffffc02033ea:	17240413          	addi	s0,s0,370 # ffffffffc0211558 <curr_ptr>
ffffffffc02033ee:	601c                	ld	a5,0(s0)
ffffffffc02033f0:	892e                	mv	s2,a1
        cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc02033f2:	00003997          	auipc	s3,0x3
ffffffffc02033f6:	86698993          	addi	s3,s3,-1946 # ffffffffc0205c58 <default_pmm_manager+0xad8>
        if ((*ptr_page)->visited == 0) {
ffffffffc02033fa:	fe07b703          	ld	a4,-32(a5)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc02033fe:	fd078693          	addi	a3,a5,-48
ffffffffc0203402:	e194                	sd	a3,0(a1)
        if ((*ptr_page)->visited == 0) {
ffffffffc0203404:	ef09                	bnez	a4,ffffffffc020341e <_clock_swap_out_victim+0x5e>
ffffffffc0203406:	a83d                	j	ffffffffc0203444 <_clock_swap_out_victim+0x84>
        cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc0203408:	854e                	mv	a0,s3
ffffffffc020340a:	cb1fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        list_entry_t *entry = curr_ptr;
ffffffffc020340e:	601c                	ld	a5,0(s0)
        if ((*ptr_page)->visited == 0) {
ffffffffc0203410:	fe07b703          	ld	a4,-32(a5)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc0203414:	fd078693          	addi	a3,a5,-48
ffffffffc0203418:	00d93023          	sd	a3,0(s2)
        if ((*ptr_page)->visited == 0) {
ffffffffc020341c:	c705                	beqz	a4,ffffffffc0203444 <_clock_swap_out_victim+0x84>
    return listelm->next;
ffffffffc020341e:	678c                	ld	a1,8(a5)
            (*ptr_page)->visited = 0;
ffffffffc0203420:	fe07b023          	sd	zero,-32(a5)
            curr_ptr = list_next(curr_ptr);
ffffffffc0203424:	e00c                	sd	a1,0(s0)
            if (curr_ptr == head) {
ffffffffc0203426:	feb491e3          	bne	s1,a1,ffffffffc0203408 <_clock_swap_out_victim+0x48>
ffffffffc020342a:	648c                	ld	a1,8(s1)
        cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc020342c:	854e                	mv	a0,s3
                curr_ptr = list_next(head);
ffffffffc020342e:	e00c                	sd	a1,0(s0)
        cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc0203430:	c8bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        list_entry_t *entry = curr_ptr;
ffffffffc0203434:	601c                	ld	a5,0(s0)
        if ((*ptr_page)->visited == 0) {
ffffffffc0203436:	fe07b703          	ld	a4,-32(a5)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc020343a:	fd078693          	addi	a3,a5,-48
ffffffffc020343e:	00d93023          	sd	a3,0(s2)
        if ((*ptr_page)->visited == 0) {
ffffffffc0203442:	ff71                	bnez	a4,ffffffffc020341e <_clock_swap_out_victim+0x5e>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203444:	6398                	ld	a4,0(a5)
ffffffffc0203446:	679c                	ld	a5,8(a5)
}
ffffffffc0203448:	70a2                	ld	ra,40(sp)
ffffffffc020344a:	64e2                	ld	s1,24(sp)
    prev->next = next;
ffffffffc020344c:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020344e:	e398                	sd	a4,0(a5)
            curr_ptr = list_next(curr_ptr);
ffffffffc0203450:	e01c                	sd	a5,0(s0)
}
ffffffffc0203452:	7402                	ld	s0,32(sp)
ffffffffc0203454:	6942                	ld	s2,16(sp)
ffffffffc0203456:	69a2                	ld	s3,8(sp)
ffffffffc0203458:	4501                	li	a0,0
ffffffffc020345a:	6145                	addi	sp,sp,48
ffffffffc020345c:	8082                	ret
        cprintf("no page to swap out\n");
ffffffffc020345e:	00002517          	auipc	a0,0x2
ffffffffc0203462:	7e250513          	addi	a0,a0,2018 # ffffffffc0205c40 <default_pmm_manager+0xac0>
ffffffffc0203466:	c55fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020346a:	70a2                	ld	ra,40(sp)
ffffffffc020346c:	7402                	ld	s0,32(sp)
ffffffffc020346e:	64e2                	ld	s1,24(sp)
ffffffffc0203470:	6942                	ld	s2,16(sp)
ffffffffc0203472:	69a2                	ld	s3,8(sp)
ffffffffc0203474:	4501                	li	a0,0
ffffffffc0203476:	6145                	addi	sp,sp,48
ffffffffc0203478:	8082                	ret
         assert(head != NULL);
ffffffffc020347a:	00002697          	auipc	a3,0x2
ffffffffc020347e:	7a668693          	addi	a3,a3,1958 # ffffffffc0205c20 <default_pmm_manager+0xaa0>
ffffffffc0203482:	00002617          	auipc	a2,0x2
ffffffffc0203486:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020348a:	04b00593          	li	a1,75
ffffffffc020348e:	00002517          	auipc	a0,0x2
ffffffffc0203492:	71250513          	addi	a0,a0,1810 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc0203496:	edffc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020349a:	00002697          	auipc	a3,0x2
ffffffffc020349e:	79668693          	addi	a3,a3,1942 # ffffffffc0205c30 <default_pmm_manager+0xab0>
ffffffffc02034a2:	00002617          	auipc	a2,0x2
ffffffffc02034a6:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02034aa:	04c00593          	li	a1,76
ffffffffc02034ae:	00002517          	auipc	a0,0x2
ffffffffc02034b2:	6f250513          	addi	a0,a0,1778 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
ffffffffc02034b6:	ebffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034ba <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034ba:	0000e797          	auipc	a5,0xe
ffffffffc02034be:	09e7b783          	ld	a5,158(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc02034c2:	cf89                	beqz	a5,ffffffffc02034dc <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc02034c4:	751c                	ld	a5,40(a0)
ffffffffc02034c6:	03060713          	addi	a4,a2,48
}
ffffffffc02034ca:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc02034cc:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc02034ce:	e398                	sd	a4,0(a5)
ffffffffc02034d0:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc02034d2:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc02034d4:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc02034d6:	fa14                	sd	a3,48(a2)
ffffffffc02034d8:	ea1c                	sd	a5,16(a2)
}
...
ffffffffc02034e2:	78a68693          	addi	a3,a3,1930 # ffffffffc0205c68 <default_pmm_manager+0xae8>
ffffffffc02034e6:	00002617          	auipc	a2,0x2
ffffffffc02034ea:	8ea60613          	addi	a2,a2,-1814 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02034ee:	03700593          	li	a1,55
ffffffffc02034f2:	00002517          	auipc	a0,0x2
ffffffffc02034f6:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205ba0 <default_pmm_manager+0xa20>
{
ffffffffc02034fa:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034fc:	e79fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203500 <check_vma_overlap.part.0>:
}
...
ffffffffc0203502:	00002697          	auipc	a3,0x2
ffffffffc0203506:	7a668693          	addi	a3,a3,1958 # ffffffffc0205ca8 <default_pmm_manager+0xb28>
ffffffffc020350a:	00002617          	auipc	a2,0x2
ffffffffc020350e:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203512:	07d00593          	li	a1,125
ffffffffc0203516:	00002517          	auipc	a0,0x2
ffffffffc020351a:	7b250513          	addi	a0,a0,1970 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020351e:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc0203520:	e55fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203524 <mm_create>:
mm_create(void) {
ffffffffc0203524:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203526:	03000513          	li	a0,48
mm_create(void) {
ffffffffc020352a:	e022                	sd	s0,0(sp)
ffffffffc020352c:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020352e:	a4aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203532:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203534:	c105                	beqz	a0,ffffffffc0203554 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc0203536:	e408                	sd	a0,8(s0)
ffffffffc0203538:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc020353a:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020353e:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203542:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203546:	0000e797          	auipc	a5,0xe
ffffffffc020354a:	00a7a783          	lw	a5,10(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020354e:	eb81                	bnez	a5,ffffffffc020355e <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc0203550:	02053423          	sd	zero,40(a0)
}
ffffffffc0203554:	60a2                	ld	ra,8(sp)
ffffffffc0203556:	8522                	mv	a0,s0
ffffffffc0203558:	6402                	ld	s0,0(sp)
ffffffffc020355a:	0141                	addi	sp,sp,16
ffffffffc020355c:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020355e:	a27ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
ffffffffc0203562:	60a2                	ld	ra,8(sp)
ffffffffc0203564:	8522                	mv	a0,s0
ffffffffc0203566:	6402                	ld	s0,0(sp)
ffffffffc0203568:	0141                	addi	sp,sp,16
ffffffffc020356a:	8082                	ret

ffffffffc020356c <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020356c:	1101                	addi	sp,sp,-32
ffffffffc020356e:	e04a                	sd	s2,0(sp)
ffffffffc0203570:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203572:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203576:	e822                	sd	s0,16(sp)
ffffffffc0203578:	e426                	sd	s1,8(sp)
ffffffffc020357a:	ec06                	sd	ra,24(sp)
ffffffffc020357c:	84ae                	mv	s1,a1
ffffffffc020357e:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203580:	9f8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203584:	c509                	beqz	a0,ffffffffc020358e <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203586:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020358a:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020358c:	ed00                	sd	s0,24(a0)
}
ffffffffc020358e:	60e2                	ld	ra,24(sp)
ffffffffc0203590:	6442                	ld	s0,16(sp)
ffffffffc0203592:	64a2                	ld	s1,8(sp)
...
ffffffffc0203646:	ebbff0ef          	jal	ra,ffffffffc0203500 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc020364a:	00002697          	auipc	a3,0x2
ffffffffc020364e:	68e68693          	addi	a3,a3,1678 # ffffffffc0205cd8 <default_pmm_manager+0xb58>
ffffffffc0203652:	00001617          	auipc	a2,0x1
ffffffffc0203656:	77e60613          	addi	a2,a2,1918 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020365a:	08400593          	li	a1,132
ffffffffc020365e:	00002517          	auipc	a0,0x2
ffffffffc0203662:	66a50513          	addi	a0,a0,1642 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203666:	d0ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020366a:	00002697          	auipc	a3,0x2
ffffffffc020366e:	6ae68693          	addi	a3,a3,1710 # ffffffffc0205d18 <default_pmm_manager+0xb98>
ffffffffc0203672:	00001617          	auipc	a2,0x1
ffffffffc0203676:	75e60613          	addi	a2,a2,1886 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020367a:	07c00593          	li	a1,124
ffffffffc020367e:	00002517          	auipc	a0,0x2
ffffffffc0203682:	64a50513          	addi	a0,a0,1610 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203686:	ceffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020368a:	00002697          	auipc	a3,0x2
ffffffffc020368e:	66e68693          	addi	a3,a3,1646 # ffffffffc0205cf8 <default_pmm_manager+0xb78>
ffffffffc0203692:	00001617          	auipc	a2,0x1
ffffffffc0203696:	73e60613          	addi	a2,a2,1854 # ffffffffc0204dd0 <commands+0x738>
ffffffffc020369a:	07b00593          	li	a1,123
ffffffffc020369e:	00002517          	auipc	a0,0x2
ffffffffc02036a2:	62a50513          	addi	a0,a0,1578 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
...
ffffffffc02036ac:	e022                	sd	s0,0(sp)
ffffffffc02036ae:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc02036b0:	6508                	ld	a0,8(a0)
ffffffffc02036b2:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02036b4:	00a40e63          	beq	s0,a0,ffffffffc02036d0 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02036b8:	6118                	ld	a4,0(a0)
ffffffffc02036ba:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02036bc:	03000593          	li	a1,48
ffffffffc02036c0:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02036c2:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02036c4:	e398                	sd	a4,0(a5)
ffffffffc02036c6:	96cff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02036ca:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02036cc:	fea416e3          	bne	s0,a0,ffffffffc02036b8 <mm_destroy+0xe>
    }
...
ffffffffc02036da:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036dc:	956ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc02036e0 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02036e0:	715d                	addi	sp,sp,-80
ffffffffc02036e2:	e486                	sd	ra,72(sp)
ffffffffc02036e4:	f44e                	sd	s3,40(sp)
ffffffffc02036e6:	f052                	sd	s4,32(sp)
ffffffffc02036e8:	e0a2                	sd	s0,64(sp)
ffffffffc02036ea:	fc26                	sd	s1,56(sp)
ffffffffc02036ec:	f84a                	sd	s2,48(sp)
ffffffffc02036ee:	ec56                	sd	s5,24(sp)
ffffffffc02036f0:	e85a                	sd	s6,16(sp)
ffffffffc02036f2:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02036f4:	f9ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02036fa:	f99fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02036fe:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc0203700:	03000513          	li	a0,48
ffffffffc0203704:	874ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc0203708:	56050863          	beqz	a0,ffffffffc0203c78 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc020370c:	e508                	sd	a0,8(a0)
ffffffffc020370e:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203710:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc0203714:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203718:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020371c:	0000e797          	auipc	a5,0xe
ffffffffc0203720:	e347a783          	lw	a5,-460(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203724:	84aa                	mv	s1,a0
ffffffffc0203726:	e7b9                	bnez	a5,ffffffffc0203774 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203728:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020372c:	03200413          	li	s0,50
ffffffffc0203730:	a811                	j	ffffffffc0203744 <vmm_init+0x64>
        vma->vm_start = vm_start;
...
ffffffffc0203736:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc020373a:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020373c:	8526                	mv	a0,s1
ffffffffc020373e:	e9dff0ef          	jal	ra,ffffffffc02035da <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203742:	cc05                	beqz	s0,ffffffffc020377a <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc020374e:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203752:	f165                	bnez	a0,ffffffffc0203732 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203754:	00002697          	auipc	a3,0x2
ffffffffc0203758:	15c68693          	addi	a3,a3,348 # ffffffffc02058b0 <default_pmm_manager+0x730>
ffffffffc020375c:	00001617          	auipc	a2,0x1
ffffffffc0203760:	67460613          	addi	a2,a2,1652 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203764:	0ce00593          	li	a1,206
ffffffffc0203768:	00002517          	auipc	a0,0x2
ffffffffc020376c:	56050513          	addi	a0,a0,1376 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203770:	c05fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203774:	811ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203778:	bf55                	j	ffffffffc020372c <vmm_init+0x4c>
ffffffffc020377a:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020377e:	1f900913          	li	s2,505
ffffffffc0203782:	a819                	j	ffffffffc0203798 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203784:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203786:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203788:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020378c:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020378e:	8526                	mv	a0,s1
ffffffffc0203790:	e4bff0ef          	jal	ra,ffffffffc02035da <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203794:	03240a63          	beq	s0,s2,ffffffffc02037c8 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203798:	03000513          	li	a0,48
ffffffffc020379c:	fddfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02037a0:	85aa                	mv	a1,a0
ffffffffc02037a2:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02037a6:	fd79                	bnez	a0,ffffffffc0203784 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc02037a8:	00002697          	auipc	a3,0x2
ffffffffc02037ac:	10868693          	addi	a3,a3,264 # ffffffffc02058b0 <default_pmm_manager+0x730>
ffffffffc02037b0:	00001617          	auipc	a2,0x1
ffffffffc02037b4:	62060613          	addi	a2,a2,1568 # ffffffffc0204dd0 <commands+0x738>
ffffffffc02037b8:	0d400593          	li	a1,212
ffffffffc02037bc:	00002517          	auipc	a0,0x2
ffffffffc02037c0:	50c50513          	addi	a0,a0,1292 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc02037c4:	bb1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc02037c8:	649c                	ld	a5,8(s1)
ffffffffc02037ca:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc02037cc:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc02037d0:	2ef48463          	beq	s1,a5,ffffffffc0203ab8 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02037d4:	fe87b603          	ld	a2,-24(a5)
ffffffffc02037d8:	ffe70693          	addi	a3,a4,-2
ffffffffc02037dc:	26d61e63          	bne	a2,a3,ffffffffc0203a58 <vmm_init+0x378>
ffffffffc02037e0:	ff07b683          	ld	a3,-16(a5)
ffffffffc02037e4:	26e69a63          	bne	a3,a4,ffffffffc0203a58 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc02037e8:	0715                	addi	a4,a4,5
ffffffffc02037ea:	679c                	ld	a5,8(a5)
ffffffffc02037ec:	feb712e3          	bne	a4,a1,ffffffffc02037d0 <vmm_init+0xf0>
ffffffffc02037f0:	4b1d                	li	s6,7
ffffffffc02037f2:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037f4:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02037f8:	85a2                	mv	a1,s0
ffffffffc02037fa:	8526                	mv	a0,s1
ffffffffc02037fc:	d9fff0ef          	jal	ra,ffffffffc020359a <find_vma>
ffffffffc0203800:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc0203802:	2c050b63          	beqz	a0,ffffffffc0203ad8 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203806:	00140593          	addi	a1,s0,1
ffffffffc020380a:	8526                	mv	a0,s1
ffffffffc020380c:	d8fff0ef          	jal	ra,ffffffffc020359a <find_vma>
ffffffffc0203810:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203812:	2e050363          	beqz	a0,ffffffffc0203af8 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203816:	85da                	mv	a1,s6
ffffffffc0203818:	8526                	mv	a0,s1
ffffffffc020381a:	d81ff0ef          	jal	ra,ffffffffc020359a <find_vma>
        assert(vma3 == NULL);
ffffffffc020381e:	2e051d63          	bnez	a0,ffffffffc0203b18 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203822:	00340593          	addi	a1,s0,3
ffffffffc0203826:	8526                	mv	a0,s1
ffffffffc0203828:	d73ff0ef          	jal	ra,ffffffffc020359a <find_vma>
        assert(vma4 == NULL);
ffffffffc020382c:	30051663          	bnez	a0,ffffffffc0203b38 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc0203830:	00440593          	addi	a1,s0,4
ffffffffc0203834:	8526                	mv	a0,s1
ffffffffc0203836:	d65ff0ef          	jal	ra,ffffffffc020359a <find_vma>
        assert(vma5 == NULL);
ffffffffc020383a:	30051f63          	bnez	a0,ffffffffc0203b58 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc020383e:	00893783          	ld	a5,8(s2)
ffffffffc0203842:	24879b63          	bne	a5,s0,ffffffffc0203a98 <vmm_init+0x3b8>
ffffffffc0203846:	01093783          	ld	a5,16(s2)
ffffffffc020384a:	25679763          	bne	a5,s6,ffffffffc0203a98 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc020384e:	008ab783          	ld	a5,8(s5)
ffffffffc0203852:	22879363          	bne	a5,s0,ffffffffc0203a78 <vmm_init+0x398>
ffffffffc0203856:	010ab783          	ld	a5,16(s5)
ffffffffc020385a:	21679f63          	bne	a5,s6,ffffffffc0203a78 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020385e:	0415                	addi	s0,s0,5
ffffffffc0203860:	0b15                	addi	s6,s6,5
ffffffffc0203862:	f9741be3          	bne	s0,s7,ffffffffc02037f8 <vmm_init+0x118>
ffffffffc0203866:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203868:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020386a:	85a2                	mv	a1,s0
ffffffffc020386c:	8526                	mv	a0,s1
ffffffffc020386e:	d2dff0ef          	jal	ra,ffffffffc020359a <find_vma>
ffffffffc0203872:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203876:	c90d                	beqz	a0,ffffffffc02038a8 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203878:	6914                	ld	a3,16(a0)
ffffffffc020387a:	6510                	ld	a2,8(a0)
ffffffffc020387c:	00002517          	auipc	a0,0x2
ffffffffc0203880:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205e38 <default_pmm_manager+0xcb8>
ffffffffc0203884:	837fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203888:	00002697          	auipc	a3,0x2
ffffffffc020388c:	5d868693          	addi	a3,a3,1496 # ffffffffc0205e60 <default_pmm_manager+0xce0>
ffffffffc0203890:	00001617          	auipc	a2,0x1
ffffffffc0203894:	54060613          	addi	a2,a2,1344 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203898:	0f600593          	li	a1,246
ffffffffc020389c:	00002517          	auipc	a0,0x2
ffffffffc02038a0:	42c50513          	addi	a0,a0,1068 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc02038a4:	ad1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc02038a8:	147d                	addi	s0,s0,-1
ffffffffc02038aa:	fd2410e3          	bne	s0,s2,ffffffffc020386a <vmm_init+0x18a>
ffffffffc02038ae:	a811                	j	ffffffffc02038c2 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc02038b0:	6118                	ld	a4,0(a0)
ffffffffc02038b2:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02038b4:	03000593          	li	a1,48
ffffffffc02038b8:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02038ba:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02038bc:	e398                	sd	a4,0(a5)
ffffffffc02038be:	f75fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02038c2:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc02038c4:	fea496e3          	bne	s1,a0,ffffffffc02038b0 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02038c8:	03000593          	li	a1,48
ffffffffc02038cc:	8526                	mv	a0,s1
ffffffffc02038ce:	f65fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02038d2:	dc1fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02038d6:	3caa1163          	bne	s4,a0,ffffffffc0203c98 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc02038da:	00002517          	auipc	a0,0x2
ffffffffc02038de:	5c650513          	addi	a0,a0,1478 # ffffffffc0205ea0 <default_pmm_manager+0xd20>
ffffffffc02038e2:	fd8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc02038ea:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02038ec:	03000513          	li	a0,48
ffffffffc02038f0:	e89fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038f4:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02038f6:	2a050163          	beqz	a0,ffffffffc0203b98 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038fa:	0000e797          	auipc	a5,0xe
ffffffffc02038fe:	c567a783          	lw	a5,-938(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc0203902:	e508                	sd	a0,8(a0)
ffffffffc0203904:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc0203906:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc020390a:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc020390e:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203912:	14079063          	bnez	a5,ffffffffc0203a52 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203916:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020391a:	0000e917          	auipc	s2,0xe
ffffffffc020391e:	bfe93903          	ld	s2,-1026(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203922:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203926:	0000e717          	auipc	a4,0xe
ffffffffc020392a:	c4873123          	sd	s0,-958(a4) # ffffffffc0211568 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020392e:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203932:	24079363          	bnez	a5,ffffffffc0203b78 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203936:	03000513          	li	a0,48
ffffffffc020393a:	e3ffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020393e:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203940:	28050063          	beqz	a0,ffffffffc0203bc0 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203944:	002007b7          	lui	a5,0x200
ffffffffc0203948:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc020394c:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc020394e:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203950:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203954:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203956:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc020395a:	c81ff0ef          	jal	ra,ffffffffc02035da <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc020395e:	10000593          	li	a1,256
ffffffffc0203962:	8522                	mv	a0,s0
ffffffffc0203964:	c37ff0ef          	jal	ra,ffffffffc020359a <find_vma>
...
ffffffffc020396c:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203970:	26aa1863          	bne	s4,a0,ffffffffc0203be0 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203974:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203978:	0785                	addi	a5,a5,1
ffffffffc020397a:	fee79de3          	bne	a5,a4,ffffffffc0203974 <vmm_init+0x294>
        sum += i;
ffffffffc020397e:	6705                	lui	a4,0x1
ffffffffc0203980:	10000793          	li	a5,256
ffffffffc0203984:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
...
ffffffffc020398c:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203990:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203992:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203994:	fec79ce3          	bne	a5,a2,ffffffffc020398c <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203998:	26071463          	bnez	a4,ffffffffc0203c00 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020399c:	4581                	li	a1,0
ffffffffc020399e:	854a                	mv	a0,s2
ffffffffc02039a0:	f7dfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039a4:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc02039a8:	0000e717          	auipc	a4,0xe
ffffffffc02039ac:	b7873703          	ld	a4,-1160(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc02039b0:	078a                	slli	a5,a5,0x2
ffffffffc02039b2:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02039b4:	26e7f663          	bgeu	a5,a4,ffffffffc0203c20 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02039b8:	00003717          	auipc	a4,0x3
ffffffffc02039bc:	8b073703          	ld	a4,-1872(a4) # ffffffffc0206268 <nbase>
ffffffffc02039c0:	8f99                	sub	a5,a5,a4
ffffffffc02039c2:	00379713          	slli	a4,a5,0x3
ffffffffc02039c6:	97ba                	add	a5,a5,a4
ffffffffc02039c8:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc02039ca:	0000e517          	auipc	a0,0xe
ffffffffc02039ce:	b5e53503          	ld	a0,-1186(a0) # ffffffffc0211528 <pages>
ffffffffc02039d2:	953e                	add	a0,a0,a5
ffffffffc02039d4:	4585                	li	a1,1
ffffffffc02039d6:	c7dfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc02039da:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc02039dc:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc02039e0:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039e4:	00a40e63          	beq	s0,a0,ffffffffc0203a00 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc02039e8:	6118                	ld	a4,0(a0)
ffffffffc02039ea:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02039ec:	03000593          	li	a1,48
ffffffffc02039f0:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02039f2:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02039f4:	e398                	sd	a4,0(a5)
ffffffffc02039f6:	e3dfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02039fa:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039fc:	fea416e3          	bne	s0,a0,ffffffffc02039e8 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203a00:	03000593          	li	a1,48
ffffffffc0203a04:	8522                	mv	a0,s0
ffffffffc0203a06:	e2dfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203a0a:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc0203a0c:	0000e797          	auipc	a5,0xe
ffffffffc0203a10:	b407be23          	sd	zero,-1188(a5) # ffffffffc0211568 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a14:	c7ffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a18:	22a49063          	bne	s1,a0,ffffffffc0203c38 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a1c:	00002517          	auipc	a0,0x2
ffffffffc0203a20:	4d450513          	addi	a0,a0,1236 # ffffffffc0205ef0 <default_pmm_manager+0xd70>
ffffffffc0203a24:	e96fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a28:	c6bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a2c:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a2e:	22a99563          	bne	s3,a0,ffffffffc0203c58 <vmm_init+0x578>
}
...
ffffffffc0203a48:	4cc50513          	addi	a0,a0,1228 # ffffffffc0205f10 <default_pmm_manager+0xd90>
}
ffffffffc0203a4c:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a4e:	e6cfc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a52:	d32ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203a56:	b5d1                	j	ffffffffc020391a <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a58:	00002697          	auipc	a3,0x2
ffffffffc0203a5c:	2f868693          	addi	a3,a3,760 # ffffffffc0205d50 <default_pmm_manager+0xbd0>
ffffffffc0203a60:	00001617          	auipc	a2,0x1
ffffffffc0203a64:	37060613          	addi	a2,a2,880 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203a68:	0dd00593          	li	a1,221
ffffffffc0203a6c:	00002517          	auipc	a0,0x2
ffffffffc0203a70:	25c50513          	addi	a0,a0,604 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203a74:	901fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a78:	00002697          	auipc	a3,0x2
ffffffffc0203a7c:	39068693          	addi	a3,a3,912 # ffffffffc0205e08 <default_pmm_manager+0xc88>
ffffffffc0203a80:	00001617          	auipc	a2,0x1
ffffffffc0203a84:	35060613          	addi	a2,a2,848 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203a88:	0ee00593          	li	a1,238
ffffffffc0203a8c:	00002517          	auipc	a0,0x2
ffffffffc0203a90:	23c50513          	addi	a0,a0,572 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203a94:	8e1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a98:	00002697          	auipc	a3,0x2
ffffffffc0203a9c:	34068693          	addi	a3,a3,832 # ffffffffc0205dd8 <default_pmm_manager+0xc58>
ffffffffc0203aa0:	00001617          	auipc	a2,0x1
ffffffffc0203aa4:	33060613          	addi	a2,a2,816 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203aa8:	0ed00593          	li	a1,237
ffffffffc0203aac:	00002517          	auipc	a0,0x2
ffffffffc0203ab0:	21c50513          	addi	a0,a0,540 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203ab4:	8c1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203ab8:	00002697          	auipc	a3,0x2
ffffffffc0203abc:	28068693          	addi	a3,a3,640 # ffffffffc0205d38 <default_pmm_manager+0xbb8>
ffffffffc0203ac0:	00001617          	auipc	a2,0x1
ffffffffc0203ac4:	31060613          	addi	a2,a2,784 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203ac8:	0db00593          	li	a1,219
ffffffffc0203acc:	00002517          	auipc	a0,0x2
ffffffffc0203ad0:	1fc50513          	addi	a0,a0,508 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203ad4:	8a1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203ad8:	00002697          	auipc	a3,0x2
ffffffffc0203adc:	2b068693          	addi	a3,a3,688 # ffffffffc0205d88 <default_pmm_manager+0xc08>
ffffffffc0203ae0:	00001617          	auipc	a2,0x1
ffffffffc0203ae4:	2f060613          	addi	a2,a2,752 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203ae8:	0e300593          	li	a1,227
ffffffffc0203aec:	00002517          	auipc	a0,0x2
ffffffffc0203af0:	1dc50513          	addi	a0,a0,476 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203af4:	881fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203af8:	00002697          	auipc	a3,0x2
ffffffffc0203afc:	2a068693          	addi	a3,a3,672 # ffffffffc0205d98 <default_pmm_manager+0xc18>
ffffffffc0203b00:	00001617          	auipc	a2,0x1
ffffffffc0203b04:	2d060613          	addi	a2,a2,720 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203b08:	0e500593          	li	a1,229
ffffffffc0203b0c:	00002517          	auipc	a0,0x2
ffffffffc0203b10:	1bc50513          	addi	a0,a0,444 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203b14:	861fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b18:	00002697          	auipc	a3,0x2
ffffffffc0203b1c:	29068693          	addi	a3,a3,656 # ffffffffc0205da8 <default_pmm_manager+0xc28>
ffffffffc0203b20:	00001617          	auipc	a2,0x1
ffffffffc0203b24:	2b060613          	addi	a2,a2,688 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203b28:	0e700593          	li	a1,231
ffffffffc0203b2c:	00002517          	auipc	a0,0x2
ffffffffc0203b30:	19c50513          	addi	a0,a0,412 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203b34:	841fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b38:	00002697          	auipc	a3,0x2
ffffffffc0203b3c:	28068693          	addi	a3,a3,640 # ffffffffc0205db8 <default_pmm_manager+0xc38>
ffffffffc0203b40:	00001617          	auipc	a2,0x1
ffffffffc0203b44:	29060613          	addi	a2,a2,656 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203b48:	0e900593          	li	a1,233
ffffffffc0203b4c:	00002517          	auipc	a0,0x2
ffffffffc0203b50:	17c50513          	addi	a0,a0,380 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203b54:	821fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b58:	00002697          	auipc	a3,0x2
ffffffffc0203b5c:	27068693          	addi	a3,a3,624 # ffffffffc0205dc8 <default_pmm_manager+0xc48>
ffffffffc0203b60:	00001617          	auipc	a2,0x1
ffffffffc0203b64:	27060613          	addi	a2,a2,624 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203b68:	0eb00593          	li	a1,235
ffffffffc0203b6c:	00002517          	auipc	a0,0x2
ffffffffc0203b70:	15c50513          	addi	a0,a0,348 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203b74:	801fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b78:	00002697          	auipc	a3,0x2
ffffffffc0203b7c:	d2868693          	addi	a3,a3,-728 # ffffffffc02058a0 <default_pmm_manager+0x720>
ffffffffc0203b80:	00001617          	auipc	a2,0x1
ffffffffc0203b84:	25060613          	addi	a2,a2,592 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203b88:	10d00593          	li	a1,269
ffffffffc0203b8c:	00002517          	auipc	a0,0x2
ffffffffc0203b90:	13c50513          	addi	a0,a0,316 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203b94:	fe0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b98:	00002697          	auipc	a3,0x2
ffffffffc0203b9c:	39068693          	addi	a3,a3,912 # ffffffffc0205f28 <default_pmm_manager+0xda8>
ffffffffc0203ba0:	00001617          	auipc	a2,0x1
ffffffffc0203ba4:	23060613          	addi	a2,a2,560 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203ba8:	10a00593          	li	a1,266
ffffffffc0203bac:	00002517          	auipc	a0,0x2
ffffffffc0203bb0:	11c50513          	addi	a0,a0,284 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
    check_mm_struct = mm_create();
ffffffffc0203bb4:	0000e797          	auipc	a5,0xe
ffffffffc0203bb8:	9a07ba23          	sd	zero,-1612(a5) # ffffffffc0211568 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203bbc:	fb8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203bc0:	00002697          	auipc	a3,0x2
ffffffffc0203bc4:	cf068693          	addi	a3,a3,-784 # ffffffffc02058b0 <default_pmm_manager+0x730>
ffffffffc0203bc8:	00001617          	auipc	a2,0x1
ffffffffc0203bcc:	20860613          	addi	a2,a2,520 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203bd0:	11100593          	li	a1,273
ffffffffc0203bd4:	00002517          	auipc	a0,0x2
ffffffffc0203bd8:	0f450513          	addi	a0,a0,244 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203bdc:	f98fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203be0:	00002697          	auipc	a3,0x2
ffffffffc0203be4:	2e068693          	addi	a3,a3,736 # ffffffffc0205ec0 <default_pmm_manager+0xd40>
ffffffffc0203be8:	00001617          	auipc	a2,0x1
ffffffffc0203bec:	1e860613          	addi	a2,a2,488 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203bf0:	11600593          	li	a1,278
ffffffffc0203bf4:	00002517          	auipc	a0,0x2
ffffffffc0203bf8:	0d450513          	addi	a0,a0,212 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203bfc:	f78fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203c00:	00002697          	auipc	a3,0x2
ffffffffc0203c04:	2e068693          	addi	a3,a3,736 # ffffffffc0205ee0 <default_pmm_manager+0xd60>
ffffffffc0203c08:	00001617          	auipc	a2,0x1
ffffffffc0203c0c:	1c860613          	addi	a2,a2,456 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203c10:	12000593          	li	a1,288
ffffffffc0203c14:	00002517          	auipc	a0,0x2
ffffffffc0203c18:	0b450513          	addi	a0,a0,180 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203c1c:	f58fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c20:	00001617          	auipc	a2,0x1
ffffffffc0203c24:	59860613          	addi	a2,a2,1432 # ffffffffc02051b8 <default_pmm_manager+0x38>
ffffffffc0203c28:	06800593          	li	a1,104
ffffffffc0203c2c:	00001517          	auipc	a0,0x1
ffffffffc0203c30:	5ac50513          	addi	a0,a0,1452 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc0203c34:	f40fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c38:	00002697          	auipc	a3,0x2
ffffffffc0203c3c:	24068693          	addi	a3,a3,576 # ffffffffc0205e78 <default_pmm_manager+0xcf8>
ffffffffc0203c40:	00001617          	auipc	a2,0x1
ffffffffc0203c44:	19060613          	addi	a2,a2,400 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203c48:	12e00593          	li	a1,302
ffffffffc0203c4c:	00002517          	auipc	a0,0x2
ffffffffc0203c50:	07c50513          	addi	a0,a0,124 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203c54:	f20fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c58:	00002697          	auipc	a3,0x2
ffffffffc0203c5c:	22068693          	addi	a3,a3,544 # ffffffffc0205e78 <default_pmm_manager+0xcf8>
ffffffffc0203c60:	00001617          	auipc	a2,0x1
ffffffffc0203c64:	17060613          	addi	a2,a2,368 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203c68:	0bd00593          	li	a1,189
ffffffffc0203c6c:	00002517          	auipc	a0,0x2
ffffffffc0203c70:	05c50513          	addi	a0,a0,92 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203c74:	f00fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c78:	00002697          	auipc	a3,0x2
ffffffffc0203c7c:	c0068693          	addi	a3,a3,-1024 # ffffffffc0205878 <default_pmm_manager+0x6f8>
ffffffffc0203c80:	00001617          	auipc	a2,0x1
ffffffffc0203c84:	15060613          	addi	a2,a2,336 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203c88:	0c700593          	li	a1,199
ffffffffc0203c8c:	00002517          	auipc	a0,0x2
ffffffffc0203c90:	03c50513          	addi	a0,a0,60 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203c94:	ee0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c98:	00002697          	auipc	a3,0x2
ffffffffc0203c9c:	1e068693          	addi	a3,a3,480 # ffffffffc0205e78 <default_pmm_manager+0xcf8>
ffffffffc0203ca0:	00001617          	auipc	a2,0x1
ffffffffc0203ca4:	13060613          	addi	a2,a2,304 # ffffffffc0204dd0 <commands+0x738>
ffffffffc0203ca8:	0fb00593          	li	a1,251
ffffffffc0203cac:	00002517          	auipc	a0,0x2
ffffffffc0203cb0:	01c50513          	addi	a0,a0,28 # ffffffffc0205cc8 <default_pmm_manager+0xb48>
ffffffffc0203cb4:	ec0fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203cb8 <do_pgfault>:
...
ffffffffc0203cba:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203cbc:	f022                	sd	s0,32(sp)
ffffffffc0203cbe:	ec26                	sd	s1,24(sp)
ffffffffc0203cc0:	f406                	sd	ra,40(sp)
ffffffffc0203cc2:	e84a                	sd	s2,16(sp)
ffffffffc0203cc4:	8432                	mv	s0,a2
ffffffffc0203cc6:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203cc8:	8d3ff0ef          	jal	ra,ffffffffc020359a <find_vma>

    pgfault_num++;
ffffffffc0203ccc:	0000e797          	auipc	a5,0xe
ffffffffc0203cd0:	8a47a783          	lw	a5,-1884(a5) # ffffffffc0211570 <pgfault_num>
ffffffffc0203cd4:	2785                	addiw	a5,a5,1
ffffffffc0203cd6:	0000e717          	auipc	a4,0xe
ffffffffc0203cda:	88f72d23          	sw	a5,-1894(a4) # ffffffffc0211570 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203cde:	c159                	beqz	a0,ffffffffc0203d64 <do_pgfault+0xac>
ffffffffc0203ce0:	651c                	ld	a5,8(a0)
ffffffffc0203ce2:	08f46163          	bltu	s0,a5,ffffffffc0203d64 <do_pgfault+0xac>
...
ffffffffc0203ce6:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203ce8:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203cea:	8b89                	andi	a5,a5,2
ffffffffc0203cec:	ebb1                	bnez	a5,ffffffffc0203d40 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203cee:	75fd                	lui	a1,0xfffff
...
ffffffffc0203cf0:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203cf2:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203cf4:	85a2                	mv	a1,s0
ffffffffc0203cf6:	4605                	li	a2,1
ffffffffc0203cf8:	9d5fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203cfc:	610c                	ld	a1,0(a0)
ffffffffc0203cfe:	c1b9                	beqz	a1,ffffffffc0203d44 <do_pgfault+0x8c>
...
ffffffffc0203d04:	8507a783          	lw	a5,-1968(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203d08:	c7bd                	beqz	a5,ffffffffc0203d76 <do_pgfault+0xbe>
...
ffffffffc0203d10:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);  
ffffffffc0203d12:	b9eff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203d16:	65a2                	ld	a1,8(sp)
ffffffffc0203d18:	6c88                	ld	a0,24(s1)
ffffffffc0203d1a:	86ca                	mv	a3,s2
...
ffffffffc0203d30:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203d32:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203d34:	70a2                	ld	ra,40(sp)
ffffffffc0203d36:	7402                	ld	s0,32(sp)
ffffffffc0203d38:	64e2                	ld	s1,24(sp)
ffffffffc0203d3a:	6942                	ld	s2,16(sp)
ffffffffc0203d3c:	6145                	addi	sp,sp,48
ffffffffc0203d3e:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d40:	4959                	li	s2,22
ffffffffc0203d42:	b775                	j	ffffffffc0203cee <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d44:	6c88                	ld	a0,24(s1)
ffffffffc0203d46:	864a                	mv	a2,s2
ffffffffc0203d48:	85a2                	mv	a1,s0
ffffffffc0203d4a:	977fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203d4e:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203d50:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d52:	f3ed                	bnez	a5,ffffffffc0203d34 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d54:	00002517          	auipc	a0,0x2
ffffffffc0203d58:	21c50513          	addi	a0,a0,540 # ffffffffc0205f70 <default_pmm_manager+0xdf0>
ffffffffc0203d5c:	b5efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d60:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d62:	bfc9                	j	ffffffffc0203d34 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d64:	85a2                	mv	a1,s0
ffffffffc0203d66:	00002517          	auipc	a0,0x2
ffffffffc0203d6a:	1da50513          	addi	a0,a0,474 # ffffffffc0205f40 <default_pmm_manager+0xdc0>
ffffffffc0203d6e:	b4cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d72:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d74:	b7c1                	j	ffffffffc0203d34 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d76:	00002517          	auipc	a0,0x2
ffffffffc0203d7a:	22250513          	addi	a0,a0,546 # ffffffffc0205f98 <default_pmm_manager+0xe18>
ffffffffc0203d7e:	b3cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d82:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d84:	bf45                	j	ffffffffc0203d34 <do_pgfault+0x7c>

ffffffffc0203d86 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
swapfs_init(void) {
ffffffffc0203d8a:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d8c:	f08fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d90:	cd01                	beqz	a0,ffffffffc0203da8 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }

    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d92:	4505                	li	a0,1
ffffffffc0203d94:	f06fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d98:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d9a:	810d                	srli	a0,a0,0x3
ffffffffc0203d9c:	0000d797          	auipc	a5,0xd
ffffffffc0203da0:	7aa7b223          	sd	a0,1956(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203da4:	0141                	addi	sp,sp,16
ffffffffc0203da6:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203da8:	00002617          	auipc	a2,0x2
ffffffffc0203dac:	21860613          	addi	a2,a2,536 # ffffffffc0205fc0 <default_pmm_manager+0xe40>
ffffffffc0203db0:	45b5                	li	a1,13
ffffffffc0203db2:	00002517          	auipc	a0,0x2
ffffffffc0203db6:	22e50513          	addi	a0,a0,558 # ffffffffc0205fe0 <default_pmm_manager+0xe60>
ffffffffc0203dba:	dbafc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dbe <swapfs_read>:
...
ffffffffc0203dc2:	00855793          	srli	a5,a0,0x8
ffffffffc0203dc6:	c3a5                	beqz	a5,ffffffffc0203e26 <swapfs_read+0x68>
ffffffffc0203dc8:	0000d717          	auipc	a4,0xd
ffffffffc0203dcc:	77873703          	ld	a4,1912(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203dd0:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e26 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203dd4:	0000d617          	auipc	a2,0xd
ffffffffc0203dd8:	75463603          	ld	a2,1876(a2) # ffffffffc0211528 <pages>
ffffffffc0203ddc:	8d91                	sub	a1,a1,a2
ffffffffc0203dde:	4035d613          	srai	a2,a1,0x3
ffffffffc0203de2:	00002597          	auipc	a1,0x2
ffffffffc0203de6:	47e5b583          	ld	a1,1150(a1) # ffffffffc0206260 <error_string+0x38>
ffffffffc0203dea:	02b60633          	mul	a2,a2,a1
ffffffffc0203dee:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203df2:	00002797          	auipc	a5,0x2
ffffffffc0203df6:	4767b783          	ld	a5,1142(a5) # ffffffffc0206268 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dfa:	0000d717          	auipc	a4,0xd
ffffffffc0203dfe:	72673703          	ld	a4,1830(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e02:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e04:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e08:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e0a:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e0c:	02e7f963          	bgeu	a5,a4,ffffffffc0203e3e <swapfs_read+0x80>
}
ffffffffc0203e10:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e12:	0000d797          	auipc	a5,0xd
ffffffffc0203e16:	7267b783          	ld	a5,1830(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e1a:	46a1                	li	a3,8
ffffffffc0203e1c:	963e                	add	a2,a2,a5
ffffffffc0203e1e:	4505                	li	a0,1
}
ffffffffc0203e20:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e22:	e7efc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e26:	86aa                	mv	a3,a0
ffffffffc0203e28:	00002617          	auipc	a2,0x2
ffffffffc0203e2c:	1d060613          	addi	a2,a2,464 # ffffffffc0205ff8 <default_pmm_manager+0xe78>
ffffffffc0203e30:	45d5                	li	a1,21
ffffffffc0203e32:	00002517          	auipc	a0,0x2
ffffffffc0203e36:	1ae50513          	addi	a0,a0,430 # ffffffffc0205fe0 <default_pmm_manager+0xe60>
ffffffffc0203e3a:	d3afc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e3e:	86b2                	mv	a3,a2
ffffffffc0203e40:	06d00593          	li	a1,109
ffffffffc0203e44:	00001617          	auipc	a2,0x1
ffffffffc0203e48:	3cc60613          	addi	a2,a2,972 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc0203e4c:	00001517          	auipc	a0,0x1
ffffffffc0203e50:	38c50513          	addi	a0,a0,908 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc0203e54:	d20fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e58 <swapfs_write>:
...
ffffffffc0203e5c:	00855793          	srli	a5,a0,0x8
ffffffffc0203e60:	c3a5                	beqz	a5,ffffffffc0203ec0 <swapfs_write+0x68>
ffffffffc0203e62:	0000d717          	auipc	a4,0xd
ffffffffc0203e66:	6de73703          	ld	a4,1758(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e6a:	04e7fb63          	bgeu	a5,a4,ffffffffc0203ec0 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e6e:	0000d617          	auipc	a2,0xd
ffffffffc0203e72:	6ba63603          	ld	a2,1722(a2) # ffffffffc0211528 <pages>
ffffffffc0203e76:	8d91                	sub	a1,a1,a2
ffffffffc0203e78:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e7c:	00002597          	auipc	a1,0x2
ffffffffc0203e80:	3e45b583          	ld	a1,996(a1) # ffffffffc0206260 <error_string+0x38>
ffffffffc0203e84:	02b60633          	mul	a2,a2,a1
ffffffffc0203e88:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e8c:	00002797          	auipc	a5,0x2
ffffffffc0203e90:	3dc7b783          	ld	a5,988(a5) # ffffffffc0206268 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e94:	0000d717          	auipc	a4,0xd
ffffffffc0203e98:	68c73703          	ld	a4,1676(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e9c:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e9e:	00c61793          	slli	a5,a2,0xc
ffffffffc0203ea2:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203ea4:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ea6:	02e7f963          	bgeu	a5,a4,ffffffffc0203ed8 <swapfs_write+0x80>
}
ffffffffc0203eaa:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203eac:	0000d797          	auipc	a5,0xd
ffffffffc0203eb0:	68c7b783          	ld	a5,1676(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203eba:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ebc:	e08fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203ec0:	86aa                	mv	a3,a0
ffffffffc0203ec2:	00002617          	auipc	a2,0x2
ffffffffc0203ec6:	13660613          	addi	a2,a2,310 # ffffffffc0205ff8 <default_pmm_manager+0xe78>
ffffffffc0203eca:	45e9                	li	a1,26
ffffffffc0203ecc:	00002517          	auipc	a0,0x2
ffffffffc0203ed0:	11450513          	addi	a0,a0,276 # ffffffffc0205fe0 <default_pmm_manager+0xe60>
ffffffffc0203ed4:	ca0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203ed8:	86b2                	mv	a3,a2
ffffffffc0203eda:	06d00593          	li	a1,109
ffffffffc0203ede:	00001617          	auipc	a2,0x1
ffffffffc0203ee2:	33260613          	addi	a2,a2,818 # ffffffffc0205210 <default_pmm_manager+0x90>
ffffffffc0203ee6:	00001517          	auipc	a0,0x1
ffffffffc0203eea:	2f250513          	addi	a0,a0,754 # ffffffffc02051d8 <default_pmm_manager+0x58>
ffffffffc0203eee:	c86fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203ef2 <printnum>:
 * */
static void
...
ffffffffc0203ef2:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ef6:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203ef8:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203efc:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203efe:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203f02:	f022                	sd	s0,32(sp)
ffffffffc0203f04:	ec26                	sd	s1,24(sp)
ffffffffc0203f06:	e84a                	sd	s2,16(sp)
ffffffffc0203f08:	f406                	sd	ra,40(sp)
ffffffffc0203f0a:	e44e                	sd	s3,8(sp)
ffffffffc0203f0c:	84aa                	mv	s1,a0
ffffffffc0203f0e:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203f10:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203f14:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203f16:	03067e63          	bgeu	a2,a6,ffffffffc0203f52 <printnum+0x60>
ffffffffc0203f1a:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203f1c:	00805763          	blez	s0,ffffffffc0203f2a <printnum+0x38>
ffffffffc0203f20:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203f22:	85ca                	mv	a1,s2
ffffffffc0203f24:	854e                	mv	a0,s3
ffffffffc0203f26:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203f28:	fc65                	bnez	s0,ffffffffc0203f20 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f2a:	1a02                	slli	s4,s4,0x20
ffffffffc0203f2c:	00002797          	auipc	a5,0x2
ffffffffc0203f30:	0ec78793          	addi	a5,a5,236 # ffffffffc0206018 <default_pmm_manager+0xe98>
ffffffffc0203f34:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f38:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f3a:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f3c:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f40:	70a2                	ld	ra,40(sp)
ffffffffc0203f42:	69a2                	ld	s3,8(sp)
ffffffffc0203f44:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f46:	85ca                	mv	a1,s2
ffffffffc0203f48:	87a6                	mv	a5,s1
}
ffffffffc0203f4a:	6942                	ld	s2,16(sp)
ffffffffc0203f4c:	64e2                	ld	s1,24(sp)
ffffffffc0203f4e:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f50:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203f52:	03065633          	divu	a2,a2,a6
ffffffffc0203f56:	8722                	mv	a4,s0
ffffffffc0203f58:	f9bff0ef          	jal	ra,ffffffffc0203ef2 <printnum>
ffffffffc0203f5c:	b7f9                	j	ffffffffc0203f2a <printnum+0x38>

ffffffffc0203f5e <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f5e:	7119                	addi	sp,sp,-128
ffffffffc0203f60:	f4a6                	sd	s1,104(sp)
ffffffffc0203f62:	f0ca                	sd	s2,96(sp)
ffffffffc0203f64:	ecce                	sd	s3,88(sp)
ffffffffc0203f66:	e8d2                	sd	s4,80(sp)
ffffffffc0203f68:	e4d6                	sd	s5,72(sp)
ffffffffc0203f6a:	e0da                	sd	s6,64(sp)
ffffffffc0203f6c:	fc5e                	sd	s7,56(sp)
ffffffffc0203f6e:	f06a                	sd	s10,32(sp)
ffffffffc0203f70:	fc86                	sd	ra,120(sp)
ffffffffc0203f72:	f8a2                	sd	s0,112(sp)
ffffffffc0203f74:	f862                	sd	s8,48(sp)
ffffffffc0203f76:	f466                	sd	s9,40(sp)
ffffffffc0203f78:	ec6e                	sd	s11,24(sp)
ffffffffc0203f7a:	892a                	mv	s2,a0
ffffffffc0203f7c:	84ae                	mv	s1,a1
ffffffffc0203f7e:	8d32                	mv	s10,a2
ffffffffc0203f80:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f82:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f86:	5b7d                	li	s6,-1
ffffffffc0203f88:	00002a97          	auipc	s5,0x2
ffffffffc0203f8c:	0c4a8a93          	addi	s5,s5,196 # ffffffffc020604c <default_pmm_manager+0xecc>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f90:	00002b97          	auipc	s7,0x2
ffffffffc0203f94:	298b8b93          	addi	s7,s7,664 # ffffffffc0206228 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f98:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f9c:	001d0413          	addi	s0,s10,1
ffffffffc0203fa0:	01350a63          	beq	a0,s3,ffffffffc0203fb4 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203fa4:	c121                	beqz	a0,ffffffffc0203fe4 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203fa6:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fa8:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203faa:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203fac:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203fb0:	ff351ae3          	bne	a0,s3,ffffffffc0203fa4 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fb4:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203fb8:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203fbc:	4c81                	li	s9,0
ffffffffc0203fbe:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203fc0:	5c7d                	li	s8,-1
ffffffffc0203fc2:	5dfd                	li	s11,-1
ffffffffc0203fc4:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203fc8:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fca:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fce:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fd2:	00140d13          	addi	s10,s0,1
ffffffffc0203fd6:	04b56263          	bltu	a0,a1,ffffffffc020401a <vprintfmt+0xbc>
ffffffffc0203fda:	058a                	slli	a1,a1,0x2
ffffffffc0203fdc:	95d6                	add	a1,a1,s5
ffffffffc0203fde:	4194                	lw	a3,0(a1)
ffffffffc0203fe0:	96d6                	add	a3,a3,s5
ffffffffc0203fe2:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203fe4:	70e6                	ld	ra,120(sp)
ffffffffc0203fe6:	7446                	ld	s0,112(sp)
ffffffffc0203fe8:	74a6                	ld	s1,104(sp)
ffffffffc0203fea:	7906                	ld	s2,96(sp)
ffffffffc0203fec:	69e6                	ld	s3,88(sp)
ffffffffc0203fee:	6a46                	ld	s4,80(sp)
ffffffffc0203ff0:	6aa6                	ld	s5,72(sp)
ffffffffc0203ff2:	6b06                	ld	s6,64(sp)
ffffffffc0203ff4:	7be2                	ld	s7,56(sp)
ffffffffc0203ff6:	7c42                	ld	s8,48(sp)
ffffffffc0203ff8:	7ca2                	ld	s9,40(sp)
ffffffffc0203ffa:	7d02                	ld	s10,32(sp)
ffffffffc0203ffc:	6de2                	ld	s11,24(sp)
ffffffffc0203ffe:	6109                	addi	sp,sp,128
ffffffffc0204000:	8082                	ret
            padc = '0';
ffffffffc0204002:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204004:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204008:	846a                	mv	s0,s10
ffffffffc020400a:	00140d13          	addi	s10,s0,1
ffffffffc020400e:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204012:	0ff5f593          	zext.b	a1,a1
ffffffffc0204016:	fcb572e3          	bgeu	a0,a1,ffffffffc0203fda <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020401a:	85a6                	mv	a1,s1
ffffffffc020401c:	02500513          	li	a0,37
ffffffffc0204020:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204022:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204026:	8d22                	mv	s10,s0
ffffffffc0204028:	f73788e3          	beq	a5,s3,ffffffffc0203f98 <vprintfmt+0x3a>
ffffffffc020402c:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204030:	1d7d                	addi	s10,s10,-1
ffffffffc0204032:	ff379de3          	bne	a5,s3,ffffffffc020402c <vprintfmt+0xce>
ffffffffc0204036:	b78d                	j	ffffffffc0203f98 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204038:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0204046:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020404a:	02d86463          	bltu	a6,a3,ffffffffc0204072 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc020404e:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204052:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204056:	0186873b          	addw	a4,a3,s8
ffffffffc020405a:	0017171b          	slliw	a4,a4,0x1
ffffffffc020405e:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204060:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204064:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204066:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020406a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020406e:	fed870e3          	bgeu	a6,a3,ffffffffc020404e <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204072:	f40ddce3          	bgez	s11,ffffffffc0203fca <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204076:	8de2                	mv	s11,s8
ffffffffc0204078:	5c7d                	li	s8,-1
ffffffffc020407a:	bf81                	j	ffffffffc0203fca <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020407c:	fffdc693          	not	a3,s11
ffffffffc0204080:	96fd                	srai	a3,a3,0x3f
ffffffffc0204082:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204086:	00144603          	lbu	a2,1(s0)
ffffffffc020408a:	2d81                	sext.w	s11,s11
ffffffffc020408c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020408e:	bf35                	j	ffffffffc0203fca <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204090:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc020409c:	bfd9                	j	ffffffffc0204072 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020409e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040a0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040a4:	01174463          	blt	a4,a7,ffffffffc02040ac <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02040a8:	1a088e63          	beqz	a7,ffffffffc0204264 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02040ac:	000a3603          	ld	a2,0(s4)
ffffffffc02040b0:	46c1                	li	a3,16
ffffffffc02040b2:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02040b4:	2781                	sext.w	a5,a5
ffffffffc02040b6:	876e                	mv	a4,s11
ffffffffc02040b8:	85a6                	mv	a1,s1
ffffffffc02040ba:	854a                	mv	a0,s2
ffffffffc02040bc:	e37ff0ef          	jal	ra,ffffffffc0203ef2 <printnum>
            break;
ffffffffc02040c0:	bde1                	j	ffffffffc0203f98 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02040c2:	000a2503          	lw	a0,0(s4)
ffffffffc02040c6:	85a6                	mv	a1,s1
ffffffffc02040c8:	0a21                	addi	s4,s4,8
ffffffffc02040ca:	9902                	jalr	s2
            break;
ffffffffc02040cc:	b5f1                	j	ffffffffc0203f98 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02040ce:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040d0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040d4:	01174463          	blt	a4,a7,ffffffffc02040dc <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02040d8:	18088163          	beqz	a7,ffffffffc020425a <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02040dc:	000a3603          	ld	a2,0(s4)
ffffffffc02040e0:	46a9                	li	a3,10
ffffffffc02040e2:	8a2e                	mv	s4,a1
ffffffffc02040e4:	bfc1                	j	ffffffffc02040b4 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040e6:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02040ea:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040ec:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040ee:	bdf1                	j	ffffffffc0203fca <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02040f0:	85a6                	mv	a1,s1
ffffffffc02040f2:	02500513          	li	a0,37
ffffffffc02040f6:	9902                	jalr	s2
            break;
ffffffffc02040f8:	b545                	j	ffffffffc0203f98 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040fa:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040fe:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204100:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204102:	b5e1                	j	ffffffffc0203fca <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204104:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204106:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020410a:	01174463          	blt	a4,a7,ffffffffc0204112 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020410e:	14088163          	beqz	a7,ffffffffc0204250 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204112:	000a3603          	ld	a2,0(s4)
ffffffffc0204116:	46a1                	li	a3,8
ffffffffc0204118:	8a2e                	mv	s4,a1
ffffffffc020411a:	bf69                	j	ffffffffc02040b4 <vprintfmt+0x156>
            putch('0', putdat);
...
ffffffffc0204128:	07800513          	li	a0,120
ffffffffc020412c:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc020412e:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204130:	6782                	ld	a5,0(sp)
ffffffffc0204132:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204134:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204138:	bfb5                	j	ffffffffc02040b4 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020413a:	000a3403          	ld	s0,0(s4)
ffffffffc020413e:	008a0713          	addi	a4,s4,8
ffffffffc0204142:	e03a                	sd	a4,0(sp)
ffffffffc0204144:	14040263          	beqz	s0,ffffffffc0204288 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204148:	0fb05763          	blez	s11,ffffffffc0204236 <vprintfmt+0x2d8>
ffffffffc020414c:	02d00693          	li	a3,45
ffffffffc0204150:	0cd79163          	bne	a5,a3,ffffffffc0204212 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204154:	00044783          	lbu	a5,0(s0)
ffffffffc0204158:	0007851b          	sext.w	a0,a5
ffffffffc020415c:	cf85                	beqz	a5,ffffffffc0204194 <vprintfmt+0x236>
ffffffffc020415e:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204162:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204166:	000c4563          	bltz	s8,ffffffffc0204170 <vprintfmt+0x212>
ffffffffc020416a:	3c7d                	addiw	s8,s8,-1
ffffffffc020416c:	036c0263          	beq	s8,s6,ffffffffc0204190 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204170:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204172:	0e0c8e63          	beqz	s9,ffffffffc020426e <vprintfmt+0x310>
ffffffffc0204176:	3781                	addiw	a5,a5,-32
ffffffffc0204178:	0ef47b63          	bgeu	s0,a5,ffffffffc020426e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020417c:	03f00513          	li	a0,63
ffffffffc0204180:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204182:	000a4783          	lbu	a5,0(s4)
ffffffffc0204186:	3dfd                	addiw	s11,s11,-1
ffffffffc0204188:	0a05                	addi	s4,s4,1
ffffffffc020418a:	0007851b          	sext.w	a0,a5
ffffffffc020418e:	ffe1                	bnez	a5,ffffffffc0204166 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204190:	01b05963          	blez	s11,ffffffffc02041a2 <vprintfmt+0x244>
ffffffffc0204194:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204196:	85a6                	mv	a1,s1
ffffffffc0204198:	02000513          	li	a0,32
ffffffffc020419c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020419e:	fe0d9be3          	bnez	s11,ffffffffc0204194 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02041a2:	6a02                	ld	s4,0(sp)
ffffffffc02041a4:	bbd5                	j	ffffffffc0203f98 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02041a6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02041a8:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02041ac:	01174463          	blt	a4,a7,ffffffffc02041b4 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02041b0:	08088d63          	beqz	a7,ffffffffc020424a <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02041b4:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02041b8:	0a044d63          	bltz	s0,ffffffffc0204272 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02041bc:	8622                	mv	a2,s0
ffffffffc02041be:	8a66                	mv	s4,s9
ffffffffc02041c0:	46a9                	li	a3,10
ffffffffc02041c2:	bdcd                	j	ffffffffc02040b4 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02041c4:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02041c8:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc02041ca:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02041cc:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02041d0:	8fb5                	xor	a5,a5,a3
ffffffffc02041d2:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02041d6:	02d74163          	blt	a4,a3,ffffffffc02041f8 <vprintfmt+0x29a>
ffffffffc02041da:	00369793          	slli	a5,a3,0x3
ffffffffc02041de:	97de                	add	a5,a5,s7
ffffffffc02041e0:	639c                	ld	a5,0(a5)
ffffffffc02041e2:	cb99                	beqz	a5,ffffffffc02041f8 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02041e4:	86be                	mv	a3,a5
ffffffffc02041e6:	00002617          	auipc	a2,0x2
ffffffffc02041ea:	e6260613          	addi	a2,a2,-414 # ffffffffc0206048 <default_pmm_manager+0xec8>
ffffffffc02041ee:	85a6                	mv	a1,s1
ffffffffc02041f0:	854a                	mv	a0,s2
ffffffffc02041f2:	0ce000ef          	jal	ra,ffffffffc02042c0 <printfmt>
ffffffffc02041f6:	b34d                	j	ffffffffc0203f98 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02041f8:	00002617          	auipc	a2,0x2
ffffffffc02041fc:	e4060613          	addi	a2,a2,-448 # ffffffffc0206038 <default_pmm_manager+0xeb8>
ffffffffc0204200:	85a6                	mv	a1,s1
ffffffffc0204202:	854a                	mv	a0,s2
ffffffffc0204204:	0bc000ef          	jal	ra,ffffffffc02042c0 <printfmt>
ffffffffc0204208:	bb41                	j	ffffffffc0203f98 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020420a:	00002417          	auipc	s0,0x2
ffffffffc020420e:	e2640413          	addi	s0,s0,-474 # ffffffffc0206030 <default_pmm_manager+0xeb0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204212:	85e2                	mv	a1,s8
ffffffffc0204214:	8522                	mv	a0,s0
ffffffffc0204216:	e43e                	sd	a5,8(sp)
ffffffffc0204218:	196000ef          	jal	ra,ffffffffc02043ae <strnlen>
ffffffffc020421c:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204220:	01b05b63          	blez	s11,ffffffffc0204236 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204224:	67a2                	ld	a5,8(sp)
ffffffffc0204226:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020422a:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020422c:	85a6                	mv	a1,s1
ffffffffc020422e:	8552                	mv	a0,s4
ffffffffc0204230:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204232:	fe0d9ce3          	bnez	s11,ffffffffc020422a <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204236:	00044783          	lbu	a5,0(s0)
ffffffffc020423a:	00140a13          	addi	s4,s0,1
ffffffffc020423e:	0007851b          	sext.w	a0,a5
ffffffffc0204242:	d3a5                	beqz	a5,ffffffffc02041a2 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204244:	05e00413          	li	s0,94
ffffffffc0204248:	bf39                	j	ffffffffc0204166 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc020424a:	000a2403          	lw	s0,0(s4)
ffffffffc020424e:	b7ad                	j	ffffffffc02041b8 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204250:	000a6603          	lwu	a2,0(s4)
ffffffffc0204254:	46a1                	li	a3,8
ffffffffc0204256:	8a2e                	mv	s4,a1
ffffffffc0204258:	bdb1                	j	ffffffffc02040b4 <vprintfmt+0x156>
ffffffffc020425a:	000a6603          	lwu	a2,0(s4)
ffffffffc020425e:	46a9                	li	a3,10
ffffffffc0204260:	8a2e                	mv	s4,a1
ffffffffc0204262:	bd89                	j	ffffffffc02040b4 <vprintfmt+0x156>
ffffffffc0204264:	000a6603          	lwu	a2,0(s4)
ffffffffc0204268:	46c1                	li	a3,16
ffffffffc020426a:	8a2e                	mv	s4,a1
ffffffffc020426c:	b5a1                	j	ffffffffc02040b4 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020426e:	9902                	jalr	s2
ffffffffc0204270:	bf09                	j	ffffffffc0204182 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204272:	85a6                	mv	a1,s1
ffffffffc0204274:	02d00513          	li	a0,45
ffffffffc0204278:	e03e                	sd	a5,0(sp)
ffffffffc020427a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020427c:	6782                	ld	a5,0(sp)
ffffffffc020427e:	8a66                	mv	s4,s9
ffffffffc0204280:	40800633          	neg	a2,s0
ffffffffc0204284:	46a9                	li	a3,10
ffffffffc0204286:	b53d                	j	ffffffffc02040b4 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204288:	03b05163          	blez	s11,ffffffffc02042aa <vprintfmt+0x34c>
ffffffffc020428c:	02d00693          	li	a3,45
ffffffffc0204290:	f6d79de3          	bne	a5,a3,ffffffffc020420a <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204294:	00002417          	auipc	s0,0x2
ffffffffc0204298:	d9c40413          	addi	s0,s0,-612 # ffffffffc0206030 <default_pmm_manager+0xeb0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020429c:	02800793          	li	a5,40
ffffffffc02042a0:	02800513          	li	a0,40
ffffffffc02042a4:	00140a13          	addi	s4,s0,1
ffffffffc02042a8:	bd6d                	j	ffffffffc0204162 <vprintfmt+0x204>
ffffffffc02042aa:	00002a17          	auipc	s4,0x2
ffffffffc02042ae:	d87a0a13          	addi	s4,s4,-633 # ffffffffc0206031 <default_pmm_manager+0xeb1>
ffffffffc02042b2:	02800513          	li	a0,40
ffffffffc02042b6:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02042ba:	05e00413          	li	s0,94
ffffffffc02042be:	b565                	j	ffffffffc0204166 <vprintfmt+0x208>
...
ffffffffc02042d4:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02042d6:	c89ff0ef          	jal	ra,ffffffffc0203f5e <vprintfmt>
}
...
ffffffffc02042e4:	e0a6                	sd	s1,64(sp)
ffffffffc02042e6:	fc4a                	sd	s2,56(sp)
ffffffffc02042e8:	f84e                	sd	s3,48(sp)
ffffffffc02042ea:	f452                	sd	s4,40(sp)
ffffffffc02042ec:	f056                	sd	s5,32(sp)
ffffffffc02042ee:	ec5a                	sd	s6,24(sp)
ffffffffc02042f0:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc02042f2:	c901                	beqz	a0,ffffffffc0204302 <readline+0x22>
ffffffffc02042f4:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc02042f6:	00002517          	auipc	a0,0x2
ffffffffc02042fa:	d5250513          	addi	a0,a0,-686 # ffffffffc0206048 <default_pmm_manager+0xec8>
ffffffffc02042fe:	dbdfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc0204304:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc0204306:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc0204308:	4aa9                	li	s5,10
ffffffffc020430a:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc020430c:	0000db97          	auipc	s7,0xd
ffffffffc0204310:	decb8b93          	addi	s7,s7,-532 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204314:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc0204318:	ddbfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020431c:	00054a63          	bltz	a0,ffffffffc0204330 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204320:	00a95a63          	bge	s2,a0,ffffffffc0204334 <readline+0x54>
ffffffffc0204324:	029a5263          	bge	s4,s1,ffffffffc0204348 <readline+0x68>
        c = getchar();
ffffffffc0204328:	dcbfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020432c:	fe055ae3          	bgez	a0,ffffffffc0204320 <readline+0x40>
            return NULL;
ffffffffc0204330:	4501                	li	a0,0
ffffffffc0204332:	a091                	j	ffffffffc0204376 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc0204334:	03351463          	bne	a0,s3,ffffffffc020435c <readline+0x7c>
ffffffffc0204338:	e8a9                	bnez	s1,ffffffffc020438a <readline+0xaa>
        c = getchar();
ffffffffc020433a:	db9fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc020433e:	fe0549e3          	bltz	a0,ffffffffc0204330 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204342:	fea959e3          	bge	s2,a0,ffffffffc0204334 <readline+0x54>
ffffffffc0204346:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204348:	e42a                	sd	a0,8(sp)
ffffffffc020434a:	da7fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc020434e:	6522                	ld	a0,8(sp)
ffffffffc0204350:	009b87b3          	add	a5,s7,s1
ffffffffc0204354:	2485                	addiw	s1,s1,1
ffffffffc0204356:	00a78023          	sb	a0,0(a5)
ffffffffc020435a:	bf7d                	j	ffffffffc0204318 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc020435c:	01550463          	beq	a0,s5,ffffffffc0204364 <readline+0x84>
ffffffffc0204360:	fb651ce3          	bne	a0,s6,ffffffffc0204318 <readline+0x38>
            cputchar(c);
ffffffffc0204364:	d8dfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204368:	0000d517          	auipc	a0,0xd
ffffffffc020436c:	d9050513          	addi	a0,a0,-624 # ffffffffc02110f8 <buf>
ffffffffc0204370:	94aa                	add	s1,s1,a0
ffffffffc0204372:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204376:	60a6                	ld	ra,72(sp)
ffffffffc0204378:	6486                	ld	s1,64(sp)
ffffffffc020437a:	7962                	ld	s2,56(sp)
ffffffffc020437c:	79c2                	ld	s3,48(sp)
ffffffffc020437e:	7a22                	ld	s4,40(sp)
ffffffffc0204380:	7a82                	ld	s5,32(sp)
ffffffffc0204382:	6b62                	ld	s6,24(sp)
ffffffffc0204384:	6bc2                	ld	s7,16(sp)
ffffffffc0204386:	6161                	addi	sp,sp,80
ffffffffc0204388:	8082                	ret
            cputchar(c);
ffffffffc020438a:	4521                	li	a0,8
ffffffffc020438c:	d65fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204390:	34fd                	addiw	s1,s1,-1
ffffffffc0204392:	b759                	j	ffffffffc0204318 <readline+0x38>

ffffffffc0204394 <strlen>:
...
strlen(const char *s) {
ffffffffc0204398:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020439a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020439c:	cb81                	beqz	a5,ffffffffc02043ac <strlen+0x18>
        cnt ++;
ffffffffc020439e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02043a0:	00a707b3          	add	a5,a4,a0
ffffffffc02043a4:	0007c783          	lbu	a5,0(a5)
ffffffffc02043a8:	fbfd                	bnez	a5,ffffffffc020439e <strlen+0xa>
...
ffffffffc02043ae:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043b0:	e589                	bnez	a1,ffffffffc02043ba <strnlen+0xc>
ffffffffc02043b2:	a811                	j	ffffffffc02043c6 <strnlen+0x18>
        cnt ++;
ffffffffc02043b4:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043b6:	00f58863          	beq	a1,a5,ffffffffc02043c6 <strnlen+0x18>
ffffffffc02043ba:	00f50733          	add	a4,a0,a5
ffffffffc02043be:	00074703          	lbu	a4,0(a4)
ffffffffc02043c2:	fb6d                	bnez	a4,ffffffffc02043b4 <strnlen+0x6>
ffffffffc02043c4:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc02043c6:	852e                	mv	a0,a1
ffffffffc02043c8:	8082                	ret

ffffffffc02043ca <strcpy>:
char *
...
ffffffffc02043ca:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc02043cc:	0005c703          	lbu	a4,0(a1)
ffffffffc02043d0:	0785                	addi	a5,a5,1
ffffffffc02043d2:	0585                	addi	a1,a1,1
ffffffffc02043d4:	fee78fa3          	sb	a4,-1(a5)
ffffffffc02043d8:	fb75                	bnez	a4,ffffffffc02043cc <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02043e0:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043e4:	cb89                	beqz	a5,ffffffffc02043f6 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc02043e6:	0505                	addi	a0,a0,1
ffffffffc02043e8:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043ea:	fee789e3          	beq	a5,a4,ffffffffc02043dc <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02043ee:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02043f2:	9d19                	subw	a0,a0,a4
ffffffffc02043f4:	8082                	ret
ffffffffc02043f6:	4501                	li	a0,0
ffffffffc02043f8:	bfed                	j	ffffffffc02043f2 <strcmp+0x16>

ffffffffc02043fa <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc02043fa:	00054783          	lbu	a5,0(a0)
ffffffffc02043fe:	c799                	beqz	a5,ffffffffc020440c <strchr+0x12>
        if (*s == c) {
ffffffffc0204400:	00f58763          	beq	a1,a5,ffffffffc020440e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204404:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204408:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020440a:	fbfd                	bnez	a5,ffffffffc0204400 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204410:	ca01                	beqz	a2,ffffffffc0204420 <memset+0x10>
ffffffffc0204412:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204414:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204416:	0785                	addi	a5,a5,1
ffffffffc0204418:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020441c:	fec79de3          	bne	a5,a2,ffffffffc0204416 <memset+0x6>
    }
    return s;
...
ffffffffc0204422 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204422:	ca19                	beqz	a2,ffffffffc0204438 <memcpy+0x16>
ffffffffc0204424:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204426:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204428:	0005c703          	lbu	a4,0(a1)
ffffffffc020442c:	0585                	addi	a1,a1,1
ffffffffc020442e:	0785                	addi	a5,a5,1
ffffffffc0204430:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204434:	fec59ae3          	bne	a1,a2,ffffffffc0204428 <memcpy+0x6>
    }
    return dst;
